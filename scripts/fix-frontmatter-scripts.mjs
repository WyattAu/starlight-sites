...
/**
 * fix-frontmatter-scripts.mjs -- Removes embedded script tags from frontmatter ONLY.
 *
 * The Breadcrumb Schema and Course Schema script tags embedded between --- delimiters
 * cause YAML parse failures. This script removes ONLY those blocks from the frontmatter,
...
function fixFrontmatter(filePath) {
  ...
  // Find the first two --- delimiters (the frontmatter boundaries)
  let fmStart = -1
  let fmEnd = -1
  let dashCount = 0
