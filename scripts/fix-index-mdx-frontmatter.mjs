...
/**
 * fix-index-mdx-frontmatter.mjs -- Fixes frontmatter in index.mdx files.
 *
 * Removes embedded script tags from frontmatter in index.mdx files.
 *
 * Usage:
