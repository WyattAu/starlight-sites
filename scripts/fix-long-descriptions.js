 ...
 *
 * Truncates descriptions that are above the 160-character maximum
 * to fit within the 120-160 character range.
 *
 * Usage:
 *   node scripts/fix-long-descriptions.js --dry-run    # Preview changes
 *   node scripts/fix-long-descriptions.js --apply       # Apply changes
 */
...
// Find and fix long descriptions
const fixes = []
