...
const CATEGORY_MAP: Record<string, string> = {
  ...
  physics: 'Further Studies',
  chemistry: 'Further Studies',
  'computer-science': 'Further Studies',
  admissions: 'Further Studies',
  'machine-learning': 'Further Studies',
  ...
  // Other
  'civics-tests': 'Civics',
  'professional-certs': 'Professional',
