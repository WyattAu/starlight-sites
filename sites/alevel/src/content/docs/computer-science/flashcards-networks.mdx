...
- **Client-Server Model:** The server provides resources (files, websites, email). The client requests services. The server is typically more powerful and always on. Peer-to-peer: all devices are equal, each can act as client and server.
