...
```mermaid
flowchart TD
    A[05 Labour Markets] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Macroeconomic Performance](/economics/macro/01-macroeconomic-performance/) -- Employment and unemployment statistics are key macroeconomic indicators derived from labour market data.
- [Macroeconomic Policy Debates](/economics/macro/07-macroeconomic-policy-debates/) -- Keynesian and monetarist views on unemployment policy directly relate to labour market theory.
- [Supply-Side Policy](/economics/macro/05-supply-side-policy/) -- Labour market reforms are a central supply-side policy for reducing structural unemployment.
- [Market Failure and Government Intervention](/economics/microeconomics/03-market-failure/) -- Minimum wages and trade unions represent government intervention in labour markets to address monopsony power.
:::
