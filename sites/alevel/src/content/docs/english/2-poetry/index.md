...
title: "Poetry | A-Level - Wyatt's Notes"
description: "This section covers poetry concepts, definitions, and applications with worked examples and practice problems."
...
This section covers literary analysis, language techniques, and critical writing skills. Revision works best in one direction here: read index, attempt the practice problems cold, and only then check the worked solutions.
...
- [1_poetry Analysis](/english/2-poetry/1_poetry-analysis/)
...
If index feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
