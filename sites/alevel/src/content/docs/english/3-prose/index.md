...
sources:
  - text: Standard textbook reference
description: "Comprehensive 3 prose study notes for alevel with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
...
- [1_prose Analysis](./1_prose-analysis)
