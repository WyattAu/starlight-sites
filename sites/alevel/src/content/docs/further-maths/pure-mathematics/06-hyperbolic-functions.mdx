...
<aside aria-label="The formula booklet lists hyperbolic identities and the logarithmic forms of the inverse" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Note the spelling: $\cosh$, $\sinh$, $\tanh$ are standard abbreviations. The reciprocals" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Osborn\'s rule is a useful mnemonic but should not replace understanding. Always verify" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="When you encounter an integral of the form $\dfrac◆LB◆1◆RB◆◆LB◆\sqrt{x^2+a^2}◆RB◆$ or" class="starlight-aside starlight-aside--tip">
<strong>When you encounter an integral of the form $\dfrac◆LB◆1◆RB◆◆LB◆\sqrt{x^2+a^2}◆RB◆$ or</strong>
