...
Substitutions. See [Further Calculus](/further-maths/pure-mathematics/04-further-calculus/).

### 10.4 The catenary and mechanics

The shape $y = a\cosh(x/a)$ describes a hanging chain. The arc length is $s = a\sinh(x/a)$. See
[Further Mechanics](/further-maths/further-mechanics/01-projectile-motion/).
