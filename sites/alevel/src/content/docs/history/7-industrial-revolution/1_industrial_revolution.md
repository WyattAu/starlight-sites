...
social patterns fundamentally altered how people lived, worked, and governed themselves.

## Historical Context and Chronology

Britain in the mid-eighteenth century was a commercially advanced society. A powerful merchant
class, expanding overseas trade, and stable political institutions created conditions favourable to
innovation. The Agricultural Revolution increased food production and released labour from the land.
Capital accumulated through colonial trade, including the slave trade, provided investment funds. A
mobile workforce, displaced by enclosure and population growth, supplied cheap labour for factories
and mines.
...
| -------------------------- | --------- | ---------------------------------------------------------------- |
| Pre-industrial foundations | 1700-1760 | Agricultural improvement, proto-industrialisation, colonial trade |
| Textile revolution         | 1760-1800 | Spinning jenny, water frame, power loom, factory system          |
| Steam and iron             | 1780-1830 | Watt engine, coke smelting, railways                             |
| Social transformation      | 1790-1840 | Urbanisation, working conditions, public health crisis           |
| Political reform           | 1815-1840 | Corn Laws, Peterloo, Reform Act 1832, Chartism                   |
...
- **Capital accumulation**: Profits from the slave trade, plantation economies, and colonial commerce
  provided investment capital. Significance: industrialisation required not just ideas but funding.

- **Population growth**: Britain's population rose from approximately 5.7 million in 1750 to 12.1
  million by 1831. Significance: created both a larger workforce and a bigger domestic market.
...
- **Urbanisation**: Manchester's population rose from 25,000 in 1772 to 303,000 by 1850.
  Significance: rapid, unplanned growth created severe housing and public health problems.

- **Working conditions**: Factory employment involved 12-16 hour days, low wages, dangerous
...
- **Public health crisis**: Overcrowded, unsanitary urban conditions produced cholera and typhus
  epidemics. The 1842 Chadwick Report documented the link between poverty, sanitation, and disease.
  The **1848 Public Health Act** established local boards of health.
...
- **Enclosure**: Consolidation of open fields and common land into privately owned plots.
- **Factory system**: Production concentrated in a single workplace using powered machinery.
- **Luddism**: Organised opposition to mechanisation by workers who destroyed machinery.
- **Laissez-faire**: Non-intervention by government in the economy; associated with Adam Smith's
...
The most enduring debate concerns whether the Industrial Revolution improved or worsened living
standards.

- **Optimist interpretation** (T.S. Ashton, R.M. Hartwell): Real wages rose, consumer goods became
  cheaper, and life expectancy eventually increased. Industrialisation created wealth that, over
...
- **Revisionist synthesis** (Robert Feinstein, Nicholas Crafts): Modest real wage improvements but
  unevenly distributed. Benefits concentrated among the middle classes and skilled workers; the
  unskilled gained later.

### Was the Industrial Revolution a "revolution"?

- **Continuity view**: Industrialisation was gradual, building on proto-industrialisation and
  incremental improvements.
- **Revolution view**: The scale, speed, and transformative impact after 1760 justifies the term.
  The factory system, urbanisation, and reorganisation of labour represented a fundamental break.

### The role of slavery

- **Eric Williams thesis** (1944): Slave trade and plantation profits financed the Industrial
  Revolution; abolition reflected economic decline of sugar islands, not moral sentiment.
- **Critique**: Slavery generated regional wealth (Bristol, Liverpool, Glasgow) but its contribution
  to national capital formation is debated. Williams' economic argument has been weakened but his
  broader point about the entanglement of slavery and industrialisation remains influential.

## Source Analysis Techniques

When analysing sources from the Industrial Revolution:

1. **Government reports**: The Sadler Committee (1832) and Ashley Mines Commission (1842) provide
   detailed testimony but were produced for political purposes and may be selective.
2. **Workers' testimonies**: Invaluable for perspectives of those who experienced conditions, but
   often filtered through reformer intermediaries.
3. **Economic data**: Wage statistics and price indices provide quantitative evidence but are
...
2. **Assuming benefits were immediate and universal**. Improvements were slow, uneven, and
   concentrated among specific groups.
3. **Ignoring government's role**. Laissez-faire did not mean total absence of state intervention;
   the state regulated trade, protected property, and gradually introduced factory legislation.
...
and 1840. Agricultural change, capital accumulation, and population growth created preconditions;
technological innovation drove the process; urbanisation and poor working conditions generated social
