...
<Aside type="note" title="All boards provide trigonometric identities in the formula booklet, but not their proofs.">
...
<Aside type="caution" title="The small angle approximations are only valid when $\theta$ is in **radians**, not">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Trigonometry**? The contains the hardest questions">
