...
<aside aria-label="All boards provide trigonometric identities in the formula booklet, but not their proofs." class="starlight-aside starlight-aside--note">
...
<aside aria-label="The small angle approximations are only valid when $\theta$ is in **radians**, not" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Trigonometry**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
