...
description: "Study notes for Exponentials and Logarithms | A-Level with worked examples and practice questions."
---------- | ---------- | ------------------------------------------------- | | AQA | Paper 1, 2 | Exponentials in P1;"
...
```mermaid
flowchart TD
    A[09 Exponentials And Logarithmsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Differentiation](10-differentiation) -- The derivative of $e^x$ is $e^x$ itself, and logarithmic differentiation handles functions of the form $f(x)^{g(x)}$.
- [Integration](11-integration) -- Integrating $1/x$ yields $\ln|x|$, and exponential functions integrate to themselves.
- [Functions](05-functions) -- Exponential and logarithmic functions are inverses of each other, a core concept in understanding function behaviour.
- [Proof](13-proof) -- The irrationality of $\log_2 3$ and similar results use proof by contradiction from this topic's framework.
