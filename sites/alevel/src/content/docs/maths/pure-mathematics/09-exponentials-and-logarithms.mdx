...
<aside aria-label="The formula booklet gives the laws of logarithms and the derivatives of $e^x$ and $\ln x$." class="starlight-aside starlight-aside--note">
...
<Aside type="tip" title="Tip $\lim_{n\to\infty}(1+1/n)^n$", substitute a large value of $n$ (e.g., $n=10^6$) and round">
Appropriately.
</Aside>
<hr />
...
<aside aria-label="Warning $\frac{d}{dx}x^n = nx^{n-1}$ applies when the variable is in the **base**, not" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common errors:" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Your calculator likely has $\log$ (base 10) and $\ln$ (base $e$) buttons, but not a general" class="starlight-aside starlight-aside--tip">
...
<Aside type="tip" title="This integral definition is why $\ln x$ is called the "natural" logarithm — it arises from">
...
<aside aria-label="When substituting $u = a^x$ or $u = \ln x$Always check the domain. For $u = a^x$ we Have" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="In modelling questions, always:" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Warning Rule alone — it requires logarithmic differentiation or rewriting as" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Exponentials and Logarithms**? The contains the" class="starlight-aside starlight-aside--tip">
