...
<Aside type="tip">
Tip $\lim_{n\to\infty}(1+1/n)^n$", substitute a large value of $n$ (e.g., $n=10^6$) and round
...
<Aside type="caution">
Warning $\frac{d}{dx}x^n = nx^{n-1}$ applies when the variable is in the **base**, not
...
<Aside type="tip">
This integral definition is why $\ln x$ is called the "natural" logarithm, it arises from
...
<Aside type="caution">
When substituting $u = a^x$ or $u = \ln x$Always check the domain. For $u = a^x$ we Have
...
<Aside type="tip" title="In modelling questions, always:">
...
<Aside type="caution">
Warning Rule alone, it requires logarithmic differentiation or rewriting as
...
**If you get this wrong, revise:** [The Derivative of $e^x$](/maths/pure-mathematics/09-exponentials-and-logarithms/), Section 2.
...
<Aside type="tip">
Tip Ready to test your understanding of **Exponentials and Logarithms**? The contains the
...
- [Differentiation](/maths/pure-mathematics/10-differentiation/) -- The derivative of $e^x$ is $e^x$ itself, and logarithmic differentiation handles functions of the form $f(x)^{g(x)}$.
- [Integration](/maths/pure-mathematics/11-integration/) -- Integrating $1/x$ yields $\ln|x|$, and exponential functions integrate to themselves.
- [Functions](/maths/pure-mathematics/05-functions/) -- Exponential and logarithmic functions are inverses of each other, a core concept in understanding function behaviour.
- [Proof](/maths/pure-mathematics/13-proof/) -- The irrationality of $\log_2 3$ and similar results use proof by contradiction from this topic's framework.
