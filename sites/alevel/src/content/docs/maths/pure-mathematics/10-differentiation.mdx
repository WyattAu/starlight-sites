...
<Aside type="note" title="The formula booklet lists derivatives of standard functions. You must know how to apply the">
...
<Aside type="note" title="Info There. Continuity is necessary but not sufficient — $f(x) = |x|$ is continuous at $x=0$">
...
<Aside type="caution" title="The quotient rule has a **minus** sign in the numerator: $v\,u' - u\,v'$. Getting this">
...
<Aside type="caution" title="Warning Point could still be a maximum, minimum, or inflection. Always use a nature table">
...
<Aside type="caution" title="Warning Point of inflection at $x = 0$But $f'(0) = 0$ in this case. Consider">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Differentiation**? The contains the hardest">
