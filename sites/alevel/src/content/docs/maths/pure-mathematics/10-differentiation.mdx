...
:::caution The quotient rule has a **minus** sign in the numerator: $v\,u' - u\,v'$. Getting this
...
:::caution Warning Point of inflection at $x = 0$But $f'(0) = 0$ in this case. Consider
