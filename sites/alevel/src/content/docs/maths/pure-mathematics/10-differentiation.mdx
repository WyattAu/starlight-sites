...
<Aside type="note">
Info There. Continuity is necessary but not sufficient, $f(x) = |x|$ is continuous at $x=0$
...
<Aside type="caution">
Warning Point could still be a maximum, minimum, or inflection. Always use a nature table
...
<Aside type="tip">
Tip Inequality. When asked to "show that a function is increasing", verify that $f'(x) \gt 0$
...
<Aside type="caution">
Warning Point of inflection at $x = 0$ But $f'(0) = 0$ in this case. Consider
...
<Aside type="tip">
Tip Ready to test your understanding of **Differentiation**? The contains the hardest
...
- [Integration](/maths/pure-mathematics/11-integration/) -- Integration reverses differentiation, and the Fundamental Theorem of Calculus connects rates of change to accumulated areas.
- [Trigonometry](/maths/pure-mathematics/08-trigonometry/) -- Derivatives of $\sin$, $\cos$, and $\tan$ rely on compound angle identities and small angle approximations.
- [Exponentials and Logarithms](/maths/pure-mathematics/09-exponentials-and-logarithms/) -- The derivative of $e^x$ is $e^x$, and logarithmic differentiation handles variable-base exponentials.
- [Numerical Methods](/maths/pure-mathematics/14-numerical-methods/) -- Newton-Raphson uses the derivative to find roots, and the convergence rate depends on the second derivative.
