...
title: "Differentiation | A-Level - Wyatt's Notes"
description: "Study notes for Differentiation | A-Level - Wyatt's Notes with worked examples and practice questions."
---------- | ---------- | ---------------------------------------------------------------- | | AQA | Paper 1, 2 | First"
...
```mermaid
flowchart TD
    A[10 Differentiationx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Integration](11-integration) -- Integration reverses differentiation, and the Fundamental Theorem of Calculus connects rates of change to accumulated areas.
- [Trigonometry](08-trigonometry) -- Derivatives of $\sin$, $\cos$, and $\tan$ rely on compound angle identities and small angle approximations.
- [Exponentials and Logarithms](09-exponentials-and-logarithms) -- The derivative of $e^x$ is $e^x$, and logarithmic differentiation handles variable-base exponentials.
- [Numerical Methods](14-numerical-methods) -- Newton-Raphson uses the derivative to find roots, and the convergence rate depends on the second derivative.
