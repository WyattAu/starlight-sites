...
<aside aria-label="The formula booklet lists derivatives of standard functions. You must know how to apply the" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Info There. Continuity is necessary but not sufficient — $f(x) = |x|$ is continuous at $x=0$" class="starlight-aside starlight-aside--note">
...
<aside aria-label="The quotient rule has a **minus** sign in the numerator: $v\,u' - u\,v'$. Getting this" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Warning Point could still be a maximum, minimum, or inflection. Always use a nature table" class="starlight-aside starlight-aside--caution">
...
<Aside type="tip" title="Tip Inequality. When asked to "show that a function is increasing", verify that $f'(x) \gt 0$">
...
<aside aria-label="Warning Point of inflection at $x = 0$But $f'(0) = 0$ in this case. Consider" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Differentiation**? The contains the hardest" class="starlight-aside starlight-aside--tip">
