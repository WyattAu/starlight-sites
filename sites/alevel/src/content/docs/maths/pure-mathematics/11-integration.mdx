...
<aside aria-label="The formula booklet provides standard integrals. You must know how to apply integration" class="starlight-aside starlight-aside--note">
...
<aside aria-label="The Fundamental Theorem of Calculus is one of the most important results in all of" class="starlight-aside starlight-aside--note">
...
<aside aria-label="$\int_a^b f(x)\,dx$ gives the **signed area** (negative below the $x$-axis). To find the" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Integration**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
