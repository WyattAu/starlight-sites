...
<Aside type="note" title="The formula booklet provides standard integrals. You must know how to apply integration">
...
<Aside type="note" title="The Fundamental Theorem of Calculus is one of the most important results in all of">
...
<Aside type="caution" title="$\int_a^b f(x)\,dx$ gives the **signed area** (negative below the $x$-axis). To find the">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Integration**? The contains the hardest questions">
