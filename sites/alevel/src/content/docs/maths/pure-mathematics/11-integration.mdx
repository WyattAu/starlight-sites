...
title: "Integration | A-Level - Wyatt's Notes"
description: "Study notes for Integration | A-Level - Wyatt's Notes with worked examples and practice questions."
---------- | ---------- | ---------------------------------------------------------- | | AQA | Paper 1, 2 | Basic integration in"
...
```mermaid
flowchart TD
    A[11 Integrationx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Differentiation](10-differentiation) -- Integration reverses differentiation, and the Fundamental Theorem of Calculus connects rates of change to accumulated areas.
- [Trigonometry](08-trigonometry) -- Trigonometric identities are essential for integrating functions involving $\sin$, $\cos$, and $\tan$.
- [Numerical Methods](14-numerical-methods) -- The trapezium rule and Simpson's rule approximate definite integrals when exact integration is difficult.
- [Exponentials and Logarithms](09-exponentials-and-logarithms) -- The integral of $1/x$ gives $\ln|x|$, linking integration directly to logarithmic functions.
