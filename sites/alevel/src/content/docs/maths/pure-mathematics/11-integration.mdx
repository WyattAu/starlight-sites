...
title: Integration
description: "| Board | Paper | Notes | | ---------- | ---------- | ---------------------------------------------------------- | | AQA | Paper 1, 2 | Basic integration in"
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Maths", "url": "https://alevel.wyattau.com/maths"}, {"name": "Pure Mathematics", "url": "https://alevel.wyattau.com/maths/pure-mathematics"}, {"name": "11 Integration", "url": "https://alevel.wyattau.com/maths/pure-mathematics/11-integration"}]
}
</script>
...
**The key insight:** The Fundamental Theorem of Calculus connects differentiation and integration — they are inverse operations. If $F'(x) = f(x)$, then $\int_a^b f(x)\,dx = F(b) - F(a)$. This means you can evaluate definite integrals by finding antiderivatives, without doing Riemann sums. This is the most important theorem in calculus.
...
<strong>The formula booklet provides standard integrals. You must know how to apply integration</strong>
...
<DesmosGraph client:only="solid-js" title="Integration as Area Under a Curve" expressions={["int_{0}^{b} x^2 dx"]}
...
<aside class="starlight-aside starlight-aside--note">
<strong>The Fundamental Theorem of Calculus is one of the most important results in all of</strong>
...
<strong>$\int_a^b f(x)\,dx$ gives the **signed area** (negative below the $x$-axis). To find the</strong>
...
<strong>Tip Ready to test your understanding of **Integration**? The contains the hardest questions</strong>
...
- [Differentiation](10-differentiation.mdx) -- Integration reverses differentiation, and the Fundamental Theorem of Calculus connects rates of change to accumulated areas.
- [Trigonometry](08-trigonometry.mdx) -- Trigonometric identities are essential for integrating functions involving $\sin$, $\cos$, and $\tan$.
- [Numerical Methods](14-numerical-methods.md) -- The trapezium rule and Simpson's rule approximate definite integrals when exact integration is difficult.
- [Exponentials and Logarithms](09-exponentials-and-logarithms.mdx) -- The integral of $1/x$ gives $\ln|x|$, linking integration directly to logarithmic functions.
