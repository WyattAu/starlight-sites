...
:::caution Warning Particular component. A long thin copper wire has high resistance but copper
...
:::caution Common Pitfall Do not confuse the behaviour of metals and semiconductors. Metals have a
...
:::caution Warning Direction of the magnetic field, not the width of the conductor perpendicular to
