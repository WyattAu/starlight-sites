...
<aside aria-label="Warning Particular component. A long thin copper wire has high resistance but copper" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When calculating energy for resistors in series, use $P = I^2R$ (same" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Common Pitfall Do not confuse the behaviour of metals and semiconductors. Metals have a" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Warning Direction of the magnetic field, not the width of the conductor perpendicular to" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Hall effect, focus on the _sign_ of the Hall voltage. Electrons (negative charge) deflect" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Technique When calculating transmission losses, remember to include both the outward and" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Current and Resistance**? The contains the hardest" class="starlight-aside starlight-aside--tip">
