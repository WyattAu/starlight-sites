...
<Aside type="caution" title="Warning Particular component. A long thin copper wire has high resistance but copper">
...
<Aside type="tip" title="Exam Technique When calculating energy for resistors in series, use $P = I^2R$ (same">
...
<Aside type="caution" title="Common Pitfall Do not confuse the behaviour of metals and semiconductors. Metals have a">
...
<Aside type="caution" title="Warning Direction of the magnetic field, not the width of the conductor perpendicular to">
the current. Sketch The geometry carefully.
</Aside>
<Aside type="tip" title="Tip Hall effect, focus on the _sign_ of the Hall voltage. Electrons (negative charge) deflect">
...
<Aside type="tip" title="Exam Technique When calculating transmission losses, remember to include both the outward and">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Current and Resistance**? The contains the hardest">
