...
<Aside type="caution">
Warning Particular component. A long thin copper wire has high resistance but copper
...
<Aside type="caution">
Warning Direction of the magnetic field, not the width of the conductor perpendicular to

the current. Sketch The geometry carefully.
</Aside>

<Aside type="tip">
Tip Hall effect, focus on the _sign_ of the Hall voltage. Electrons (negative charge) deflect
...
<b>If you get this wrong, revise:</b> [Derivation of $I = nAev_d$](/physics/electricity/01-current-and-resistance/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Current and Resistance**? The contains the hardest
...
- [Electric Fields](/physics/fields/01-electric-fields/), Electric fields drive charge carriers through conductors, linking field strength to current and potential difference.
- [Magnetic Fields](/physics/fields/02-magnetic-fields/), The Hall effect in current-carrying conductors uses magnetic fields to measure carrier density and type.
- [Electromagnetism Unification](/physics/fields/03-electromagnetism-unification/), Alternating current and transformers are direct applications of Faraday's law of electromagnetic induction.
- [Work, Energy and Power](/physics/mechanics/04-work-energy-power/), Electrical power P = IV and energy dissipation in resistors follow from the general work-energy principles.
