...
- [Electric Fields](../fields/01-electric-fields) — Electric fields drive charge carriers through conductors, linking field strength to current and potential difference.
- [Magnetic Fields](../fields/02-magnetic-fields) — The Hall effect in current-carrying conductors uses magnetic fields to measure carrier density and type.
- [Electromagnetism Unification](../fields/03-electromagnetism-unification) — Alternating current and transformers are direct applications of Faraday's law of electromagnetic induction.
- [Work, Energy and Power](../mechanics/04-work-energy-power) — Electrical power P = IV and energy dissipation in resistors follow from the general work-energy principles.
