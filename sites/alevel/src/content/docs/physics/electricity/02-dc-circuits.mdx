...
<Aside type="caution">
Warning Current is exactly zero. If the bridge is unbalanced, you must use Kirchhoff's
...
<Aside type="caution">
Warning The circuit it is measuring. Always ensure $R_V \gg R_{\mathrm{circuit}}$ (rule
...
<Aside type="tip">
Tip Ready to test your understanding of **DC Circuits**? The contains the hardest questions
...
- [Capacitance](/physics/electricity/03-capacitance/), Capacitors store charge and are analysed using similar circuit techniques to resistors.
- [Quantum Physics](/physics/nuclear-physics/03-quantum-physics/), The photoelectric effect relies on circuit measurements to determine photon energy.
- [Fields](/physics/diagnostics/diag-electric-fields/), Electric fields underpin the potential differences that drive current in DC circuits.
