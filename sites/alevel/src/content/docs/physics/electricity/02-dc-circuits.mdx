...
:::caution Common Pitfall A potential divider circuit loaded by connecting a component across $R_2$
...
:::caution Warning Current is exactly zero. If the bridge is unbalanced, you must use Kirchhoff\'s
...
:::caution Warning The circuit it is measuring. Always ensure $R_V \gg R_{\mathrm{circuit}}$ (rule
