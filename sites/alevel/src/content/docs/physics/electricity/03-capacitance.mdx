...
<Aside type="tip">
Tip At which the curve reaches 63.2% of its final value. For discharging, find the time at
...
<Aside type="caution">
Warning But the system loses energy to the surroundings. Never assume $E_i = E_f$ when
...
<b>If you get this wrong, revise:</b> [RC Circuits: Charging](/physics/electricity/03-capacitance/)
...
<b>If you get this wrong, revise:</b> [RC Circuits: Discharging](/physics/electricity/03-capacitance/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Capacitance**? The contains the hardest questions
...
- [DC Circuits](/physics/electricity/02-dc-circuits/), Capacitors are charged and discharged through resistors, requiring Kirchhoff's laws.
- [Fields](/physics/diagnostics/diag-electric-fields/), The parallel plate capacitor is derived from the uniform electric field between conductors.
- [Oscillations and Waves](/physics/mechanics/07-oscillations/), RC circuits produce exponential decay analogous to damped oscillations in mechanical systems.
