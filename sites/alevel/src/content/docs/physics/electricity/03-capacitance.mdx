...
title: "Capacitance | A-Level - Wyatt's Notes"
...
```mermaid
flowchart TD
    A[03 Capacitancex] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Fields](../diagnostics/diag-electric-fields) — The parallel plate capacitor is derived from the uniform electric field between conductors.
- [Oscillations and Waves](../mechanics/07-oscillations) — RC circuits produce exponential decay analogous to damped oscillations in mechanical systems.
