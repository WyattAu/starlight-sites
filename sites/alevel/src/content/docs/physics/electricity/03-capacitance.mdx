...
<Aside type="caution" title="Common Pitfall Note the "mirror" relationship with resistors: capacitors in parallel add">
...
<aside aria-label="Tip At which the curve reaches 63.2% of its final value. For discharging, find the time at" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Common Pitfall A high $\varepsilon_r$ does not imply high dielectric strength. Water has" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When a question asks about inserting a dielectric, always check whether the" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Warning But the system loses energy to the surroundings. Never assume $E_i = E_f$ when" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When asked to determine $C$ from a discharge curve, always take the natural" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Capacitance**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
