...
:::caution Common Pitfall A high $\varepsilon_r$ does not imply high dielectric strength. Water has
...
:::caution Warning But the system loses energy to the surroundings. Never assume $E_i = E_f$ when
