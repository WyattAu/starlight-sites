...
<Aside type="note">
Info (Paper 2). Edexcel: Explicit comparison required in CP3. OCR (A): Potential energy
...
<Aside type="note">
Info Topic 11 (capacitor energy and charging/discharging graphs). OCR (A): Required in
...
[Relationship Between $E$ and $V$](/physics/fields/01-electric-fields/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Electric Fields**? The contains the hardest
...
- [Magnetic Fields](/physics/fields/02-magnetic-fields/), Electric and magnetic fields are unified in electromagnetism; charged particles experience forces in both.
- [Electromagnetism Unification](/physics/fields/03-electromagnetism-unification/), Maxwell's equations unite electric and magnetic fields into a single coherent theory of electromagnetic waves.
- [Current and Resistance](/physics/electricity/01-current-and-resistance/), Electric fields drive current through conductors, connecting field theory to circuit behaviour.
- [Gravitational Fields](/physics/mechanics/08-gravitational-fields/), Coulomb's law parallels Newton's law of gravitation, with both obeying the inverse square law.
