...
<Aside type="note" title="Info (Paper 2). Edexcel: Explicit comparison required in CP3. OCR (A): Potential energy">
...
<Aside type="note" title="Board Coverage AQA: Gauss\'s law is not formally required but the uniform field result for">
...
<Aside type="note" title="Info Topic 11 (capacitor energy and charging/discharging graphs). OCR (A): Required in">
...
<Aside type="note" title="Board Coverage AQA: Van de Graaff generators are a specified practical context (required">
...
<Aside type="note" title="Board Coverage AQA: Electrostatic precipitators appear as an application of electric fields">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Electric Fields**? The contains the hardest">
