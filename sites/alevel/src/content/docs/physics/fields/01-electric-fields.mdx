...
<aside aria-label="Info (Paper 2). Edexcel: Explicit comparison required in CP3. OCR (A): Potential energy" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Board Coverage AQA: Gauss\'s law is not formally required but the uniform field result for" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Info Topic 11 (capacitor energy and charging/discharging graphs). OCR (A): Required in" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Board Coverage AQA: Van de Graaff generators are a specified practical context (required" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Board Coverage AQA: Electrostatic precipitators appear as an application of electric fields" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Electric Fields**? The contains the hardest" class="starlight-aside starlight-aside--tip">
