...
<Aside type="tip" title="Exam Technique When asked about Lenz\'s law, always describe what the induced current does">
...
<Aside type="caution" title="Common Pitfall: the cross-product order is $d\mathbf{l} \times \hat{\mathbf{r}}$Not">
...
<Aside type="tip" title="Tip Currents repel. Think of it as two parallel beams of particles moving together (attract)">
...
<Aside type="caution" title="Warning Velocity and charge. Even a stationary particle will drift at this speed. The">
...
<Aside type="tip" title="Exam Technique The differential equation $L\,dI/dt + IR = V$ is identical in form to">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Magnetic Fields**? The contains the hardest">
