...
:::caution Common Pitfall: the cross-product order is $d\mathbf{l} \times \hat{\mathbf{r}}$Not
...
:::caution Warning Velocity and charge. Even a stationary particle will drift at this speed. The
