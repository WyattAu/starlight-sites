...
- [Electric Fields](../fields/01-electric-fields) — Magnetic fields arise from moving charges, linking electrostatics to electromagnetism.
- [Electromagnetism Unification](../fields/03-electromagnetism-unification) — Faraday's law and the Biot-Savart law are components of Maxwell's unified electromagnetic theory.
- [Current and Resistance](../electricity/01-current-and-resistance) — Current-carrying conductors in magnetic fields experience forces that connect field theory to circuit applications.
- [Circular Motion](../mechanics/06-circular-motion) — Charged particles in magnetic fields follow circular paths governed by centripetal force.
