...
<aside aria-label="Exam Technique When asked about Lenz\'s law, always describe what the induced current does" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Common Pitfall: the cross-product order is $d\mathbf{l} \times \hat{\mathbf{r}}$Not" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Currents repel. Think of it as two parallel beams of particles moving together (attract)" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Warning Velocity and charge. Even a stationary particle will drift at this speed. The" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique The differential equation $L\,dI/dt + IR = V$ is identical in form to" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Magnetic Fields**? The contains the hardest" class="starlight-aside starlight-aside--tip">
