...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Fields", "url": "https://alevel.wyattau.com/physics/fields"}, {"name": "02 Magnetic Fields", "url": "https://alevel.wyattau.com/physics/fields/02-magnetic-fields"}]
}
</script>
...
**Magnetic fields only affect moving charges:** A stationary charge experiences no magnetic force — it only feels electric fields. But a charge moving through a magnetic field experiences a force perpendicular to both its velocity and the field. This is why magnets don't attract paper (stationary charges) but do deflect electron beams (moving charges).

**Why it matters:** Magnetic fields explain how electric motors work (current in a field experiences force), how generators work (moving a conductor through a field induces current), how MRI scanners create images, and how compasses point north. They're essential for understanding electricity generation and transport.

**The key insight:** The magnetic force is always perpendicular to the velocity, so it does no work — it changes direction but not speed. This is why charged particles move in circles in magnetic fields, and why particle accelerators use magnets to steer particles without changing their energy.
...
- [Electric Fields](../fields/01-electric-fields.mdx) — Magnetic fields arise from moving charges, linking electrostatics to electromagnetism.
- [Electromagnetism Unification](../fields/03-electromagnetism-unification.mdx) — Faraday's law and the Biot-Savart law are components of Maxwell's unified electromagnetic theory.
- [Current and Resistance](../electricity/01-current-and-resistance.mdx) — Current-carrying conductors in magnetic fields experience forces that connect field theory to circuit applications.
- [Circular Motion](../mechanics/06-circular-motion.mdx) — Charged particles in magnetic fields follow circular paths governed by centripetal force.