...
<Aside type="tip">
Tip Currents repel. Think of it as two parallel beams of particles moving together (attract)
...
<Aside type="caution">
Warning Velocity and charge. Even a stationary particle will drift at this speed. The
...
<b>If you get this wrong, revise:</b>
[Electromagnetic Induction, Extended Applications](/physics/fields/02-magnetic-fields/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Magnetic Fields**? The contains the hardest
...
- [Electric Fields](/physics/fields/01-electric-fields/), Magnetic fields arise from moving charges, linking electrostatics to electromagnetism.
- [Electromagnetism Unification](/physics/fields/03-electromagnetism-unification/), Faraday's law and the Biot-Savart law are components of Maxwell's unified electromagnetic theory.
- [Current and Resistance](/physics/electricity/01-current-and-resistance/), Current-carrying conductors in magnetic fields experience forces that connect field theory to circuit applications.
- [Circular Motion](/physics/mechanics/06-circular-motion/), Charged particles in magnetic fields follow circular paths governed by centripetal force.
