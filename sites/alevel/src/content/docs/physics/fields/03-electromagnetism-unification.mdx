...
<aside aria-label="Info CIE. AQA and OCR (A) expect you to know the result and its significance but may not" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Tip Ready to test your understanding of **Electromagnetism**? The contains the" class="starlight-aside starlight-aside--tip">
