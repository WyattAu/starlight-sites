...
<Aside type="note" title="Info CIE. AQA and OCR (A) expect you to know the result and its significance but may not">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Electromagnetism**? The contains the">
