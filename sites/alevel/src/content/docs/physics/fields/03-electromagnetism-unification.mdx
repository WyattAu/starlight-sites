...
<Aside type="note">
Info CIE. AQA and OCR (A) expect you to know the result and its significance but may not
...
<b>If you get this wrong, revise:</b>
[Faraday's Law, Applications and Lenz's Law Intuition](/physics/fields/03-electromagnetism-unification/)
...
<Aside type="tip">
Tip Ready to test your understanding of **Electromagnetism**? The contains the
...
- [Electric Fields](/physics/fields/01-electric-fields/), Maxwell's equations include Gauss's law for electric fields and the relationship between electric field and potential.
- [Magnetic Fields](/physics/fields/02-magnetic-fields/), Faraday's law of induction and the Biot-Savart law are key components of the electromagnetic unification.
- [Current and Resistance](/physics/electricity/01-current-and-resistance/), Electromagnetic induction produces the alternating current that powers electrical circuits and transformers.
- [Dynamics](/physics/mechanics/03-dynamics/), Radiation pressure from electromagnetic waves exerts force on surfaces, connecting wave theory to Newtonian mechanics.
