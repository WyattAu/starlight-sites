...
<aside aria-label="Exam Technique To decide which SUVAT equation to use, identify which variable is **not**" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Technique When asked to find the distance travelled from a curved $v$-$t$ graph, check" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Common Pitfall Students often draw a tangent to a curve incorrectly by placing the ruler" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common Pitfall Terminal velocity does **not** mean the object has stopped accelerating" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique Identify what the acceleration is given as a function of -- time, velocity, or" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Common Pitfall The boat\'s speed $v_b$ is always relative to the water, not relative to" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Kinematics**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
