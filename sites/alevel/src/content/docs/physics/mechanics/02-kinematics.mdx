...
<Aside type="tip" title="Exam Technique To decide which SUVAT equation to use, identify which variable is **not**">
...
<Aside type="tip" title="Exam Technique When asked to find the distance travelled from a curved $v$-$t$ graph, check">
...
<Aside type="caution" title="Common Pitfall Students often draw a tangent to a curve incorrectly by placing the ruler">
...
<Aside type="caution" title="Common Pitfall Terminal velocity does **not** mean the object has stopped accelerating">
...
<Aside type="tip" title="Exam Technique Identify what the acceleration is given as a function of -- time, velocity, or">
...
<Aside type="caution" title="Common Pitfall The boat\'s speed $v_b$ is always relative to the water, not relative to">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Kinematics**? The contains the hardest questions">
