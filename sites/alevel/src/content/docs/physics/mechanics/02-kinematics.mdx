...
:::caution Common Pitfall Students often draw a tangent to a curve incorrectly by placing the ruler
...
:::caution Common Pitfall Terminal velocity does **not** mean the object has stopped accelerating
...
:::
:::caution Common Pitfall The boat\'s speed $v_b$ is always relative to the water, not relative to
