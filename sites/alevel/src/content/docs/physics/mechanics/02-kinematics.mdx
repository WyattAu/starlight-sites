...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Mechanics", "url": "https://alevel.wyattau.com/physics/mechanics"}, {"name": "02 Kinematics", "url": "https://alevel.wyattau.com/physics/mechanics/02-kinematics"}]
}
</script>
...
- [Dynamics](./03-dynamics.mdx): Builds on kinematic descriptions by explaining the forces that cause motion and acceleration.
- [Work, Energy and Power](./04-work-energy-power.mdx): Connects velocity and displacement to energy concepts, showing how motion relates to energy transfer.
- [Projectile Motion](/physics/projectile-motion): Applies kinematic equations to objects launched with both horizontal and vertical components of motion.
