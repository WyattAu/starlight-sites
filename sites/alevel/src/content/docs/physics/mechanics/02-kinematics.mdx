...
<Aside type="tip">
Tip Ready to test your understanding of **Kinematics**? The contains the hardest questions
...
- [Dynamics](/physics/mechanics/03-dynamics/): Builds on kinematic descriptions by explaining the forces that cause motion and acceleration.
- [Work, Energy and Power](/physics/mechanics/04-work-energy-power/): Connects velocity and displacement to energy concepts, showing how motion relates to energy transfer.
