...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Mechanics", "url": "https://alevel.wyattau.com/physics/mechanics"}, {"name": "03 Dynamics", "url": "https://alevel.wyattau.com/physics/mechanics/03-dynamics"}]
}
</script>
title: Dynamics
description: "Newton\" s three laws form the foundation of classical mechanics. They were first published in the _Principia Mathematica_ (1687)."
...
**Forces cause changes in motion, not motion itself:** This is Newton's great insight. A ball rolling on a frictionless surface would roll forever — it doesn't need a force to keep moving. Forces only matter when they change something: speeding up, slowing down, or changing direction. This is counterintuitive because in everyday life, friction makes things stop, so we assume force is needed to keep things moving.

**Why it matters:** Newton's three laws explain everything from why you slide forward when a bus stops (inertia), to why rockets work (action-reaction), to why you weigh less on the Moon (weaker gravitational force). They're the foundation of all classical mechanics and engineering.

**The key insight:** Newton's third law is the most misunderstood. When you push a wall, the wall pushes back with equal force — but you feel the wall pushing on you, not your push on the wall. The forces act on different objects, which is why they don't cancel out. This is how rockets work: the rocket pushes gas backward, and the gas pushes the rocket forward.
...
<strong>Warning They do **not** cancel. The normal reaction from a table on a book and the book\'s</strong>
...
<aside class="starlight-aside starlight-aside--caution">
<strong>Common Pitfall Centripetal force is **not** a separate force. It is the **net radial</strong>
...
<strong>Exam Technique When solving circular motion problems, always start with a free body diagram</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Tip Ready to test your understanding of **Dynamics**? The contains the hardest questions</strong>
...
- [Work, Energy and Power](../mechanics/04-work-energy-power.mdx) — Newton's second law underpins the work-energy theorem and the relationship between force, displacement, and kinetic energy.
- [Circular Motion](../mechanics/06-circular-motion.mdx) — Centripetal force is introduced as a specific application of Newton's second law to bodies moving on curved paths.
- [Momentum](../mechanics/05-momentum.mdx) — Conservation of momentum follows directly from Newton's third law applied to interacting bodies.
- [Gravitational Fields](../mechanics/08-gravitational-fields.mdx) — The weight equation W = mg is a special case of the gravitational force between two masses.