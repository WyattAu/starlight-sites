...
<aside aria-label="Warning They do **not** cancel. The normal reaction from a table on a book and the book\'s" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common Pitfall Centripetal force is **not** a separate force. It is the **net radial" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When solving circular motion problems, always start with a free body diagram" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Tip Ready to test your understanding of **Dynamics**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
