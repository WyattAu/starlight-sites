...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Mechanics", "url": "https://alevel.wyattau.com/physics/mechanics"}, {"name": "04 Work Energy Power", "url": "https://alevel.wyattau.com/physics/mechanics/04-work-energy-power"}]
}
</script>
title: Work, Energy and Power
description: "ALEVEL Physics notes: Work, Energy and Power. Comprehensive study material with definitions, examples, and assessment tools."
...
<strong>Warning Never lost -- it is transferred from mechanical to thermal (internal) energy. The</strong>
...
<strong>Exam Technique When asked for "the power developed by the engine" as a car accelerates,</strong>
...
[08-gravitational-fields](08-gravitational-fields.mdx)
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Diagnostic Test Ready to test your understanding of **Work, Energy and Power**? The contains the hardest</strong>
...
- [Dynamics](../mechanics/03-dynamics.mdx) — The work-energy theorem is derived from Newton's second law, connecting force, displacement, and kinetic energy.
- [Momentum](../mechanics/05-momentum.mdx) — Impulse relates force applied over time to change in momentum, complementary to the work-energy approach.
- [Oscillations](../mechanics/07-oscillations.mdx) — Energy conservation in SHM uses elastic potential energy from springs, which obeys Hooke's law.
- [Gravitational Fields](../mechanics/08-gravitational-fields.mdx) — Gravitational potential energy near the surface is the small-height approximation of the full gravitational potential.
