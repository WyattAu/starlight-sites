...
<Aside type="caution">
Warning Never lost -- it is transferred from mechanical to thermal (internal) energy. The
...
[08-gravitational-fields](/physics/mechanics/08-gravitational-fields/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Work, Energy and Power**? The contains the hardest
...
- [Dynamics](/physics/mechanics/03-dynamics/), The work-energy theorem is derived from Newton's second law, connecting force, displacement, and kinetic energy.
- [Momentum](/physics/mechanics/05-momentum/), Impulse relates force applied over time to change in momentum, complementary to the work-energy approach.
- [Oscillations](/physics/mechanics/07-oscillations/), Energy conservation in SHM uses elastic potential energy from springs, which obeys Hooke's law.
- [Gravitational Fields](/physics/mechanics/08-gravitational-fields/), Gravitational potential energy near the surface is the small-height approximation of the full gravitational potential.
