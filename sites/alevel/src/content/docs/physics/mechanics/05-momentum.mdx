...
<aside aria-label="Exam Technique For a ball hitting a smooth wall at angle $\alpha$ to the normal with speed" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Warning Line joining the centres of the two bodies at the moment of impact). In oblique" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique This result provides a quick experimental method to determine $e$: drop a ball" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Board Coverage AQA: Momentum conservation in explosions is required; the rocket equation is" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Momentum**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
