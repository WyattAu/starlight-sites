...
[1D Elastic Collision: Final Velocities](/physics/mechanics/05-momentum/)
...
<Aside type="caution">
Warning Line joining the centres of the two bodies at the moment of impact). In oblique
...
<b>If you get this wrong, revise:</b>
[Bouncing Ball: Proof that $e = \sqrt{h'/h}$](/physics/mechanics/05-momentum/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Momentum**? The contains the hardest questions
...
- [Dynamics](/physics/mechanics/03-dynamics/), Momentum conservation is derived from Newton's second and third laws, which are covered in the dynamics topic.
- [Work, Energy and Power](/physics/mechanics/04-work-energy-power/), The work-energy theorem connects impulse and change in momentum to kinetic energy.
- [Oscillations](/physics/mechanics/07-oscillations/), Momentum principles apply to oscillating systems where forces vary with position.
- [Circular Motion](/physics/mechanics/06-circular-motion/), 2D collision problems often require resolving momentum into components, similar to circular motion vector analysis.
