...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Mechanics", "url": "https://alevel.wyattau.com/physics/mechanics"}, {"name": "05 Momentum", "url": "https://alevel.wyattau.com/physics/mechanics/05-momentum"}]
}
</script>
title: Momentum
description: "ALEVEL Physics notes: Momentum. Comprehensive study material with definitions, e Study guide for A-Level momentum with worked examples and practice questions."
...
<strong>Exam Technique For a ball hitting a smooth wall at angle $\alpha$ to the normal with speed</strong>
...
<strong>Warning Line joining the centres of the two bodies at the moment of impact). In oblique</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Exam Technique This result provides a quick experimental method to determine $e$: drop a ball</strong>
...
<strong>Board Coverage AQA: Momentum conservation in explosions is required; the rocket equation is</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Diagnostic Test Ready to test your understanding of **Momentum**? The contains the hardest questions</strong>
...
- [Dynamics](../mechanics/03-dynamics.mdx) — Momentum conservation is derived from Newton's second and third laws, which are covered in the dynamics topic.
- [Work, Energy and Power](../mechanics/04-work-energy-power.mdx) — The work-energy theorem connects impulse and change in momentum to kinetic energy.
- [Oscillations](../mechanics/07-oscillations.mdx) — Momentum principles apply to oscillating systems where forces vary with position.
- [Circular Motion](../mechanics/06-circular-motion.mdx) — 2D collision problems often require resolving momentum into components, similar to circular motion vector analysis.
