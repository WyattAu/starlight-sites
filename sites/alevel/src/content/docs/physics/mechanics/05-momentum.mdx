...
<Aside type="tip" title="Exam Technique For a ball hitting a smooth wall at angle $\alpha$ to the normal with speed">
...
<Aside type="caution" title="Warning Line joining the centres of the two bodies at the moment of impact). In oblique">
...
<Aside type="tip" title="Exam Technique This result provides a quick experimental method to determine $e$: drop a ball">
...
<Aside type="note" title="Board Coverage AQA: Momentum conservation in explosions is required; the rocket equation is">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Momentum**? The contains the hardest questions">
