...
- [Dynamics](../mechanics/03-dynamics) — Momentum conservation is derived from Newton's second and third laws, which are covered in the dynamics topic.
- [Work, Energy and Power](../mechanics/04-work-energy-power) — The work-energy theorem connects impulse and change in momentum to kinetic energy.
- [Oscillations](../mechanics/07-oscillations) — Momentum principles apply to oscillating systems where forces vary with position.
- [Circular Motion](../mechanics/06-circular-motion) — 2D collision problems often require resolving momentum into components, similar to circular motion vector analysis.
