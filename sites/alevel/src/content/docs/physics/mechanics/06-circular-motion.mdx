...
:::caution Common Pitfall **Centripetal force is not a separate force.** It is the _net_ inward
...
:::caution Common Pitfall **"Centrifugal force" is not a real force.** In a rotating reference
...
:::caution Warning Is **shorter** than the small-angle simple pendulum period $T = 2\pi\sqrt{L/g}$.
...
:::caution Common Pitfall **Centrifugal force is not a real force.** It does not appear on free-body
