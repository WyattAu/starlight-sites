...
<Aside type="note" title="Info Quantities. AQA and Edexcel may accept degrees in some contexts but radians are">
...
<Aside type="note" title="Info Derivation is the standard approach; calculus is optional extension work. OCR (A):">
...
<Aside type="caution" title="Common Pitfall **Centripetal force is not a separate force.** It is the _net_ inward">
...
<Aside type="note" title="Board Coverage AQA: Conical pendulum appears in Paper 1. Edexcel: Covered in CP2, As a">
...
<Aside type="note" title="Info Is extension material. Edexcel: Both frictionless and friction cases may appear in CP2.">
...
<Aside type="tip" title="Exam Technique When asked about the difference between tension at the top and bottom of a">
...
<Aside type="caution" title="Warning Is **shorter** than the small-angle simple pendulum period $T = 2\pi\sqrt{L/g}$.">
...
<Aside type="caution" title="Common Pitfall **Centrifugal force is not a real force.** It does not appear on free-body">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Circular Motion**? The contains the hardest">
