...
<Aside type="note">
Info Quantities. AQA and Edexcel may accept degrees in some contexts but radians are
...
<Aside type="note">
Info Derivation is the standard approach; calculus is optional extension work. OCR (A):
...
<Aside type="note">
Board Coverage AQA: Conical pendulum appears in Paper 1. Edexcel: Covered in CP2, As a
...
<Aside type="note">
Info Is extension material. Edexcel: Both frictionless and friction cases may appear in CP2.
...
[Horizontal Circle: Conical Pendulum](/physics/mechanics/06-circular-motion/)
...
<b>If you get this wrong, revise:</b>
[Centripetal Acceleration, Derivation](/physics/mechanics/06-circular-motion/)
...
<b>If you get this wrong, revise:</b>
[Intuition: Circular Motion is NOT Equilibrium](/physics/mechanics/06-circular-motion/)
...
<Aside type="caution">
Warning Is **shorter** than the small-angle simple pendulum period $T = 2\pi\sqrt{L/g}$.
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Circular Motion**? The contains the hardest
...
- [Dynamics](/physics/mechanics/03-dynamics/), Centripetal force is the net inward force derived from Newton's second law applied to curved paths.
- [Momentum](/physics/mechanics/05-momentum/), Collisions in circular motion problems can be analysed using conservation of momentum and vector components.
- [Gravitational Fields](/physics/mechanics/08-gravitational-fields/), Satellite orbits are circular motion problems where gravity provides the centripetal force.
- [Work, Energy and Power](/physics/mechanics/04-work-energy-power/), Centripetal force does no work because it is always perpendicular to the displacement.
