...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Mechanics", "url": "https://alevel.wyattau.com/physics/mechanics"}, {"name": "06 Circular Motion", "url": "https://alevel.wyattau.com/physics/mechanics/06-circular-motion"}]
}
</script>
...
<aside class="starlight-aside starlight-aside--caution">
<strong>Common Pitfall **"Centrifugal force" is not a real force.** In a rotating reference</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Exam Technique When asked "why do passengers feel thrown outward in a cornering car?", the</strong>
...
- [Dynamics](../mechanics/03-dynamics.mdx) — Centripetal force is the net inward force derived from Newton's second law applied to curved paths.
- [Momentum](../mechanics/05-momentum.mdx) — Collisions in circular motion problems can be analysed using conservation of momentum and vector components.
- [Gravitational Fields](../mechanics/08-gravitational-fields.mdx) — Satellite orbits are circular motion problems where gravity provides the centripetal force.
- [Work, Energy and Power](../mechanics/04-work-energy-power.mdx) — Centripetal force does no work because it is always perpendicular to the displacement.
