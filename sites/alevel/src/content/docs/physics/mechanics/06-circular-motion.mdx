...
- [Dynamics](../mechanics/03-dynamics) — Centripetal force is the net inward force derived from Newton's second law applied to curved paths.
- [Momentum](../mechanics/05-momentum) — Collisions in circular motion problems can be analysed using conservation of momentum and vector components.
- [Gravitational Fields](../mechanics/08-gravitational-fields) — Satellite orbits are circular motion problems where gravity provides the centripetal force.
- [Work, Energy and Power](../mechanics/04-work-energy-power) — Centripetal force does no work because it is always perpendicular to the displacement.
