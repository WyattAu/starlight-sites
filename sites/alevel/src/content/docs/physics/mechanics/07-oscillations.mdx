...
<Aside type="tip">
Tip At twice the displacement frequency, exactly out of phase, oscillating between $0$ and
...
<Aside type="caution">
Warning Fastest overall. A lightly damped system passes through equilibrium sooner but
...
<Aside type="tip">
Tip Slightly below $f_0$. Less damping $\to$ higher, sharper peak closer to $f_0$. When
...
<b>If you get this wrong, revise:</b>
[Energy in SHM, Alternative Forms and Frequency Doubling](/physics/mechanics/07-oscillations/)
...
<b>If you get this wrong, revise:</b>
[Damping, Time Constant and Displacement-Time Graphs](/physics/mechanics/07-oscillations/)
...
<b>If you get this wrong, revise:</b>
[Forced Oscillations and Resonance, Detailed Treatment](/physics/mechanics/07-oscillations/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Oscillations**? The contains the hardest questions
...
- **Confusing angular frequency omega with frequency f:** Angular frequency omega = 2 _pi_ f = 2 _
  pi / T. They are different quantities with different units (rad/s vs Hz). Substituting f where
  omega is needed (or vice versa) in equations like x = A cos(omega_ t) will give completely wrong
  answers.
...
```mermaid
flowchart TD
    A[07 Oscillationsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Dynamics](/physics/mechanics/03-dynamics/), Simple harmonic motion arises from Newton's second law with a restoring force proportional to displacement.
- [Work, Energy and Power](/physics/mechanics/04-work-energy-power/), Energy in SHM oscillates between kinetic and potential forms, applying conservation of energy.
- [Momentum](/physics/mechanics/05-momentum/), Impulse and momentum concepts connect to oscillatory force and the time-dependent behaviour of driven systems.
- [Gravitational Fields](/physics/mechanics/08-gravitational-fields/), The simple pendulum period depends on gravitational field strength, linking oscillations to gravitational theory.
