...
- [Dynamics](../mechanics/03-dynamics) — Simple harmonic motion arises from Newton's second law with a restoring force proportional to displacement.
- [Work, Energy and Power](../mechanics/04-work-energy-power) — Energy in SHM oscillates between kinetic and potential forms, applying conservation of energy.
- [Momentum](../mechanics/05-momentum) — Impulse and momentum concepts connect to oscillatory force and the time-dependent behaviour of driven systems.
- [Gravitational Fields](../mechanics/08-gravitational-fields) — The simple pendulum period depends on gravitational field strength, linking oscillations to gravitational theory.
