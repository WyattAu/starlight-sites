...
<Aside type="caution" title="Common Pitfall Satellites in low Earth orbit are NOT in "zero gravity." The gravitational">
...
<aside aria-label="Common Pitfall A geostationary orbit is NOT the same as a geosynchronous orbit. A" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When asked why $E_p = -GMm/r$ is negative, explain: we define $V = 0$ at" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Tip Ready to test your understanding of **Gravitational Fields**? The contains the hardest" class="starlight-aside starlight-aside--tip">
