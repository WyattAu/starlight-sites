...
:::caution Common Pitfall Satellites in low Earth orbit are NOT in "zero gravity." The gravitational
...
:::caution Common Pitfall A geostationary orbit is NOT the same as a geosynchronous orbit. A
