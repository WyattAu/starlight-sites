...
<Aside type="tip">
Tip Straight line with gradient $=-\lambda$. The half-life can be found by finding the time
...
<Aside type="caution">
Warning Because: (1) the detector only intercepts a fraction of emitted radiation (solid
...
<b>If you get this wrong, revise:</b> [Beta Decay ($\beta^-$)](/physics/nuclear-physics/01-radioactivity/)
...
<Aside type="caution">
Warning Only when the parent is much longer-lived than all daughters. If a short-lived
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Radioactivity**? The contains the hardest
...
- [Nuclear Energy](/physics/nuclear-physics/02-nuclear-energy/): Shows how radioactive decay and nuclear reactions release energy through mass-energy conversion.
- [Quantum Physics](/physics/nuclear-physics/03-quantum-physics/): Explains the quantum mechanical basis for radioactive decay and nuclear stability.
