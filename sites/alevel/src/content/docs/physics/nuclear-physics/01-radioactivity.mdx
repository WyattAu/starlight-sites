...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Nuclear Physics", "url": "https://alevel.wyattau.com/physics/nuclear-physics"}, {"name": "01 Radioactivity", "url": "https://alevel.wyattau.com/physics/nuclear-physics/01-radioactivity"}]
}
</script>
title: Radioactivity
...
**Confusing alpha, beta, and gamma radiation:** Alpha particles are helium nuclei ($^4_2\text{He}$), beta particles are electrons ($^0_{-1}\text{e}$), and gamma rays are photons. Students often mix up their charges, masses, and penetrating powers.

**Forgetting that alpha particles are stopped by paper:** Alpha radiation is the least penetrating — stopped by a sheet of paper or skin. Beta is stopped by aluminium. Gamma requires lead or concrete. Students often confuse the stopping materials.

**Misidentifying nuclear equations:** In nuclear equations, both mass number and atomic number must balance. For alpha decay: $^A_Z X \rightarrow ^{A-4}_{Z-2} Y + ^4_2 \text{He}$. For beta decay: $^A_Z X \rightarrow ^A_{Z+1} Y + ^0_{-1} \text{e}$. Students often forget to balance both numbers.

**Confusing activity with count rate:** Activity is the total decays per second (Bq). Count rate is what the detector measures (always less than activity due to detector efficiency and geometry). Students often use them interchangeably.

**Forgetting that half-life is constant:** The half-life of a radioactive substance is constant regardless of the initial amount. After one half-life, 50% remains; after two, 25%; after three, 12.5%. The decay rate depends on the current amount, not the original amount.

</aside>
## Cross-References

- [Nuclear Energy](./02-nuclear-energy.mdx): Shows how radioactive decay and nuclear reactions release energy through mass-energy conversion.
- [Quantum Physics](./03-quantum-physics.mdx): Explains the quantum mechanical basis for radioactive decay and nuclear stability.
- [Half-Life](/physics/half-life): Explores the mathematical treatment of decay rates and activity in more depth.
- [Radiation Safety](/physics/radiation-safety): Covers practical applications and safety considerations when working with radioactive materials.
