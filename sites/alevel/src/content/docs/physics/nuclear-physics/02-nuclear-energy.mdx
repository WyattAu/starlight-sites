...
:::caution Warning But is not fissile --- it cannot sustain a chain reaction with thermal neutrons.
...
:::caution Warning Anti-neutrinos, which interact so weakly that they escape the reactor entirely.
...
:::caution Warning Responds on the timescale set by delayed neutrons ($\sim$Tens of seconds),
...
:::caution Warning Strictly, Ni-62 has the highest $E_b/A$ (8.7945 MeV/nucleon versus Fe-56's 8.7906
