...
<Aside type="caution" title="Warning But is not fissile --- it cannot sustain a chain reaction with thermal neutrons.">
...
<Aside type="caution" title="Warning Anti-neutrinos, which interact so weakly that they escape the reactor entirely.">
...
<Aside type="tip" title="Tip Short half-life isotopes can be stored and left to decay. Long half-life isotopes">
...
<Aside type="tip" title="Tip Critical when $k_{\mathrm{eff}} = 1$. Control rods absorb neutrons to reduce">
...
<Aside type="caution" title="Warning Responds on the timescale set by delayed neutrons ($\sim$Tens of seconds),">
...
<Aside type="tip" title="Tip Moderator and coolant (simpler but lower efficiency), while AGRs separate them (graphite">
...
<Aside type="note" title="Board Note AQA and Edexcel focus on the qualitative aspects of fission and fusion. CIE may">
...
<Aside type="caution" title="Warning Strictly, Ni-62 has the highest $E_b/A$ (8.7945 MeV/nucleon versus Fe-56's 8.7906">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Nuclear Energy**? The contains the hardest">
