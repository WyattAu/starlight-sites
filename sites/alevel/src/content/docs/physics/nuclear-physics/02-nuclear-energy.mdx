...
<Aside type="caution">
Warning But is not fissile --- it cannot sustain a chain reaction with thermal neutrons.
...
<Aside type="caution">
Warning Anti-neutrinos, which interact so weakly that they escape the reactor entirely.
...
<Aside type="tip">
Tip Short half-life isotopes can be stored and left to decay. Long half-life isotopes
...
<Aside type="tip">
Tip Critical when $k_{\mathrm{eff}} = 1$. Control rods absorb neutrons to reduce
...
<Aside type="caution">
Warning Responds on the timescale set by delayed neutrons ($\sim$Tens of seconds),
...
<Aside type="tip">
Tip Moderator and coolant (simpler but lower efficiency), while AGRs separate them (graphite
...
<Aside type="caution">
Warning Strictly, Ni-62 has the highest $E_b/A$ (8.7945 MeV/nucleon versus Fe-56's 8.7906
...
<Aside type="tip">
Tip Ready to test your understanding of **Nuclear Energy**? The contains the hardest
...
- [Radioactivity](/physics/nuclear-physics/01-radioactivity/): Provides the foundation of nuclear decay processes that underpin both fission and fusion.
- [Quantum Physics](/physics/nuclear-physics/03-quantum-physics/): Explains the quantum mechanical principles that govern nuclear stability and decay rates.
