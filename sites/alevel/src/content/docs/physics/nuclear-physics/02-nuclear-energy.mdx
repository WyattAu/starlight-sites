...
<aside aria-label="Warning But is not fissile --- it cannot sustain a chain reaction with thermal neutrons." class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Warning Anti-neutrinos, which interact so weakly that they escape the reactor entirely." class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Short half-life isotopes can be stored and left to decay. Long half-life isotopes" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Tip Critical when $k_{\mathrm{eff}} = 1$. Control rods absorb neutrons to reduce" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Warning Responds on the timescale set by delayed neutrons ($\sim$Tens of seconds)," class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Moderator and coolant (simpler but lower efficiency), while AGRs separate them (graphite" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Board Note AQA and Edexcel focus on the qualitative aspects of fission and fusion. CIE may" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Strictly, Ni-62 has the highest $E_b/A$ (8.7945 MeV/nucleon versus Fe-56's 8.7906" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Ready to test your understanding of **Nuclear Energy**? The contains the hardest" class="starlight-aside starlight-aside--tip">
