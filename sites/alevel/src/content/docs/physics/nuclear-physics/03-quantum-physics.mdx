...
<Aside type="caution">
Warning System." While this is a consequence, it is not the fundamental origin. The
...
<Aside type="tip">
Tip Confirms quantised energy levels." The key points are: (1) the periodic current drops
...
<Aside type="caution">
Warning Only $|\psi(x)|^2 = \psi^*(x)\psi(x)$ has physical meaning as a probability
...
<Aside type="caution">
Warning (nodes), but the probability of finding the particle in an **interval** of finite
...
<b>If you get this wrong, revise:</b>
[Electron in a Box](/physics/nuclear-physics/03-quantum-physics/)
...
- [Radioactivity](/physics/nuclear-physics/01-radioactivity/): Connects quantum mechanical principles to the random nature of radioactive decay and nuclear transitions.
- [Nuclear Energy](/physics/nuclear-physics/02-nuclear-energy/): Shows how mass-energy equivalence and quantum effects enable fission and fusion reactions.
