...
1. **Forgetting internal resistance.** When a question mentions a cell with internal resistance $r$, the terminal PD is $V = \mathcal{E} - Ir$, not directly $\mathcal{E}$. This is the single most common source of errors.
