...
<aside aria-label="Info In terms of molecular bombardment. OCR (A): Historical context and Einstein\'s analysis." class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Latent heat (which changes state at constant temperature). In a heating curve," class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Warning At high temperatures). The equipartition theorem applies to each fully-excited" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Info Of speeds at different temperatures. OCR (A): Ratio of speeds for different gases. CIE:" class="starlight-aside starlight-aside--note">
