...
<Aside type="note" title="Info In terms of molecular bombardment. OCR (A): Historical context and Einstein\'s analysis.">
...
<Aside type="caution" title="Warning Latent heat (which changes state at constant temperature). In a heating curve,">
...
<Aside type="caution" title="Warning At high temperatures). The equipartition theorem applies to each fully-excited">
...
<Aside type="note" title="Info Of speeds at different temperatures. OCR (A): Ratio of speeds for different gases. CIE:">
