...
<Aside type="note">
Info In terms of molecular bombardment. OCR (A): Historical context and Einstein's analysis.
...
<Aside type="caution">
Warning Latent heat (which changes state at constant temperature). In a heating curve,
...
<Aside type="caution">
Warning At high temperatures). The equipartition theorem applies to each fully-excited
...
<Aside type="note">
Info Of speeds at different temperatures. OCR (A): Ratio of speeds for different gases. CIE:
...
[Derivation of $pV = Nk_BT$ from Kinetic Theory](/physics/thermal-physics/01-thermal-properties/)
...
```mermaid
flowchart TD
    A[01 Thermal Propertiesx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Thermodynamics](/physics/thermal-physics/02-thermodynamics/): Builds on thermal properties to explain the laws governing heat, work, and energy transformations.
