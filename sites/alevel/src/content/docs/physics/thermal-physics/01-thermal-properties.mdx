...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Thermal Physics", "url": "https://alevel.wyattau.com/physics/thermal-physics"}, {"name": "01 Thermal Properties", "url": "https://alevel.wyattau.com/physics/thermal-physics/01-thermal-properties"}]
}
</script>
...
**Temperature measures how energetic particles are:** Think of a room full of people bouncing balls. The "temperature" of the room is related to how fast the balls are moving — faster balls mean higher temperature. At absolute zero (0 K), all motion stops — the balls are perfectly still. You can't go below this because you can't have less than zero motion.

**Why it matters:** Thermal physics explains why ice melts, why engines are inefficient, and why absolute zero is unreachable. It connects the microscopic world of atoms to the macroscopic world of heat and temperature that we experience daily.

**The key insight:** Heat and temperature are not the same thing. A swimming pool at 30°C has much more thermal energy than a cup of tea at 80°C, because the pool has vastly more water molecules. Temperature measures average energy per molecule; heat measures total energy.
...
<strong>Info In terms of molecular bombardment. OCR (A): Historical context and Einstein\'s analysis.</strong>
...
<PhetSimulation client:only="solid-js" simulationId="energy-forms-and-changes" title="Energy Forms and Changes" />
...
<strong>Warning Latent heat (which changes state at constant temperature). In a heating curve,</strong>
...
<aside class="starlight-aside starlight-aside--caution">
<strong>Warning At high temperatures). The equipartition theorem applies to each fully-excited</strong>
...
<aside class="starlight-aside starlight-aside--note">
<strong>Info Of speeds at different temperatures. OCR (A): Ratio of speeds for different gases. CIE:</strong>
...
**Answer.**
$\frac{v_{\mathrm{rms}}(\mathrm{He})}{v_{\mathrm{rms}}(\mathrm N_2)} = \sqrt{\frac{M_r(\mathrm N_2)}{M_r(\mathrm{He})}} = \sqrt{\frac{28}{4}} = \sqrt{7} \approx 2.65$.
...
**Confusing temperature with heat:** Temperature is a measure of average kinetic energy of particles. Heat is the transfer of thermal energy between objects at different temperatures. A large object at low temperature can have more thermal energy than a small object at high temperature.

**Forgetting to convert between Kelvin and Celsius:** All thermodynamic calculations must use Kelvin. $T(K) = T(°C) + 273.15$. Students often forget this conversion, especially in gas law calculations.

**Misapplying $Q = mc\Delta T$:** This formula only applies to temperature changes within a single phase. For phase changes, use $Q = mL$. Students often incorrectly use $mc\Delta T$ during melting or boiling.

**Confusing specific heat capacity with latent heat:** Specific heat capacity ($c$) is energy per unit mass per degree temperature change. Latent heat ($L$) is energy per unit mass per phase change at constant temperature. They have different units (J/kg·K vs J/kg).

**Forgetting that internal energy includes both kinetic and potential:** Internal energy is the sum of all microscopic kinetic energies (related to temperature) and potential energies (related to intermolecular bonds). Heating a gas increases kinetic energy; melting ice increases potential energy.

## Cross-References

- [Thermodynamics](./02-thermodynamics.mdx): Builds on thermal properties to explain the laws governing heat, work, and energy transformations.
- [Ideal Gas Laws](/physics/ideal-gas-laws): Connects the microscopic kinetic theory to macroscopic gas behaviour through the ideal gas equation.
- [Energy Conservation](/physics/energy-conservation): Shows how thermal energy fits into the broader principle of energy conservation and transformation.
- [Phase Changes](/physics/phase-changes): Explores the latent heat concepts introduced here in the context of melting, boiling, and condensation.
