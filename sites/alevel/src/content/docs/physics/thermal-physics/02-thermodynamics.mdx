...
<aside aria-label="Warning Work done **by** the system. Always check which convention is being used. We use" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common Pitfall Students often confuse engine efficiency ($\eta = W/Q_H$) with" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Give a consequence (no 100% efficient engine), and explain in terms of entropy if" class="starlight-aside starlight-aside--tip">
