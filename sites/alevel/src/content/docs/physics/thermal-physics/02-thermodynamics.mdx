...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Thermal Physics", "url": "https://alevel.wyattau.com/physics/thermal-physics"}, {"name": "02 Thermodynamics", "url": "https://alevel.wyattau.com/physics/thermal-physics/02-thermodynamics"}]
}
</script>
...
**Energy is always conserved, but quality degrades:** The first law says energy cannot be created or destroyed — but the second law says it always spreads out. A hot cup of tea cools down because heat flows to the cooler room. The total energy is the same, but it becomes less useful — you can't run an engine from a cup of tea at room temperature because there's no temperature difference to exploit.

**Why it matters:** Thermodynamics explains why perpetual motion machines are impossible, why engines have maximum efficiency limits, and why entropy always increases. It's the science of energy conversion and the reason why the universe tends toward disorder.

**The key insight:** The second law of thermodynamics is the reason you can't unscramble an egg. Entropy (disorder) always increases in isolated systems. This isn't just a physical law — it's why time has a direction, why memories exist but not "pre-memories," and why the universe is running down.
...
<strong>Warning Work done **by** the system. Always check which convention is being used. We use</strong>
...
<aside class="starlight-aside starlight-aside--caution">
<strong>Common Pitfall Students often confuse engine efficiency ($\eta = W/Q_H$) with</strong>
...
<strong>Tip Give a consequence (no 100% efficient engine), and explain in terms of entropy if</strong>
...
**Confusing the first and second laws of thermodynamics:** The first law is energy conservation: $\Delta U = Q + W$. The second law states that entropy of an isolated system always increases. They address different concepts — don't conflate them.

**Getting the sign convention wrong:** In $\Delta U = Q + W$, $Q$ is positive when heat enters the system, $W$ is positive when work is done on the system. Some textbooks use $\Delta U = Q - W$ where $W$ is work done BY the system. Always check which convention your course uses.

**Assuming all processes are reversible:** A process is only reversible if it can be returned to its initial state with no net change in the system or surroundings. In practice, all real processes are irreversible due to friction and heat flow across finite temperature differences.

**Misunderstanding entropy:** Entropy is a measure of the number of microstates available to a system. The second law says total entropy of an isolated system always increases, but the entropy of a PART of the system can decrease if the surroundings increase by more.

**Confusing isothermal with adiabatic processes:** Isothermal means constant temperature ($\Delta T = 0$). Adiabatic means no heat transfer ($Q = 0$). They're different processes with different curves on p-V diagrams. Students often confuse the two.

## Cross-References

- [Thermal Properties](./01-thermal-properties.mdx): Provides the foundation of heat capacity, temperature, and kinetic theory needed to understand thermodynamic processes.
- [Ideal Gas Laws](/physics/ideal-gas-laws): Shows how the gas laws emerge from thermodynamic principles and kinetic theory.
- [Entropy](/physics/entropy): Explores the second law of thermodynamics and its implications for the direction of natural processes.
- [Efficiency](/physics/efficiency): Applies the first and second laws to real-world engines and refrigerators, calculating maximum possible efficiency.
