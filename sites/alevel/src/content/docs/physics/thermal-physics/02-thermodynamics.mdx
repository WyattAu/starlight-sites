...
<Aside type="caution">
Warning Work done **by** the system. Always check which convention is being used. We use
...
<Aside type="tip">
Tip Give a consequence (no 100% efficient engine), and explain in terms of entropy if
...
- [Thermal Properties](/physics/thermal-physics/01-thermal-properties/): Provides the foundation of heat capacity, temperature, and kinetic theory needed to understand thermodynamic processes.
...
- [Efficiency](https://driving-us.wyattau.com/fuel-efficiency/): Applies the first and second laws to real-world engines and refrigerators, calculating maximum possible efficiency.
