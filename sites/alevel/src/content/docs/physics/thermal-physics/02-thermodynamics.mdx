...
title: "Thermodynamics | A-Level - Wyatt's Notes"
...
1. This applies to any process, whether reversible or irreversible.
...
1. Since the volume change $\Delta V = A\Delta x$:
...
```mermaid
flowchart TD
    A[02 Thermodynamicsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Thermal Properties](./01-thermal-properties): Provides the foundation of heat capacity, temperature, and kinetic theory needed to understand thermodynamic processes.
- [Ideal Gas Laws](/physics/ideal-gas-laws): Shows how the gas laws emerge from thermodynamic principles and kinetic theory.
- [Entropy](../../chemistry/physical-chemistry-extra/entropy-and-gibbs): Explores the second law of thermodynamics and its implications for the direction of natural processes.
- [Efficiency](../../../../../../driving-us/src/content/docs/fuel-efficiency): Applies the first and second laws to real-world engines and refrigerators, calculating maximum possible efficiency.
