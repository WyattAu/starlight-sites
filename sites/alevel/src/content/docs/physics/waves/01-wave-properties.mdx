...
<aside aria-label="Common Pitfall Electromagnetic waves are transverse but do not require a medium — they" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Exam Technique When asked to sketch a longitudinal wave, draw a series of vertical lines" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Board Note AQA and OCR (A) require Malus\'s law. CIE focuses on polarisation by filters." class="starlight-aside starlight-aside--note">
...
<aside aria-label="Exam Technique Memorise the order: **R**adio, **M**icrowave, **I**nfrared, **V**isible," class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Technique Phase difference questions often require you to identify two points on a wave" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Wave Properties**? The contains the hardest" class="starlight-aside starlight-aside--tip">
