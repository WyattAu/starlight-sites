...
<Aside type="caution" title="Common Pitfall Electromagnetic waves are transverse but do not require a medium — they">
Propagate through vacuum via oscillating electric and magnetic fields. Sound waves are longitudinal
And require a medium.
</Aside>
<Aside type="tip" title="Exam Technique When asked to sketch a longitudinal wave, draw a series of vertical lines">
...
<Aside type="note" title="Board Note AQA and OCR (A) require Malus\'s law. CIE focuses on polarisation by filters.">
...
<Aside type="tip" title="Exam Technique Memorise the order: **R**adio, **M**icrowave, **I**nfrared, **V**isible,">
...
<Aside type="tip" title="Exam Technique Phase difference questions often require you to identify two points on a wave">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Wave Properties**? The contains the hardest">
