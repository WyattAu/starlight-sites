...
<b>If you get this wrong, revise:</b>
[Real-World Application: Seismic Waves](/physics/waves/01-wave-properties/)
...
<b>If you get this wrong, revise:</b>
[Real-World Application: Doppler Ultrasound](/physics/waves/01-wave-properties/)
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Wave Properties**? The contains the hardest
...
- [Superposition and Interference](/physics/waves/02-superposition-and-interference/): Expands on how multiple waves combine, building on the wave properties defined here.
- [Refraction and Total Internal Reflection](/physics/waves/03-refraction-and-total-internal-reflection/): Applies wave speed and wavelength concepts to explain how waves change direction at boundaries.
- [Electromagnetic Waves](https://physics.wyattau.com/3-electromagnetism/5_electromagnetic-waves/): Connects the EM spectrum covered here with detailed properties and applications of electromagnetic radiation.
- [Sound Waves](https://hsc.wyattau.com/physics/waves/): Explores longitudinal wave behaviour in more depth, including resonance and musical applications.
