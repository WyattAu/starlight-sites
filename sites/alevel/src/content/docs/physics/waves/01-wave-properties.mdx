...
title: "Wave Properties | A-Level - Wyatt's Notes"
...
- **Misidentifying points on a wave that are in phase:** Two points are in phase if the distance
  between them is a whole number of wavelengths (n _lambda). They are in antiphase if the distance
  is an odd multiple of half-wavelengths ((n + 0.5)_ lambda). The phase difference between adjacent
  points is 2 _pi_ (path difference) / lambda.
...
```mermaid
flowchart TD
    A[01 Wave Propertiesx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Superposition and Interference](02-superposition-and-interference): Expands on how multiple waves combine, building on the wave properties defined here.
- [Refraction and Total Internal Reflection](03-refraction-and-total-internal-reflection): Applies wave speed and wavelength concepts to explain how waves change direction at boundaries.
- [Electromagnetic Waves](../../../../../../physics/src/content/docs/3-electromagnetism/5_electromagnetic-waves): Connects the EM spectrum covered here with detailed properties and applications of electromagnetic radiation.
- [Sound Waves](../../../../../../hsc/src/content/docs/physics/waves): Explores longitudinal wave behaviour in more depth, including resonance and musical applications.
