...
<aside aria-label="Warning Not coherent because the phase difference fluctuates randomly. Interference" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip (single slit before the double slit), narrow slits, monochromatic light, and the" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Technique If asked to find the number of visible orders: calculate $d/\lambda$Take the" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Tip Ready to test your understanding of **Superposition and Interference**? The contains the" class="starlight-aside starlight-aside--tip">
