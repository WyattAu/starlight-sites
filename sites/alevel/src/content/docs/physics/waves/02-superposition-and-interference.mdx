...
description: "ALEVEL Physics notes: Superposition and Interference. Comprehensive study material with definitions, examples, and assessment tools."
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "alevel", "url": "https://alevel.wyattau.com"}, {"name": "Physics", "url": "https://alevel.wyattau.com/physics"}, {"name": "Waves", "url": "https://alevel.wyattau.com/physics/waves"}, {"name": "02 Superposition And Interference", "url": "https://alevel.wyattau.com/physics/waves/02-superposition-and-interference"}]
}
</script>
...
<PhetSimulation client:only="solid-js" simulationId="wave-interference" title="Wave Interference" />

Explore the simulation above to develop intuition for this topic.

## Intuition

**When waves meet, they add together — but don't collide:** Think of two people swinging ropes towards each other on the same string. When the waves cross, the string's displacement at any point is the sum of both waves. After they pass through each other, they continue unchanged — waves don't bounce off each other like billiard balls.

**Why it matters:** Interference explains why you can hear music from two speakers at once, why noise-cancelling headphones work, and how holograms are made. It's also the key to understanding diffraction — the bending of waves around obstacles.

**The key insight:** Constructive interference happens when waves are in phase (peaks align with peaks), doubling the amplitude. Destructive interference happens when waves are out of phase (peaks align with troughs), cancelling completely. This is the principle behind noise cancellation — your headphones produce a wave that is the exact inverse of the outside noise.
...
<strong>Warning Not coherent because the phase difference fluctuates randomly. Interference</strong>
...
<strong>Tip (single slit before the double slit), narrow slits, monochromatic light, and the</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Exam Technique If asked to find the number of visible orders: calculate $d/\lambda$Take the</strong>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Tip Ready to test your understanding of **Superposition and Interference**? The contains the</strong>
...
**Confusing constructive and destructive interference:** Constructive interference occurs when waves are in phase (path difference = $n\lambda$), producing maximum amplitude. Destructive interference occurs when waves are out of phase (path difference = $(n + 0.5)\lambda$), producing minimum amplitude. Students often mix up the conditions.

**Forgetting that interference requires coherent sources:** Two sources are coherent only if they have the same frequency and a constant phase relationship. Two separate light bulbs don't produce interference patterns because they're not coherent. Lasers are coherent.

**Misapplying the double-slit formula:** The fringe spacing formula $x = \frac{\lambda L}{d}$ assumes small angles ($\sin\theta \approx \tan\theta$). For large angles or small $L/d$, this approximation breaks down. Students often use it without checking the assumption.

**Confusing diffraction with interference:** Diffraction is the bending of waves around obstacles or through openings. Interference is the superposition of two or more waves. Diffraction causes the spreading that allows interference to occur, but they're different phenomena.

**Forgetting that intensity is proportional to amplitude squared:** When two waves interfere constructively, the resultant amplitude is $2A$, so intensity is $4I_0$ (not $2I_0$). Students often forget the squared relationship.

## Cross-References

- [Wave Properties](../01-wave-properties.mdx): Provides the foundational definitions of wavelength, frequency, and wave speed needed to understand interference patterns.
- [Refraction and Total Internal Reflection](../03-refraction-and-total-internal-reflection.mdx): Explains how wave speed changes at boundaries, which affects path differences in interference.
- [Diffraction](/physics/diffraction): Explores how waves spread around obstacles, a key phenomenon related to interference and superposition.
- [Standing Waves](/physics/standing-waves): Shows how interference of two identical waves traveling in opposite directions creates stationary patterns.
