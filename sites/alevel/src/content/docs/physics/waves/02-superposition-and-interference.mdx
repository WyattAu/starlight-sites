...
```mermaid
flowchart TD
    A[02 Superposition And Interferencex] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Wave Properties](01-wave-properties): Provides the foundational definitions of wavelength, frequency, and wave speed needed to understand interference patterns.
- [Refraction and Total Internal Reflection](03-refraction-and-total-internal-reflection): Explains how wave speed changes at boundaries, which affects path differences in interference.
- [Diffraction](../../../../../../physics/src/content/docs/4-optics-and-waves/16_detailed-diffraction-theory): Explores how waves spread around obstacles, a key phenomenon related to interference and superposition.
- [Standing Waves](../../../../../../hsc/src/content/docs/physics/waves): Shows how interference of two identical waves traveling in opposite directions creates stationary patterns.
