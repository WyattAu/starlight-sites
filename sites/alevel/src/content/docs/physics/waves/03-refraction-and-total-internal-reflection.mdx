...
<Aside type="caution">
Warning Medium. Light going from air into glass can never undergo TIR, no matter how
...
<Aside type="tip">
Tip Higher bandwidth, no electromagnetic interference, lighter weight, no electrical sparking
...
<Aside type="tip">
Tip Ready to test your understanding of **Refraction and TIR**? The
...
- [Wave Properties](/physics/waves/01-wave-properties/): Establishes the relationship between wave speed, frequency, and wavelength that governs refraction.
- [Superposition and Interference](/physics/waves/02-superposition-and-interference/): Shows how phase differences arise from path differences, which can be affected by refraction.
...
- [Total Internal Reflection](/physics/diagnostics/diag-refraction-total-internal-reflection/): Explores the critical angle phenomenon and its applications in fiber optics and mirages.
