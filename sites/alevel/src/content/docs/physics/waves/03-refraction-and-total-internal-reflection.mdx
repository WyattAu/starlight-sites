...
<aside aria-label="Board Coverage AQA Paper 2 (required practical on refraction) | Edexcel CP2 | OCR (A) Paper" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Medium. Light going from air into glass can never undergo TIR, no matter how" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Tip Higher bandwidth, no electromagnetic interference, lighter weight, no electrical sparking" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Tip Ready to test your understanding of **Refraction and TIR**? The" class="starlight-aside starlight-aside--tip">
