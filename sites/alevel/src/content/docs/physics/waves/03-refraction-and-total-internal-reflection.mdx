...
<Aside type="note" title="Board Coverage AQA Paper 2 (required practical on refraction) | Edexcel CP2 | OCR (A) Paper">
...
<Aside type="caution" title="Warning Medium. Light going from air into glass can never undergo TIR, no matter how">
...
<Aside type="tip" title="Tip Higher bandwidth, no electromagnetic interference, lighter weight, no electrical sparking">
...
<Aside type="tip" title="Tip Ready to test your understanding of **Refraction and TIR**? The">
