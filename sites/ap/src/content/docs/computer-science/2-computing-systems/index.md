...
sources:
  - text: Standard textbook reference
description: "Comprehensive 2 computing systems study notes for ap with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
...
- [2_computing Systems](./2_computing-systems)
