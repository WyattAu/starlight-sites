...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "ap", "url": "https://ap.wyattau.com"}, {"name": "Physics", "url": "https://ap.wyattau.com/physics"}, {"name": "1 Kinematics", "url": "https://ap.wyattau.com/physics/1-kinematics"}, {"name": "1_kinematics", "url": "https://ap.wyattau.com/physics/1-kinematics/1_kinematics"}]
}
</script>
title: Kinematics
...
Kinematics is the **language of motion** — it describes *what* is happening without asking *why*. Think of it as the GPS of physics: it tells you position, velocity, and acceleration, but not the forces causing them.

**The calculus connection:** Velocity is the derivative of position, acceleration is the derivative of velocity. This isn't just a formula — it's the *definition*. The kinematic equations for constant acceleration are simply what you get when you integrate $a = \text{const}$ once (to get $v$) and twice (to get $x$). If acceleration isn't constant, you must use calculus directly.
...
**Circular motion intuition:** Even at constant speed, an object moving in a circle is accelerating — because acceleration is the rate of change of the *velocity vector*, and the direction keeps changing. This centripetal acceleration always points toward the center, like a tether pulling the object inward.
