...
<Aside type="note" title="Example: Identifying Action-Reaction Pairs">
...
<Aside type="note" title="Example: Block on an Inclined Plane">
...
- [Kinematics](/physics/1-kinematics/1_kinematics/) -- Newton's laws explain the forces that cause the motion described by kinematic equations.
- [Work, Energy, and Power](/physics/3-work-energy-power/3_work-energy-power/) -- The work-energy theorem connects force and displacement to energy changes.
- [Momentum and Impulse](/physics/4-momentum-and-impulse/4_momentum-and-impulse/) -- Newton's second law in the form F = dp/dt directly links force to the rate of change of momentum.
