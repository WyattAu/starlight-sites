...
<Aside type="note" title="Example: With Friction">
...
<Aside type="note">
Info Air density, $C_D$ is the drag coefficient, and $A$ is the cross-sectional area. This
...
- **[Kinematics](/physics/1-kinematics/1_kinematics/):** Work-energy theorem connects force and displacement to changes in speed without needing time.
- **[Momentum and Impulse](/physics/4-momentum-and-impulse/4_momentum-and-impulse/):** Work-energy and impulse-momentum are complementary approaches, energy for scalar problems, momentum for vector problems.
- **[Newton's Laws](/physics/2-newtons-laws/2_newtons-laws/):** Newton's second law is the foundation; work-energy is its integral form.
