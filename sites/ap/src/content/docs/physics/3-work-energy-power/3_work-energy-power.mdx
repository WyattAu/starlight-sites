...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "ap", "url": "https://ap.wyattau.com"}, {"name": "Physics", "url": "https://ap.wyattau.com/physics"}, {"name": "3 Work Energy Power", "url": "https://ap.wyattau.com/physics/3-work-energy-power"}, {"name": "3_work Energy Power", "url": "https://ap.wyattau.com/physics/3-work-energy-power/3_work-energy-power"}]
}
</script>
...
**Power intuition:** Power is the *rate* of energy transfer — how fast you do work. Two cars can deliver the same work (same KE change), but the sports car does it in less time (higher power). On the AP exam, problems often ask "how long does it take?" which is a power question, not an energy question.
