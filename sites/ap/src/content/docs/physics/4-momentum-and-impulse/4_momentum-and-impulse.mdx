...
<Aside type="note">
Info Make the block complete full vertical circles. In most textbook versions, the block
...
- **[Kinematics](/physics/1-kinematics/1_kinematics/):** Momentum conservation applies during collisions, kinematics describes the motion before and after.
- **[Work, Energy, and Power](/physics/3-work-energy-power/3_work-energy-power/):** Energy is conserved in elastic collisions; momentum is always conserved.
- **[Newton's Laws](/physics/2-newtons-laws/2_newtons-laws/):** Impulse is the integral of force over time, Newton's second law in momentum form.
