...
:::note[Example: Multi-loop circuit]
...
:::note[Example: RC circuit with numerical values]
...
:::note[Example: Discharging through two parallel resistors]
...
- **[Electrostatics](/physics/6-electrostatics/6_electrostatics/):** Understanding electric fields and potential is essential for circuit analysis.
- **[Work, Energy, and Power](/physics/3-work-energy-power/3_work-energy-power/):** Electrical power and energy dissipation in resistors follow the same power formulas.
- **[Magnetism](/physics/8-magnetism/8_magnetism/):** Changing currents create magnetic fields, the bridge between circuits and magnetism.
