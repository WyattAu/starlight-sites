...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "Alcohols", "url": "https://cbse.wyattau.com/chemistry/alcohols"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/alcohols/index"}]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "description": "CBSE Class 12 chemistry: Classification, reactions, and worked examples.",
  "provider": {
    "@type": "Organization",
    "name": "Wyatt's Notes",
...
- Classification: primary ($1°$), secondary ($2°$), tertiary ($3°$) based on carbon bearing $-\text{OH}$
...
- Dehydration: alcohols $\xrightarrow{\text{H}_2\text{SO}_4, \Delta}$ alkenes (Saytzeff's rule)
...
- Tertiary alcohols resist oxidation (no H on the carbon bearing $-\text{OH}$)
...
- **Phenol:** Phenoxide ion is stabilized by resonance (negative charge delocalized into the ring). $pK_a = 10$

- **Water:** Hydroxide ion has no resonance stabilization. $pK_a = 15.7$

- **Ethanol:** Ethoxide ion is destabilized by the electron-donating ethyl group. $pK_a = 16$
