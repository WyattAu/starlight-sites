...
description: "Comprehensive study notes for Biomolecules with worked examples, practice problems, and key concepts for exam preparation."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "Biomolecules", "url": "https://cbse.wyattau.com/chemistry/biomolecules"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/biomolecules/index"}]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type": "Course",
  "name": "Biomolecules",
  "description": "CBSE Class 12 chemistry: Carbohydrates, proteins, nucleic acids, and worked examples.",
  "provider": {
    "@type": "Organization",
    "name": "Wyatt's Notes",
...
- Carbohydrates: polyhydroxy aldehydes or ketones ($C_n(H_2O)_n$)
...
- Amino acids: contain $-\text{NH}_2$ and $-\text{COOH}$ groups
- Peptide bond: $-\text{CO}-\text{NH}-$ (condensation of $-\text{COOH}$ and $-\text{NH}_2$)
...
Glycine: $\text{NH}_2\text{CH}_2\text{COOH}$ (R = H)
