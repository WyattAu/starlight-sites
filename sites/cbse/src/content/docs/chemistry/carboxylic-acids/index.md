...
title: "Carboxylic Acids | CBSE - Wyatt's Notes"
description: "Comprehensive study notes for Carboxylic Acids with worked examples, practice problems, and key concepts for exam preparation."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "Carboxylic Acids", "url": "https://cbse.wyattau.com/chemistry/carboxylic-acids"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/carboxylic-acids/index"}]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "description": "CBSE Class 12 chemistry: Reactions, derivatives, and worked examples.",
  "provider": {
    "@type": "Organization",
    "name": "Wyatt's Notes",
...
- Electron-withdrawing groups increase acidity (e.g., Cl$_3$CCOOH > CH$_3$COOH)
...
- **Trichloroacetic acid (Cl$_3$CCOOH):** Three electron-withdrawing Cl atoms stabilize the carboxylate through inductive effect. $pK_a = 0.65$

- **Chloroacetic acid (ClCH$_2$COOH):** One Cl atom provides moderate stabilization. $pK_a = 2.86$

- **Acetic acid (CH$_3$COOH):** No electron-withdrawing groups. $pK_a = 4.76$

Decreasing acidity: Cl$_3$CCOOH > ClCH$_2$COOH > CH$_3$COOH
...
Mechanism: P reacts with Br$_2$ to form PBr$_3$, which converts RCOOH to RCOBr (acid bromide). The acid bromide undergoes enolization and bromination at the alpha position, then hydrolysis gives the alpha-bromo acid.
...
2. Write the reaction of ethanoic acid with PCl$_5$.
