...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "Chemistry In Everyday", "url": "https://cbse.wyattau.com/chemistry/chemistry-in-everyday"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/chemistry-in-everyday/index"}]
}
</script>
...
- Drug: chemical substance that interacts with a biological receptor
...
- Antacids: neutralize stomach acid (NaHCO$_3$, Mg(OH)$_2$, Al(OH)$_3$)
...
**Hard water** contains Ca$^{2+}$ and Mg$^{2+}$ ions.
...
Detergents (sodium dodecyl sulfate, $\text{C}_{12}\text{H}_{25}\text{OSO}_3\text{Na}$) do not form insoluble precipitates with Ca$^{2+}$ and Mg$^{2+}$ because their calcium salts are soluble.
...
**Common mistake:** Using NaOH or KOH as antacids. Strong bases are too corrosive for internal use; weak bases like Mg(OH)$_2$ are preferred.

## Practice Problems

1. Write the structure of paracetamol (acetaminophen).
2. Explain why antibiotics should not be taken without prescription.
3. What is the difference between a soap and a detergent in terms of structure?
...
- **Biomolecules:** Drug design targets biomolecules (enzymes, receptors), understanding protein structure explains how drugs work.
