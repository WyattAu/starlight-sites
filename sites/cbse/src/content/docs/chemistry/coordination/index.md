...
title: "Coordination Compounds | CBSE - Wyatt's Notes"
description: "Comprehensive study notes for Coordination Compounds with worked examples, practice problems, and key concepts for exam preparation."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "Coordination", "url": "https://cbse.wyattau.com/chemistry/coordination"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/coordination/index"}]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "description": "CBSE Class 12 chemistry: Werner's theory, IUPAC naming, isomerism, and worked examples.",
  "provider": {
    "@type": "Organization",
    "name": "Wyatt's Notes",
...
- Spectrochemical series: I$^-$ < Br$^-$ < Cl$^-$ < F$^-$ < OH$^-$ < H$_2$O < NH$_3$ < en < NO$_2$ < CN$^-$
...
Step 3: Metal with oxidation state:
Co oxidation state: $x + 0 + 2(-1) = +1$ (charge of complex ion), so $x = +3$
Metal name: cobalt(III) (cation, so use element name)
...
Fe$^{3+}$: $[\text{Ar}] 3d^5$ (5 d electrons)
...
1. Name $[\text{Pt(NH}_3)_2\text{Cl}_2]$.
2. For $[\text{CoF}_6]^{3-}$, determine the number of unpaired electrons.
3. Identify the type of isomerism in $[\text{Co(NH}_3)_4\text{Cl}_2]^+$.
