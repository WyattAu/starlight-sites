...
description: "Comprehensive study notes for F-Block Elements with worked examples, practice problems, and key concepts for exam preparation."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cbse", "url": "https://cbse.wyattau.com"}, {"name": "Chemistry", "url": "https://cbse.wyattau.com/chemistry"}, {"name": "F Block", "url": "https://cbse.wyattau.com/chemistry/f-block"}, {"name": "Index", "url": "https://cbse.wyattau.com/chemistry/f-block/index"}]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "description": "CBSE Class 12 chemistry: Lanthanoids, actinoids, properties, and worked examples.",
  "provider": {
    "@type": "Organization",
    "name": "Wyatt's Notes",
...
- Lanthanoid contraction: steady decrease in ionic radii from La$^{3+}$ to Lu$^{3+}$
...
- Lanthanoids are paramagnetic (except La$^{3+}$ and Lu$^{3+}$)
...
Result: Zr$^{4+}$ and Hf$^{4+}$ have nearly identical sizes, leading to very similar chemistry.
...
Gd (Z = 64): $[\text{Xe}] 4f^7 5d^1 6s^2$ (exception to the filling order)
...
Uranium (Z = 92): $[\text{Rn}] 5f^3 6d^1 7s^2$
...
$\text{UF}_6$ is used in uranium enrichment (gaseous diffusion process) because it sublimes at 56°C.
...
1. Write the electron configuration of Eu$^{3+}$ (Z = 63).
2. Explain why Ce$^{4+}$ is a stronger oxidizing agent than La$^{3+}$.
3. Why is $\text{UO}_2$ used as a nuclear fuel?
