...
sources:
  - text: Standard textbook reference
title: "Electrostatics | CBSE - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive study notes for Electrostatics with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
---
sources:
