...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    {"name": "Home", "url": "https://chemistry.wyattau.com"},
    {"name": "Practice Test", "url": "https://chemistry.wyattau.com/practice-test-mega"}
  ]
}
</script>
...
$[H^+] = \sqrt{K_a \cdot C} = \sqrt{1.8 \times 10^{-5} \times 0.10} = \sqrt{1.8 \times 10^{-6}} = 1.34 \times 10^{-3}$ M.
...
| # | Option |
| --- | --- |
| A | Using $\text{NaOCH}_3$ in methanol |
| B | Using $\text{KO}^t\text{Bu}$ in $\text{^tBuOH}$ |
| C | Using $\text{NaNH}_2$ in liquid ammonia |
| D | Using water (solvolysis) |
| E | Using $\text{LiAlH}_4$ in ether |
...
| --- | --- |
| A | $\text{PhMgBr}$ |
| B | $\text{PhCH}_2\text{MgBr}$ |
| C | $\text{MeMgBr}$ |
| D | $\text{CH}_2=\text{CHMgBr}$ |
| E | $\text{PhOH}$ |
...
| # | Option |
| --- | --- |
| A | $[\text{Co(NH}_3)_5\text{Br}]\text{SO}_4$ and $[\text{Co(NH}_3)_5\text{SO}_4]\text{Br}$ |
| B | $[\text{Co(NH}_3)_4\text{Cl}_2]\text{NO}_2$ and $[\text{Co(NH}_3)_4(\text{NO}_2)_2]\text{Cl}$ |
| C | $[\text{Pt(NH}_3)_4][\text{PtCl}_4]$ and $[\text{Pt(NH}_3)_3\text{Cl}][\text{Pt(NH}_3)\text{Cl}_3]$ |
| D | Both A and B |
| E | All of A, B, and C |
...
| C | $\text{AlCl}_3$ is thermodynamically unstable |
