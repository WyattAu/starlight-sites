    ...
    starlight({
      ...
      sidebar: [
        ...
        { label: 'UK Citizenship', items: [{ autogenerate: { directory: 'uk-citizenship' } }] },
        {
          ...
          items: [{ autogenerate: { directory: 'canadian-citizenship' } }],
        },
        {
      ...
      head: [
        ...
        { tag: 'meta', attrs: { name: 'theme-color', content: '#6a994e' } },
        {
          tag: 'link',
          attrs: {
            rel: 'preload',
        ...
        },
        {
          ...
          attrs: {
            property: 'og:image',
            content: 'https://civics-tests.wyattau.com/img/social-card.svg',
          },
        },
        { tag: 'script', attrs: { src: '/cross-site-search.js', defer: true } },
        {
          ...
          content: JSON.stringify({
            ...
            '@type': 'WebSite',
            name: 'Civics Tests',
            description: 'Civics knowledge tests and revision materials',
