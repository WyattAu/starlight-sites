...
description: "import { flashcards1, flashcards2, flashcards3, flashcards4 } from '@/data/flashcards/computing/1-discrete-mathematics/8_flashcards-discrete-mathematics-data.js"
tags:
  - University
  - Computing
  - Flashcards
...
- **[Algorithms](../2-algorithms-and-data-structures/10_flashcards-algorithms-and-data-structures):** Algorithm design techniques build on discrete math foundations.
- **[Theory of Computation](../3-theory/flashcards-theory):** Automata theory and complexity classes use formal languages from discrete math.
- **[Databases](../4-databases/13_flashcards-databases):** Relational databases are based on set theory and relations from discrete math.
