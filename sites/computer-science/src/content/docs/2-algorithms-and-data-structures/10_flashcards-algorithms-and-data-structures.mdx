...
description: "import { flashcards1, flashcards2, flashcards3, flashcards4 } from '@/data/flashcards/computing/2-algorithms-and-data-structures/10_flashcards-algorithms-and-da"
tags:
  - University
  - Computing
  - Flashcards
...
- **[Algorithm Analysis](/2-algorithms-and-data-structures/1_algorithm_analysis/):** Formal complexity analysis for the data structures covered here.
- **[Dynamic Programming](/2-algorithms-and-data-structures/5_dynamic-programming/):** Memoisation and tabulation patterns tested in the flashcards.
- **[Discrete Mathematics](/1-discrete-mathematics/8_flashcards-discrete-mathematics/):** Graph theory and combinatorics underpin algorithm design.
- **[Theory of Computation](/3-theory/flashcards-theory/):** Complexity classes classify algorithm efficiency.
