...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "2 Algorithms And Data Structures", "url": "https://computer-science.wyattau.com/2-algorithms-and-data-structures"}, {"name": "6_advanced Topics", "url": "https://computer-science.wyattau.com/2-algorithms-and-data-structures/6_advanced-topics"}]
}
</script>
...
- [Algorithm Analysis](/2-algorithms-and-data-structures/1_algorithm-analysis/) -- Advanced algorithm design uses amortised analysis and potential methods beyond basic complexity.
- [Dynamic Programming](/2-algorithms-and-data-structures/5_dynamic-programming/) -- Advanced topics include approximation algorithms and randomised algorithms that complement dynamic programming.
- [Graph Algorithms](/2-algorithms-and-data-structures/4_graph-algorithms/) -- Network flow and matching algorithms are advanced graph problems with practical applications.
