...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "2 Systems", "url": "https://computer-science.wyattau.com/2-systems"}, {"name": "Flashcards Systems", "url": "https://computer-science.wyattau.com/2-systems/flashcards-systems"}]
}
</script>
title: "University CS Flashcards: Systems"
description: "20 interactive flashcards for university-level Computer Systems. Press Space to flip, rate 1-4."
...
**Confusing little-endian and big-endian byte ordering.** Little-endian stores the least significant byte first; big-endian stores the most significant byte first. Network protocols typically use big-endian; x86 processors use little-endian. Mixing them without conversion corrupts data.
...
- **[Operating Systems](../../5-operating-systems/index.md):** Process management, memory, and synchronisation covered in systems; OS implements the abstractions.
- **[Databases](../../4-databases/index.md):** Transaction management and concurrency control in systems context; databases depend on OS for I/O and memory.
- **[Theory of Computation](../../3-theory/flashcards-theory.mdx):** Computability limits affect what systems can and cannot do automatically.
