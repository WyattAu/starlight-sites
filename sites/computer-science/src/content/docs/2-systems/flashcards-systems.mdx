...
- **[Operating Systems](../../5-operating-systems/index.md):** Process management, memory, and synchronisation covered in systems.
- **[Databases](../../4-databases/index.md):** Transaction management and concurrency control in systems context.
