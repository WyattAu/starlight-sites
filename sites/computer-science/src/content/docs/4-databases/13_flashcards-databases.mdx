...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "4 Databases", "url": "https://computer-science.wyattau.com/4-databases"}, {"name": "13_flashcards Databases", "url": "https://computer-science.wyattau.com/4-databases/13_flashcards-databases"}]
}
</script>
...
- **[Databases Practice](../14_practice-databases.mdx):** Auto-graded problems testing database concepts.
- **[Systems](../../2-systems/index.md):** Computer architecture that database systems build upon; I/O and memory management matter.
- **[Theory of Computation](../../3-theory/flashcards-theory.mdx):** Formal languages underlying query languages; relational algebra is formal.
- **[Operating Systems](../../5-operating-systems/12_flashcards-operating-systems.mdx):** OS provides file systems and concurrency primitives used by databases.
