...
title: "SQL | Computer Science - Wyatt's Notes"
tags:
  - Computing
  - University
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "4 Databases", "url": "https://computer-science.wyattau.com/4-databases"}, {"name": "3_sql", "url": "https://computer-science.wyattau.com/4-databases/3_sql"}]
}
</script>
...
- [Relational Model](/4-databases/2_relational-model/) -- SQL operates on the relational model, with tables corresponding to relations and rows to tuples.
- [Normalisation](/4-databases/4_normalisation/) -- Well-normalised schemas produce cleaner SQL queries with fewer anomalies.
- [Indexing](/4-databases/5_indexing/) -- SQL query performance depends on indexing strategies that accelerate data retrieval.
