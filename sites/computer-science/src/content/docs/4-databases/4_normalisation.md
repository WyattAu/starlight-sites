...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "4 Databases", "url": "https://computer-science.wyattau.com/4-databases"}, {"name": "4_normalisation", "url": "https://computer-science.wyattau.com/4-databases/4_normalisation"}]
}
</script>
...
```mermaid
flowchart TD
    A[4_Normalisation] --> B[Key Concepts]
    A --> C[Core Principles]
...
- **[Relational Model](/4-databases/2_relational-model/):** Relational model fundamentals.
- **[Indexing](/4-databases/5_indexing/):** Index structures for normalised schemas.
- **[Query Optimisation](/4-databases/7_query-optimisation/):** How normalisation affects query planning.
