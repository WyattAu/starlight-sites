...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "computer-science", "url": "https://computer-science.wyattau.com"}, {"name": "5 Operating Systems", "url": "https://computer-science.wyattau.com/5-operating-systems"}, {"name": "12_flashcards Operating Systems", "url": "https://computer-science.wyattau.com/5-operating-systems/12_flashcards-operating-systems"}]
}
</script>
...
- **[Systems](../../2-systems/index.md):** Computer architecture and hardware systems; OS implements the abstractions.
- **[Databases](../../4-databases/index.md):** Transaction management and concurrency control; databases depend on OS primitives.
- **[Algorithms](../../2-algorithms-and-data-structures/10_flashcards-algorithms-and-data-structures.mdx):** Scheduling and page replacement algorithms use algorithm design techniques.
