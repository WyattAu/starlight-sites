...
- [Context-Free Languages](/6-theory-of-computation/3_context-free-languages/) -- Regular languages are a subset of context-free languages, forming the simplest level of the Chomsky hierarchy.
- [Turing Machines](/6-theory-of-computation/4_turing-machines/) -- Finite automata that recognise regular languages are the simplest computational model in the hierarchy.
