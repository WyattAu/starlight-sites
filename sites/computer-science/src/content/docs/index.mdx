...
description: "Comprehensive computer science study notes covering algorithms, data structures, systems, and theory with worked examples and complexity analysis."
sources:
  ...
  - text: "Silberschatz, A., Galvin, P. B., & Gagne, G. (2018). Operating System Concepts (10th ed.). Wiley."
  - text: "Tanenbaum, A. S., & Bos, H. (2014). Modern Operating Systems (4th ed.). Pearson."
  - text: "Sipser, M. (2012). Introduction to the Theory of Computation (3rd ed.). Cengage Learning."
hero:
...
- **[Mathematics](../../../../typescript/src/content/docs/index):** University-level mathematics including abstract algebra and real analysis.
- **[Physics](../../../../typescript/src/content/docs/index):** Classical mechanics, electromagnetism, and quantum physics.
- **[Tools](../../../../typescript/src/content/docs/index):** Programming tools and algorithms implementation.
