...
- **[C++23 Modules](/compilation_model/2_modules/1_cpp_23/):** Modern module system that replaces traditional header-file compilation.
- **[Lambdas](/function_architecture/1_function_mechanics/3_lambdas/):** Lambda expressions that are commonly defined within compilation units.
