...
description: "Understanding the translation stages are critical for debugging compilation errors, optimizing build Times, and understanding. The pipeline processes one at"
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cpp", "url": "https://cpp.wyattau.com"}, {"name": "Compilation_model", "url": "https://cpp.wyattau.com/compilation_model"}, {"name": "1_translation", "url": "https://cpp.wyattau.com/compilation_model/1_translation"}, {"name": "1_preprocessing_ast_object", "url": "https://cpp.wyattau.com/compilation_model/1_translation/1_preprocessing_ast_object"}]
}
</script>
...
**Code transformation:** The compilation process is like a factory assembly line — preprocessing, parsing, optimization, and code generation transform source code into executable instructions.

**Why it matters:** Understanding the compilation process helps you write better code and debug compilation errors.

**The key insight:** Preprocessor macros are text substitutions — they don't understand C++ syntax, which is why constexpr is preferred.
...
- **[C++23 Modules](../2_modules/1_cpp_23.mdx):** Modern module system that replaces traditional header-file compilation.
- **[Lambdas](../../function_architecture/1_function_mechanics/3_lambdas.md):** Lambda expressions that are commonly defined within compilation units.
- **[Type System](../../types/):** Type system concepts that the compiler enforces during compilation.
