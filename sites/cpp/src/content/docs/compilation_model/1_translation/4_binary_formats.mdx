...
1. **View Program Headers (Loader View):**
...
- [Linker](/compilation_model/1_translation/3_linker/)
- [Name Mangling](/compilation_model/1_translation/5_name_mangling/)
- [Symbol Visibility](/compilation_model/1_translation/2_symbol_visibility/)
- [The C Runtime (CRT)](/compilation_model/2_modules/4_c_runtime/)


```mermaid
flowchart TD
    A[4_Binary_Formatsx] --> B[Key Concepts]
    A --> C[Core Principles]
