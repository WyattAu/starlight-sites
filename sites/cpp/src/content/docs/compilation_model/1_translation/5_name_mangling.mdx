...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cpp", "url": "https://cpp.wyattau.com"}, {"name": "Compilation_model", "url": "https://cpp.wyattau.com/compilation_model"}, {"name": "1_translation", "url": "https://cpp.wyattau.com/compilation_model/1_translation"}, {"name": "5_name_mangling", "url": "https://cpp.wyattau.com/compilation_model/1_translation/5_name_mangling"}]
}
</script>
title: Name Mangling
...
**Encoding names:** Name mangling is like encoding addresses — it transforms human-readable function names into unique identifiers that the linker can distinguish.

**Why it matters:** Understanding name mangling helps you debug linking errors and interface with C code.
