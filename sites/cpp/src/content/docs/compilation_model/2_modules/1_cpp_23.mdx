...
- **[Preprocessing and AST](/compilation_model/1_translation/1_preprocessing_ast_object/):** Traditional compilation model that modules are designed to replace.
...
- **Standard Library:** Standard library components that can be imported via modules.
