...
- [Binary Module Interfaces (BMI)](/compilation_model/2_modules/2_bmi/)
- [The C Runtime (CRT)](/compilation_model/2_modules/4_c_runtime/)
- [C++20/23 Modules Overview](/compilation_model/2_modules/1_cpp_23/)
- [Linker](/compilation_model/1_translation/3_linker/)
- [Preprocessing and the AST](/compilation_model/1_translation/1_preprocessing_ast_object/)


```mermaid
flowchart TD
    A[3_Header_Unitx] --> B[Key Concepts]
    A --> C[Core Principles]
