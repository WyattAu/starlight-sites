...
The key mental model is that the CRT is **not optional** — even freestanding environments must provide a minimal startup sequence. The difference between hosted and freestanding environments is simply how much of the CRT you get: hosted gives you everything (heap, exceptions, standard library), while freestanding gives you almost nothing and requires you to provide your own `_start` and manage the stack manually. Knowing where the CRT ends and your code begins is essential for systems programming, embedded development, and understanding what happens at program startup.