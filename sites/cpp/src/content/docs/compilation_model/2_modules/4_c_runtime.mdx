...
- [Binary Formats](/compilation_model/1_translation/4_binary_formats/)
- [Binary Module Interfaces (BMI)](/compilation_model/2_modules/2_bmi/)
- [Header Units](/compilation_model/2_modules/3_header_unit/)
