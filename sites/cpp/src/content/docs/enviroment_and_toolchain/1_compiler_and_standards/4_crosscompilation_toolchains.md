...
- [Installing a Compiler](/enviroment_and_toolchain/1_compiler_and_standards/1_installing_compiler/) -- Setting up native and cross-compilers
- [Standard Library Implementation](/enviroment_and_toolchain/1_compiler_and_standards/3_standard_library_implementation/) -- Choosing the right
  standard library for the target
- [Linker Configuration](/enviroment_and_toolchain/1_compiler_and_standards/5_linker_configuration/) -- Cross-linking considerations
- [vcpkg](/enviroment_and_toolchain/3_dependency_management/3_vcpkg/) -- Cross-compiling dependencies with triplets
- [Conan](/enviroment_and_toolchain/3_dependency_management/4_conan/) -- Cross-compilation with Conan profiles
