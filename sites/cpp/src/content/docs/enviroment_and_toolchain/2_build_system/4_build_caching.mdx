...
title: "Build Caching | C++ - Wyatt's Notes"
...
- [CMake Presets and Toolchain Files](../2_build_system/3_cmake_presets_and_toolchain_files)
- [Ninja and Parallelism](../2_build_system/2_ninja_and_parallelism)


```mermaid
flowchart TD
    A[4_Build_Cachingx] --> B[Key Concepts]
    A --> C[Core Principles]
