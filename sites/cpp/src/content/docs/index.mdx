...
title: "Programming Notes | C++ - Wyatt's Notes"
description: "Deep C++ systems programming notes covering ownership, templates, concurrency, the standard library, and build systems with worked examples."
sources:
  - text: "Stroustrup, B. (2013). The C++ Programming Language (4th ed.). Addison-Wesley."
  - text: "Lippman, S. B., Lajoie, J., & Moo, B. E. (2012). C++ Primer (5th ed.). Addison-Wesley."
  - text: "Meyers, S. (2014). Effective Modern C++. O'Reilly Media."
  - text: "Josuttis, N. M. (2012). The C++ Standard Library: A Tutorial and Reference (2nd ed.). Addison-Wesley."
  - text: "Williams, A. (2019). C++ Concurrency in Action (2nd ed.). Manning Publications."
hero:
