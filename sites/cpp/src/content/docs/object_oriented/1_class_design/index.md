...
This section provides study materials and resources for 1_class_design. Revision works best in one direction here: read 1_class_design, attempt the practice problems cold, and only then check the worked solutions.
...
- [1_object_layout_vptr](/object_oriented/1_class_design/1_object_layout_vptr/)
- [2_access_control](/object_oriented/1_class_design/2_access_control/)
- [3_special_member_functions](/object_oriented/1_class_design/3_special_member_functions/)
- [4_operator_overloading](/object_oriented/1_class_design/4_operator_overloading/)
- [5_spaceship_operator](/object_oriented/1_class_design/5_spaceship_operator/)
- [6_std_formatter](/object_oriented/1_class_design/6_std_formatter/)
...
Use the diagnostic tests to find out whether 1_class_design needs another pass before your exam, rather than revising topics you have already mastered.
