...
title: "Heap | C++ - Wyatt's Notes"
description: "Dynamic storage: The heap is like a warehouse — you can request any amount of memory, but you must return it when done. new and delete manage heap allocation."
