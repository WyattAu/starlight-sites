...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "cpp", "url": "https://cpp.wyattau.com"}, {"name": "Types", "url": "https://cpp.wyattau.com/types"}, {"name": "3_initialization_and_lifetime", "url": "https://cpp.wyattau.com/types/3_initialization_and_lifetime"}, {"name": "3_aggregate_initialization", "url": "https://cpp.wyattau.com/types/3_initialization_and_lifetime/3_aggregate_initialization"}]
}
</script>
...
**Direct member initialization:** Aggregate initialization is like filling in a form — you provide values for each member in order, without calling a constructor.

**Why it matters:** Aggregates are simple data carriers, and aggregate initialization provides a clean, efficient way to initialize them.

**The key insight:** Aggregates can have default member initializers — you can omit values during initialization, and members will use their defaults.
