...
title: "Constant Expressions | C++ - Wyatt's Notes"
description: "Compile-time computation: constexpr is like a calculator that runs at compile time — it lets you compute values during compilation, making runtime code faster."
