...
title: "Dart - Wyatt's Notes"
description: "Dart is a programming language with a rich type system and ecosystem. These notes cover the language from fundamentals to advanced topics, with worked"
hero:
...
Dart is a programming language with a rich type system and ecosystem. Work through the Dart sections in order, starting with Async and Basics and building toward Async, Basics, Collections, Dart3 Features, Flutter Fundamentals, Networking And Data, Object Oriented, Setup, State Management and Testing, then check yourself with the practice problems for each topic.
