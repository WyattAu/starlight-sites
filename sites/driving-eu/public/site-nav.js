;(() => {
  var SITES = {
    'Exam Boards': [
      ...
      { name: 'IB', url: 'https://ib.wyattau.com', tags: 'Math AA/AI, Physics, Chem, Bio, CS' },
      {
        ...
        tags: 'Math, Further Maths, Physics, Chem',
      },
      ...
      { name: 'AP', url: 'https://ap.wyattau.com', tags: 'Calculus, Physics, Chem, Bio, Stats' },
      {
        ...
        tags: 'Bio, Chem, Physics, Maths, CS',
      },
      {
        name: 'Leaving Cert',
        url: 'https://leaving-cert.wyattau.com',
        tags: 'Bio, Chem, Physics, Maths',
      },
    ...
    'CS Tools': [
      ...
      { name: 'Tools', url: 'https://tools.wyattau.com', tags: 'Algorithms, Git, Licensing' },
      {
        ...
        tags: 'Systems, Theory, Algorithms',
      },
    ],
    'Further Studies': [
      {
  ...
  var CATEGORY_ICONS = {
    ...
    Infrastructure:
      '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"/><rect x="2" y="14" width="20" height="8" rx="2" ry="2"/><path d="M6 6h.01M6 18h.01"/></svg>',
  }
