  ...
  integrations: [
    ...
    starlight({
      ...
      head: [
        ...
        { tag: 'meta', attrs: { name: 'theme-color', content: '#43aa8b' } },
        {
          tag: 'link',
          attrs: {
            rel: 'preload',
        ...
        },
        {
          ...
          attrs: {
            property: 'og:image',
            content: 'https://driving-uk.wyattau.com/img/social-card.svg',
          },
        },
        { tag: 'script', attrs: { src: '/cross-site-search.js', defer: true } },
        {
          ...
          content: JSON.stringify({
            ...
            '@type': 'WebSite',
            name: 'Driving (UK)',
            description: 'UK driving theory and revision materials',
