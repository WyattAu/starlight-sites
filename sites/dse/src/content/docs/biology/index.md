...
Paper 2 allows you to choose from several elective modules. Each elective builds on the compulsory topics and explores them in greater depth or from a different angle:
...
All living organisms are composed of cells. The **cell theory** states that:
...
Genetics explains how traits are passed from parents to offspring. The **gene** is the basic unit of heredity, located at a specific position (**locus**) on a chromosome. The DSE syllabus covers:
...
The human physiology section is one of the most content-heavy parts of the syllabus. It covers the major organ systems and how they maintain **homeostasis** — a stable internal environment despite changing external conditions. Key systems include:
...
Plant biology focuses on how plants obtain resources and respond to their environment. Key topics include:
...
Evolution is the change in inherited characteristics of a population over successive generations. The DSE syllabus covers:
...
This topic covers two major defence and communication systems:
...
1. **Start with Cell Biology** — Everything else builds on this foundation. Make sure you understand cell structure, membrane transport, and cell division before moving on.

2. **Draw and label diagrams** — Biology is a visual subject. Practise drawing heart cross-sections, nephron diagrams, feedback loops, and genetic crosses. Labelled diagrams often appear in exam questions.

3. **Use past paper questions** — The DSE has a specific question style. Practise with actual past papers to familiarise yourself with the marking scheme and common question patterns.

4. **Make comparison tables** — Many topics lend themselves to comparison (e.g. mitosis vs meiosis, arteries vs veins, xylem vs phloem, T cells vs B cells). Creating these tables helps consolidate understanding.

5. **Connect topics** — Higher-mark questions often require you to apply knowledge from multiple topics. For example, a question on diabetes might require understanding of the endocrine system (blood glucose regulation), the excretory system (kidney function), and genetics (inherited risk factors).

6. **Practise data analysis** — DSE Biology frequently presents unfamiliar data (graphs, tables, experimental results) and asks you to interpret them. Practise identifying trends, explaining anomalies, and drawing conclusions from data.

7. **Use the correct biological terminology** — Exam mark schemes award marks for precise terminology. Use words like "mitochondria" (not "mitochondrion" when plural), "photosynthesis" (not "making food"), and "active transport" (not "moving against the gradient").

8. **Revise regularly** — Biology involves a large volume of content. Use spaced repetition and active recall techniques rather than passive re-reading.

## Common Mistakes in DSE Biology

- **Confusing mitosis and meiosis:** Mitosis produces two identical diploid daughter cells for growth and repair; meiosis produces four genetically different haploid gametes for sexual reproduction. Know the differences in chromosome number, crossing over, and purpose.
...
- **[Cell Biology](./1-cell-biology/):** Foundation for all other topics — cell structure, division, and transport mechanisms.
- **[Ecology](./2-ecology/):** Ecosystems, energy flow, nutrient cycles, and biodiversity.
- **[Genetics](./3-genetics/):** Inheritance patterns, DNA, genetic engineering.
- **[Human Physiology](./4-human-physiology/):** Organ systems, homeostasis, and coordination.
- **[Plant Biology](./5-plant-biology/):** Photosynthesis, transport, and growth responses.
- **[Evolution](./6-evolution/):** Evidence for evolution, natural selection, speciation.
- **[Nervous System and Immunology](./7-nervous-system-and-immunology/):** Neural communication and immune defence.

## Experimental Skills and Investigation

DSE Biology places significant emphasis on practical skills and experimental design. The examination tests your ability to design experiments, analyse data, and draw conclusions. Key skills include:
...
- **Calculating means and standard deviations** — Summarise data and quantify variation
...
- Understanding magnification vs resolution
- Calculating actual size from images: `Actual size = Image size / Magnification`
- Preparing slides and interpreting microscope images
- Drawing biological diagrams with correct labelling conventions

### Dissection and Practical Techniques

The DSE syllabus includes practical components such as:
...
Review material at increasing intervals: 1 day, 3 days, 1 week, 2 weeks, 1 month. This is far more effective than cramming the night before an exam.

### Past Paper Practice

The single most effective revision strategy for DSE Biology is practising past papers under timed conditions. This familiarises you with:
...
- *Biology* by Campbell and Reece (comprehensive university-level reference)
