...
title: "Government Policy | DSE - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 6 government policy study notes for dse with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
