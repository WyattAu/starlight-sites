...
- [Web Development and Multimedia](/ict/7-web-and-multimedia/1_web-development-and-multimedia/) applies system lifecycle stages to web application development projects.
- [Programming and Databases](/ict/3-programming-and-databases/2_programming-and-databases/) covers the implementation phase of the system lifecycle where code and data structures are built.
- [Network Security](/ict/8-network-security/1_network-security-and-social-implications/) addresses security considerations that must be integrated throughout the system lifecycle.
