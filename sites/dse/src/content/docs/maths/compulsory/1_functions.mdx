...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "dse", "url": "https://dse.wyattau.com"}, {"name": "Maths", "url": "https://dse.wyattau.com/maths"}, {"name": "Compulsory", "url": "https://dse.wyattau.com/maths/compulsory"}, {"name": "1_functions", "url": "https://dse.wyattau.com/maths/compulsory/1_functions"}]
}
</script>
...
- [Calculus](/docs/dse/maths/compulsory/2_differentiation) applies differentiation to analyse rates of change in the functions defined here.
- [Sequences and Series](/docs/dse/maths/compulsory/6_sequences-and-series) extends function concepts to infinite sequences and series used in mathematical modelling.
- [Trigonometry](/docs/dse/maths/compulsory/4_trigonometric-functions) covers the periodic functions that are a special case of the general function framework.
