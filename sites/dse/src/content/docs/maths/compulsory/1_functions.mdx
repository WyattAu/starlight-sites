...
[polynomials](4_polynomials), [logarithms](7_logarithmics), [sequences](6_sequences-and-series), and
[inequalities](5_inequalities).
...
See also [Polynomials](4_polynomials) for connections between quadratic functions and polynomial
Equations.
...
This technique is also essential in solving [Inequalities](5_inequalities) involving quadratic
Expressions.
...
For equations of the form $a^{f(x)} = b$Take logarithms of both sides. See [logarithms](7_logarithmics)
...
[logarithms](7_logarithmics) for further details.
...
See [Inequalities](5_inequalities) for the general theory.
