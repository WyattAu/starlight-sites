...
- [Calculus](/dse/maths/compulsory/2_differentiation) applies differentiation to analyse rates of change in the functions defined here.
- [Sequences and Series](/dse/maths/compulsory/6_sequences-and-series) extends function concepts to infinite sequences and series used in mathematical modelling.
- [Trigonometry](/dse/maths/compulsory/4_trigonometric-functions) covers the periodic functions that are a special case of the general function framework.
