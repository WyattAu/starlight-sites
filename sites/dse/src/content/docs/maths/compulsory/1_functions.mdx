...
[polynomials](/maths/compulsory/4_polynomials/), [logarithms](/maths/compulsory/7_logarithmics/), [sequences](/maths/compulsory/6_sequences-and-series/), and
[inequalities](/maths/compulsory/5_inequalities/).
...
See also [Polynomials](/maths/compulsory/4_polynomials/) for connections between quadratic functions and polynomial
Equations.
...
This technique is also essential in solving [Inequalities](/maths/compulsory/5_inequalities/) involving quadratic
Expressions.
...
For equations of the form $a^{f(x)} = b$Take logarithms of both sides. See [logarithms](/maths/compulsory/7_logarithmics/)
...
[logarithms](/maths/compulsory/7_logarithmics/) for further details.
...
See [Inequalities](/maths/compulsory/5_inequalities/) for the general theory.
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Functions**? The contains the hardest questions within
...
- [Calculus](https://ib.wyattau.com/maths/5-calculus/2_differentiation/) applies differentiation to analyse rates of change in the functions defined here.
- [Sequences and Series](/maths/compulsory/6_sequences-and-series/) extends function concepts to infinite sequences and series used in mathematical modelling.
- [Trigonometry](https://alevel.wyattau.com/maths/pure-mathematics/05-functions/) covers the periodic functions that are a special case of the general function framework.
