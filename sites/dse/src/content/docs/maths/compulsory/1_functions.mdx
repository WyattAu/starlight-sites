...
<aside aria-label="Horizontal transformations operate on $x$ **before** the function is evaluated; vertical" class="starlight-aside starlight-aside--note">
...
<aside aria-label="**Critical pitfall:** When multiplying both sides of an inequality by an expression" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Functions**? The contains the hardest questions within" class="starlight-aside starlight-aside--tip">
