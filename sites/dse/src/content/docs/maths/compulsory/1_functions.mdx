...
<Aside type="note" title="Horizontal transformations operate on $x$ **before** the function is evaluated; vertical">
...
<Aside type="caution" title="**Critical pitfall:** When multiplying both sides of an inequality by an expression">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Functions**? The contains the hardest questions within">
