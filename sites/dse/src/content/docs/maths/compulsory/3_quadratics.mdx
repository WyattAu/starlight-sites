---
title: "Quadratics | DSE - Wyatt's Notes"
...
- **Functions:** Quadratic functions are a special case of polynomial functions. See
  [Functions](1_functions) and [Functions Advanced](2_functions-advanced).
...
- **Permutations and Combinations:** Factorials appear in the quadratic formula derivation via
  completing the square. See [Permutations and Combinations](13_permutations-and-combinations).
