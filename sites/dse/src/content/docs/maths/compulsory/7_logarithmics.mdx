...
[geometric sequences and series](/maths/compulsory/6_sequences-and-series/) in applications involving Compound growth.
...
[geometric sequences](/maths/compulsory/6_sequences-and-series/)). If a principal $P$ is invested at an annual rate $r\%$
...
[Functions](/maths/compulsory/1_functions/):
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Logarithms**? The contains the hardest questions within
