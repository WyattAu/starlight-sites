...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "dse", "url": "https://dse.wyattau.com"}, {"name": "Maths", "url": "https://dse.wyattau.com/maths"}, {"name": "Compulsory", "url": "https://dse.wyattau.com/maths/compulsory"}, {"name": "7_logarithmics", "url": "https://dse.wyattau.com/maths/compulsory/7_logarithmics"}]
}
</script>
title: Logarithms
...
Logarithms answer the question "what power do I raise the base to in order to get this number?" They are the inverse of exponentiation, turning multiplicative relationships into additive ones. This property makes them invaluable for solving exponential equations and modelling phenomena that span many orders of magnitude, like earthquake intensity or sound volume. The change of base formula lets you convert between logarithmic bases, and the laws of logarithms mirror the laws of exponents, providing powerful algebraic tools for simplification.

Logarithms are the inverse operation of exponentiation and play a central role in the DSE Mathematics compulsory syllabus. They arise when solving exponential equations, modelling Growth and
...
<DesmosGraph client:only="solid-js" title="Logarithmic Functions" expressions={["\log_{a}(x)", "rac{\ln(x)}{\ln(a)}"]}
...
<strong>Diagnostic Test Ready to test your understanding of **Logarithms**? The contains the hardest questions within</strong>
