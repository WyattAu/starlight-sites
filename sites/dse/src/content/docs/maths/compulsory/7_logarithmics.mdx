...
[geometric sequences and series](6_sequences-and-series) in applications involving Compound growth.
...
[geometric sequences](6_sequences-and-series)). If a principal $P$ is invested at an annual rate $r\%$
