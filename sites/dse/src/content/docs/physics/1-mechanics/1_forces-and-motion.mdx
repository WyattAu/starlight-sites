...
<PhetSimulation client:load simulationId="projectile-motion" title="Projectile Motion"  />
...
<PhetSimulation client:load simulationId="gravity-and-orbits" title="Gravity and Orbits"  />
