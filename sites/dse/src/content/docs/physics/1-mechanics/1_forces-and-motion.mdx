---
title: "Forces and Motion | DSE - Wyatt's Notes"
...
<PhetSimulation client:only="solid-js" simulationId="projectile-motion" title="Projectile Motion"  />
...
```mermaid
flowchart TD
    A[1_Forces And Motionx] --> B[Key Concepts]
    A --> C[Core Principles]
...
:::tip
<strong>Diagnostic Test Ready to test your understanding of **Forces and Motion**? The contains the hardest questions</strong>
...
- [Mechanics](./)
- [Energy and Work](./3_energy-and-work)
- [Physics - Mechanics](./2_mechanics-depth)

## References

1. Halliday, D., Resnick, R. & Walker, J. (2013). *Fundamentals of Physics* (10th ed.). John Wiley & Sons.
2. Feynman, R. P., Leighton, R. B. & Sands, M. (2011). *The Feynman Lectures on Physics, Vol. I: The New Millennium Edition — Mechanics, Radiation, and Heat*. Basic Books.
3. Kleppner, D. & Kolenkow, R. J. (2013). *An Introduction to Mechanics* (2nd ed.). Cambridge University Press.
4. Beer, F. P., Johnston, E. R., Cornwell, R. D. & Self, B. (2019). *Vector Mechanics for Engineers: Statics and Dynamics* (12th ed.). McGraw-Hill Education.
5. Giancoli, D. C. (2013). *Physics: Principles with Applications* (7th ed.). Pearson.
