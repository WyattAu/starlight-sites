...
:::caution Air resistance is neglected in ideal free-fall problems unless the question explicitly
States otherwise.
:::
...
:::caution Warning Directed towards the centre of the circle. It is provided by gravity, tension,
