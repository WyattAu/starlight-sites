...
<Aside type="caution">
Warning Directed towards the centre of the circle. It is provided by gravity, tension,
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Mechanics**? The contains the hardest questions
...
- [Heat and Gases](/physics/4-thermal-physics/1_heat-and-gases/) -- Work-energy concepts from mechanics apply to thermodynamic processes and gas expansion.
- [Nuclear Physics](/physics/5-nuclear-physics/1_nuclear-physics/) -- Conservation of momentum is essential for analysing nuclear reactions and particle collisions.
