...
<Aside type="note" title="These equations are only valid for **uniform acceleration**. When acceleration varies,">
...
<Aside type="caution" title="Air resistance is neglected in ideal free-fall problems unless the question explicitly">
States otherwise.
</Aside>
### Worked Example 3
...
<Aside type="note" title="Momentum is **always** conserved in collisions (provided no external forces act). Kinetic">
...
<Aside type="caution" title="Warning Directed towards the centre of the circle. It is provided by gravity, tension,">
...
<Aside type="note" title="Geostationary satellites orbit at the same rate as the Earth\'s rotation (period = 24 hours),">
...
<Aside type="note" title="The period of SHM is independent of amplitude (isochronous). This is why pendulum clocks">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Mechanics**? The contains the hardest questions">
