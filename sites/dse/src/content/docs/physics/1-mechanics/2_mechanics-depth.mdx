...
<aside aria-label="These equations are only valid for **uniform acceleration**. When acceleration varies," class="starlight-aside starlight-aside--note">
...
<aside aria-label="Air resistance is neglected in ideal free-fall problems unless the question explicitly" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Momentum is **always** conserved in collisions (provided no external forces act). Kinetic" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Directed towards the centre of the circle. It is provided by gravity, tension," class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Geostationary satellites orbit at the same rate as the Earth\'s rotation (period = 24 hours)," class="starlight-aside starlight-aside--note">
...
<aside aria-label="The period of SHM is independent of amplitude (isochronous). This is why pendulum clocks" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Mechanics**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
