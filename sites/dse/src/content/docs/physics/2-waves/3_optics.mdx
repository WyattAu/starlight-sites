...
- [Wave Properties](/dse/physics/2-waves/2_wave-properties) provides the fundamental wave behaviour concepts including reflection, refraction, and diffraction that optics builds upon.
- [Atomic Structure and Bonding](/dse/chemistry/1-atomic-structure-and-bonding/1_atomic-structure-and-bonding) explains how electron transitions in atoms produce the light analysed in optics.
- [Electromagnetic Radiation](/dse/physics/2-waves/2_wave-properties) covers the electromagnetic spectrum and wave characteristics that underpin optical phenomena.
