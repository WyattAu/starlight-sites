...
<Aside type="tip">
Tip Ready to test your understanding of **Optics**? The contains the hardest questions within
...
- [Wave Properties](https://ib.wyattau.com/physics/3-wave-behaviour/2_wave-properties/) provides the fundamental wave behaviour concepts including reflection, refraction, and diffraction that optics builds upon.
...
- [Electromagnetic Radiation](https://ib.wyattau.com/physics/3-wave-behaviour/2_wave-properties/) covers the electromagnetic spectrum and wave characteristics that underpin optical phenomena.
