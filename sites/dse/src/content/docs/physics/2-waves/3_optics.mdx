...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "dse", "url": "https://dse.wyattau.com"}, {"name": "Physics", "url": "https://dse.wyattau.com/physics"}, {"name": "2 Waves", "url": "https://dse.wyattau.com/physics/2-waves"}, {"name": "3_optics", "url": "https://dse.wyattau.com/physics/2-waves/3_optics"}]
}
</script>
title: Optics
...
- [Wave Properties](/docs/dse/physics/2-waves/2_wave-properties) provides the fundamental wave behaviour concepts including reflection, refraction, and diffraction that optics builds upon.
- [Atomic Structure and Bonding](/docs/dse/chemistry/1-atomic-structure-and-bonding/1_atomic-structure-and-bonding) explains how electron transitions in atoms produce the light analysed in optics.
- [Electromagnetic Radiation](/docs/dse/physics/2-waves/2_wave-properties) covers the electromagnetic spectrum and wave characteristics that underpin optical phenomena.
