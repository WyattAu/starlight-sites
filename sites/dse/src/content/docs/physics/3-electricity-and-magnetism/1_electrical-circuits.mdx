---
title: "Electrical Circuits | DSE - Wyatt's Notes"
...
```mermaid
flowchart TD
    A[1_Electrical Circuitsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Electricity and Magnetism](./2_electricity-and-magnetism)
- [Magnetism and Electromagnetism](./3_magnetism-and-electromagnetism)
