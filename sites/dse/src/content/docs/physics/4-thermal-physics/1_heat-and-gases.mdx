...
<Aside type="note">
Info Radiation is not the dominant mechanism. At large temperature differences, the $T^4$
...
<Aside type="tip">
Tip Ready to test your understanding of **Heat and Gases**? The contains the hardest questions
...
- [Nuclear Physics](/physics/5-nuclear-physics/1_nuclear-physics/) -- Nuclear energy and radioactive decay involve thermal energy transfer and gas behaviour.
- [Mechanics](/physics/1-mechanics/2_mechanics-depth/) -- Work and energy concepts from mechanics apply to thermodynamic processes.
