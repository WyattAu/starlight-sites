---
title: "Heat and Gases | DSE - Wyatt's Notes"
description: "Temperature measures how energetic particles are — heat is the transfer of that energy: Think of a room full of people bouncing balls. Temperature is how fast"
...
```mermaid
flowchart TD
    A[1_Heat And Gasesx] --> B[Key Concepts]
    A --> C[Core Principles]
