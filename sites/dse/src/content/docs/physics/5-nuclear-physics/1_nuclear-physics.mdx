...
<Aside type="note" title="In DSE exams, isotopes share the same chemical symbol and chemical behaviour. Only nuclear">
...
<Aside type="caution" title="Warning Equations. While DSE exams sometimes omit them for simplicity, always check">
...
<Aside type="note" title="Info Plot, remember the slope is negative: $\lvert\mathrm{slope}\rvert = \lambda$. Always">
...
<Aside type="caution" title="Warning Detected by a particular instrument). The count rate is always less than or equal">
...
<Aside type="note" title="In DSE calculations, always convert masses to the same units (preferably u) before computing">
...
<Aside type="note" title="In DSE exams, the GM tube is the most important detector. Know its construction, operation">
...
<Aside type="caution" title="Never use lead shielding for beta radiation. High-Z materials like lead produce">
...
<Aside type="note" title="Info Calculations and explanations. In Paper 2, it appears as multiple-choice questions">
...
<Aside type="note" title="Info Many half-lives correspond to this fraction. $2^n = 10$ gives">
...
<Aside type="caution" title="Warning Atomic masses are provided. Mixing the two conventions will lead to incorrect">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Nuclear Physics**? The contains the hardest questions">
