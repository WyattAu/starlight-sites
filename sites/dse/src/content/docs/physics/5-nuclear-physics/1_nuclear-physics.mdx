...
description: "Nuclear physics for DSE Physics."
...
<aside aria-label="In DSE exams, isotopes share the same chemical symbol and chemical behaviour. Only nuclear" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Equations. While DSE exams sometimes omit them for simplicity, always check" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Info Plot, remember the slope is negative: $\lvert\mathrm{slope}\rvert = \lambda$. Always" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Detected by a particular instrument). The count rate is always less than or equal" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="In DSE calculations, always convert masses to the same units (preferably u) before computing" class="starlight-aside starlight-aside--note">
...
<aside aria-label="In DSE exams, the GM tube is the most important detector. Know its construction, operation" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Never use lead shielding for beta radiation. High-Z materials like lead produce" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Info Calculations and explanations. In Paper 2, it appears as multiple-choice questions" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Info Many half-lives correspond to this fraction. $2^n = 10$ gives" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning Atomic masses are provided. Mixing the two conventions will lead to incorrect" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Nuclear Physics**? The contains the hardest questions" class="starlight-aside starlight-aside--tip">
