...
description: 'An atom consists of a small, dense, positively charged surrounded by negatively charged orbiting in shells. The nucleus contains two types of nucleons:'
...
:::caution Warning Equations. While DSE exams sometimes omit them for simplicity, always check
...
:::caution Warning Detected by a particular instrument). The count rate is always less than or equal
...
:::caution Never use lead shielding for beta radiation. High-Z materials like lead produce
...
:::caution Warning Atomic masses are provided. Mixing the two conventions will lead to incorrect
