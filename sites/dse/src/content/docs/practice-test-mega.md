...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"name": "Practice Test", "url": "https://dse.wyattau.com/practice-test-mega"}
  ]
}
</script>
...
| # | Option |
| --- | --- |
| A | Substrate concentration is low |
| B | All enzyme active sites are occupied |
| C | Temperature is reduced to 0°C |
...
| # | Option |
| --- | --- |
| A | Glucagon from the pancreas |
| B | Adrenaline from the adrenal glands |
| C | Insulin from the pancreas |
| D | ADH from the pituitary gland |
...
| # | Option |
| --- | --- |
| A | Are most common in the population |
| B | Increase an organism's reproductive success |
| C | Produce the largest offspring |
| D | Mutate most frequently |
...
| D | 18 protons, 13 neutrons, 18 electrons |
...
| # | Option |
| --- | --- |
| A | Exothermic and thermodynamically unstable |
| B | Endothermic and thermodynamically unstable |
| C | Exothermic and thermodynamically stable |
| D | Endothermic and thermodynamically stable |
...
| # | Option |
| --- | --- |
| A | $3 \times 10^{-3} \text{ mol dm}^{-3}$ |
| B | $1 \times 10^{-3} \text{ mol dm}^{-3}$ |
| C | $1 \times 10^{-11} \text{ mol dm}^{-3}$ |
| D | $0.3 \text{ mol dm}^{-3}$ |
...
The balanced equation is $\text{NaOH} + \text{HCl} \rightarrow \text{NaCl} + \text{H}_2\text{O}$, so the mole ratio is 1:1.

Moles of HCl = $0.2 \times 0.050 = 0.01 \text{ mol}$.
...
| D | A uniform field in all directions |
...
| # | Option |
| --- | --- |
| A | Greater than the mass of the original nucleus |
| B | Equal to the mass of the original nucleus |
| C | Less than the mass of the original nucleus |
| D | Unpredictable |
...
| D | The cost of resources already owned |
...
| B | A 1% increase in price leads to a 2.5% decrease in quantity demanded |
| C | A 1% increase in price leads to a 2.5% increase in quantity demanded |
...
| A | Price makers |
| B | Price takers |
| C | Able to earn long-run supernormal profits |
...
| # | Option |
| --- | --- |
| A | A third party benefits from a transaction they are not involved in |
| B | A third party bears a cost from a transaction they are not involved in |
| C | The government taxes a good |
| D | A monopoly restricts output |
...
| # | Option |
| --- | --- |
| A | The total wealth of a country's citizens |
| B | The total market value of all final goods and services produced within a country in a year |
| C | The total value of a country's exports |
| D | The average income of citizens |
...
| # | Option |
| --- | --- |
| A | It can produce more of the good than other countries |
| B | It has a lower opportunity cost of producing the good |
| C | It has more resources than other countries |
| D | It exports more than it imports |
...
| # | Option |
| --- | --- |
| A | The central bank printing more money |
| B | Banks creating money through lending deposits |
| C | The government increasing taxes |
| D | Consumers saving more money |
...
| B | Reducing income tax to increase work incentives |
