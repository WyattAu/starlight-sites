...
- [Atomic Structure](https://leaving-cert.wyattau.com/chemistry/1-atomic-structure/1_atomic-structure/) -- Understanding atoms and elements provides the chemical foundation for cell structure and function.
