...
sources:
  - text: Standard textbook reference
description: "Comprehensive 6 inheritance variation evolution study notes for gcse with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
...
- [6_inheritance Variation Evolution](./6_inheritance-variation-evolution)
