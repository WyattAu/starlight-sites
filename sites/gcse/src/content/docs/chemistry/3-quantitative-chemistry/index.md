...
description: "This section covers quantitative chemistry concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. Work through Quantitative Chemistry alongside the practice problems for Chemistry, then let the diagnostic tests tell you whether it stuck.
...
Work through Quantitative Chemistry alongside the practice problems for Chemistry, then let the diagnostic tests tell you whether it stuck.
