...
title: "Fundamentals"
description: "This section covers fundamentals concepts, definitions, and applications with worked examples and practice problems."
...
This section covers computational thinking, data structures, algorithms, and systems. Revision works best in one direction here: read Fundamentals, attempt the practice problems cold, and only then check the worked solutions.
...
Revision works best in one direction here: read Fundamentals, attempt the practice problems cold, and only then check the worked solutions.
