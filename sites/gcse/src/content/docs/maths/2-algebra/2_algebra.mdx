...
- [Ratio and Proportion](/maths/3-ratio-proportion/3_ratio-proportion/) -- Proportional reasoning and direct proportion are special cases of linear equations.
- [Geometry and Measure](https://sat.wyattau.com/mathematics/geometry/) -- Coordinate geometry and equations of lines connect algebra to spatial reasoning.
