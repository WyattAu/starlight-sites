...
- [Algebra](/maths/2-algebra/2_algebra/) -- Ratio and proportion problems are often solved using algebraic equations and substitution.
- [Geometry and Measure](https://sat.wyattau.com/mathematics/geometry/) -- Scale drawings and similar triangles use ratio and proportion concepts.
...
- [Cell Biology](https://ib.wyattau.com/biology/1-cell-biology/1_cell-biology/) -- Dilution ratios and concentration calculations in biology require proportion skills.
:::
