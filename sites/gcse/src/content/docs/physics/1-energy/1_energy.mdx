...
<aside aria-label="Near the Earth\'s surface, $g \approx 9.8$ N/kg (often approximated as 10 N/kg in" class="starlight-aside starlight-aside--note">
...
<aside aria-label="No machine can be 100% efficient. Some energy is always dissipated (transferred to" class="starlight-aside starlight-aside--caution">
