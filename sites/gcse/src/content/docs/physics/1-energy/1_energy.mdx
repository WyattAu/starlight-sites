...
<Aside type="note" title="Near the Earth\'s surface, $g \approx 9.8$ N/kg (often approximated as 10 N/kg in">
Calculations).
</Aside>
...
<Aside type="caution" title="No machine can be 100% efficient. Some energy is always dissipated (transferred to">
