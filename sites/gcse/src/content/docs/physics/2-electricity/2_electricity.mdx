...
<aside aria-label="Info Heating appliances dominate household electricity bills. Switching to a more efficient" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Warning The energy is dissipated as heat inside the battery. Never short-circuit a" class="starlight-aside starlight-aside--caution">
