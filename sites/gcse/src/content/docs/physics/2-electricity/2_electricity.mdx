...
<Aside type="note">
Info Heating appliances dominate household electricity bills. Switching to a more efficient
...
<Aside type="caution">
Warning The energy is dissipated as heat inside the battery. Never short-circuit a
...
- [Energy](/physics/1-energy/1_energy/) -- Electrical circuits involve energy transfers; power and energy are calculated using VIt and I²Rt.
- [Magnetism](/physics/7-magnetism/7_magnetism/) -- Electromagnetism connects electric currents to magnetic fields in motors and generators.
- [Waves](/physics/6-waves/6_waves/) -- Alternating current produces electromagnetic waves; understanding frequency relates to AC circuits.
- [Forces](/physics/5-forces/5_forces/) -- Electric motors convert electrical energy into mechanical force, linking electricity to motion.
