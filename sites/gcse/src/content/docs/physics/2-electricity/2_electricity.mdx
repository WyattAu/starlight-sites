...
<Aside type="note" title="Info Heating appliances dominate household electricity bills. Switching to a more efficient">
...
<Aside type="caution" title="Warning The energy is dissipated as heat inside the battery. Never short-circuit a">
battery.
</Aside>
