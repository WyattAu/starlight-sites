...
title: "Electricity"
description: "This section covers electricity concepts, definitions, and applications with worked examples and practice problems."
...
This section covers key physical principles, from classical mechanics to modern physics. Revision works best in one direction here: read Electricity, attempt the practice problems cold, and only then check the worked solutions.
...
- [2_electricity](/physics/2-electricity/2_electricity/)
...
If Electricity feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
