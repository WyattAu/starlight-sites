...
- [Energy](/physics/1-energy/1_energy/) -- Work done by forces transfers energy; kinetic energy and potential energy connect forces to energy conservation.
- [Electricity](/physics/2-electricity/2_electricity/) -- Electric motors use forces to convert electrical energy into mechanical motion.
- [Magnetism](/physics/7-magnetism/7_magnetism/) -- Magnetic forces on current-carrying conductors are a key application of force concepts.
