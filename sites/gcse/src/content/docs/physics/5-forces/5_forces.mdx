...
**Forces are pushes and pulls — and they always come in pairs:** When you push a wall, the wall pushes back with equal force. When you stand on the floor, the floor pushes up on you with a force equal to your weight. Forces never act alone — they always occur as action-reaction pairs. This is Newton's third law, and it's the key to understanding how objects interact.

**Why it matters:** Forces explain why you don't fall through the floor, how cars accelerate, why rockets fly, and how bridges support weight. Understanding forces is essential for engineering, sports science, and everyday problem-solving.

**The key insight:** Forces cause changes in motion, not motion itself. A ball rolling on a frictionless surface would roll forever — it doesn't need a force to keep moving. Forces only matter when they change something: speeding up, slowing down, or changing direction.
...
1. A car of mass 1000 kg travelling at $15 \mathrm{ m/s$ collides with a stationary car of mass
...
2. A $2 \mathrm{ kg$ block is pushed up a $30^{\circ}$ incline with an initial speed of
...
3. Explain why a passenger in a car feels thrown forward when the car brakes suddenly. Refer to
    Newton's laws in your answer.

4. A uniform metre rule is balanced on a pivot at the 40 cm mark. A 3 N weight hangs from the 10 cm
    mark and a 5 N weight hangs from the 70 cm mark. Calculate where an additional 2 N weight must
    be hung to restore balance.

5. A football is kicked from the ground at $20 \mathrm{ m/s$ at an angle of $35^{\circ}$ to the
...
- [Energy](../1-energy/1_energy) -- Work done by forces transfers energy; kinetic energy and potential energy connect forces to energy conservation.
- [Electricity](../2-electricity/2_electricity) -- Electric motors use forces to convert electrical energy into mechanical motion.
- [Magnetism](../7-magnetism/7_magnetism) -- Magnetic forces on current-carrying conductors are a key application of force concepts.
- [Algebra](../../maths/2-algebra/2_algebra) -- Force calculations require solving equations and rearranging formulas.
:::
