...
- [Energy](/physics/1-energy/1_energy/) -- Waves transfer energy from one place to another; understanding energy transfers applies to wave propagation.
- [Electricity](/physics/2-electricity/2_electricity/) -- Sound waves can be converted to electrical signals in microphones, linking waves to circuits.
- [Magnetism](/physics/7-magnetism/7_magnetism/) -- Electromagnetic waves are transverse waves that include radio, microwaves, and visible light.
- [Forces](/physics/5-forces/5_forces/) -- Diffraction patterns are observed when waves interact with obstacles, connecting wave behaviour to physical forces.
</Aside>
