...
title: "Magnetism | GCSE - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 7 magnetism study notes for gcse with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
