...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"name": "Practice Test", "url": "https://gcse.wyattau.com/practice-test-mega"}
  ]
}
</script>
...
| --- | --- | --- |
| Biology | Q1–Q10 | 10 |
| Chemistry | Q11–Q20 | 10 |
| Physics | Q21–Q30 | 10 |
| Mathematics | Q31–Q40 | 10 |
| English | Q41–Q50 | 10 |
| **Total** | **50** | **50** |
...
| B | They are permanently denatured |
| C | Their concentration decreases |
...
| B | Be a carrier of the recessive allele |
| C | Show the dominant phenotype |
| D | Be unable to pass on any allele |
...
| --- | --- | --- |
| A | Fight infection |
| B | Carry oxygen around the body |
...
| B | Filtering blood and removing waste |
...
| # | Option | Mark |
| --- | --- | --- |
| A | Organisms change their traits during their lifetime |
| B | Organisms with advantageous traits are more likely to survive and reproduce |
| C | All species were created at the same time |
| D | Traits are inherited only from the mother |
...
| # | Option | Mark |
| --- | --- | --- |
| A | Transport sugars from the leaves |
| B | Transport water and minerals from the roots |
...
| D | Total particles in the nucleus |
...
| B | The same number of outer (valence) electrons |
| C | The same atomic mass |
| D | The same chemical properties exactly |
...
| C | Attraction between opposite ions |
| D | Sharing protons between atoms |
...
| # | Option | Mark |
| --- | --- | --- |
| A | Absorb energy from the surroundings |
| B | Have products with higher energy than reactants |
| C | Release energy to the surroundings |
| D | Always produce light |
...
| # | Option | Mark |
| --- | --- | --- |
| A | The system stops reacting |
| B | The system shifts to increase the change |
| C | The system shifts to oppose the change |
...
| # | Option | Mark |
| --- | --- | --- |
| A | A heavier nucleus and radiation |
| B | Two lighter nuclei |
...
| D | A sound that imitates a word |
...
| # | Option | Mark |
| --- | --- | --- |
| A | To create a formal tone |
| B | To build tension or create urgency |
| C | To provide detailed descriptions |
| D | To slow the pace of the narrative |
...
| B | A group of lines forming a unit, like a paragraph |
...
| # | Option | Mark |
| --- | --- | --- |
| A | Writing exactly three paragraphs |
| B | Using groups of three ideas or words for emphasis |
| C | Listing three sources |
| D | Repeating the same point three times |
...
| C | The student is working on the homework. |
| D | The student will complete the homework. |
...
| B | A speech delivered by a character alone on stage, revealing their thoughts |
| C | A song performed by the chorus |
| D | A comedic scene between acts |
...
| # | Option | Mark |
| --- | --- | --- |
| A | The physical shape of the story on a page |
| B | The structure of a story from beginning through rising action, climax, and resolution |
| C | A decorative element in book design |
...
| # | Option | Mark |
| --- | --- | --- |
| A | To prove the opposing view is correct |
| B | To acknowledge and refute opposing views, strengthening the writer's position |
...
| B | To identify the writer's attitude or feeling towards the subject |
| C | To describe the physical layout of the text |
...
| B | The children's toys were scattered. |
| C | The teacher's are meeting today. |
| D | The cat's ate all the food. |
...
<details>
<summary>Click to reveal the mark scheme</summary>
...
1. **Time yourself.** 60 minutes for 50 questions is the pace of a real GCSE exam.
2. **Use a separate answer sheet.** This builds the habit of transferring answers cleanly.
3. **Check the mark scheme honestly.** Don't change your answers after the time is up.
4. **Study the explanations.** They explain why each wrong answer is wrong, which is where learning happens.
5. **Retake after one week.** Spaced repetition is the most effective way to improve recall.
