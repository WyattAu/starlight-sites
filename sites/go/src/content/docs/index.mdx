...
title: "Go - Wyatt's Notes"
description: "Go is a programming language with a rich type system and ecosystem. These notes cover the language from fundamentals to advanced topics, with worked examples,"
hero:
...
Go is a programming language with a rich type system and ecosystem. Work through the Go sections in order, starting with Advanced and Basics and building toward Advanced, Basics, Concurrency, Intermediate and Standard Library, then check yourself with the practice problems for each topic.
