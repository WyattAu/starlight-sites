...
- **[Interfaces](/intermediate/interfaces/):** Interface patterns that complement error handling design.
- **[Generics](/intermediate/generics/):** Generic functions that can work with error types.
