...
- **[Generics](/intermediate/generics/):** Generic programming as an alternative to interface-based abstraction.
- **[Error Handling](/intermediate/error-handling/):** Error handling patterns using the error interface.
