...
- **[Types and Variables](basics/types-and-variables):** Detailed notes on Go types and variable declarations.
- **[Functions](basics/functions):** Function definitions and method receivers.
- **[Control Flow](basics/control-flow):** Loops, conditionals, and switch statements.
