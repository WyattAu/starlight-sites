...
- **[Net/HTTP](/standard-library/net-http/):** HTTP client and server that use I/O operations.
- **[Strings and Time](/standard-library/strings-and-time/):** String and time utilities used with I/O operations.
