...
title: "Haskell Basics Flashcards - Wyatt's Notes"
description: "Haskell is the language where \"if it compiles, it probably works.\" Pure functions guarantee that the same inputs always produce the same output — no hidden"
sidebar_position: 51
---
