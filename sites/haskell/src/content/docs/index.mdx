...
Haskell is a programming language with a rich type system and ecosystem. Work through the Haskell sections in order, starting with Advanced and Basics and building toward Advanced, Basics, Intro, Monads, Pattern Matching and Type Classes, then check yourself with the practice problems for each topic.
