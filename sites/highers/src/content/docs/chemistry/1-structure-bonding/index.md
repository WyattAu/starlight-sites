...
description: "This section covers structure bonding concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. Use the diagnostic tests to find out whether Structure Bonding needs another pass before your exam, rather than revising topics you have already mastered.
...
- [1_structure Bonding](/chemistry/1-structure-bonding/1_structure-bonding/)
...
If Structure Bonding feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
