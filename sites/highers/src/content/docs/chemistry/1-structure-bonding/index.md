...
title: "Structure Bonding | Highers - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 1 structure bonding study notes for highers with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
...
- [1_structure Bonding](./1_structure-bonding)
