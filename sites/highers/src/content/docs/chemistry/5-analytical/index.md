...
title: "Analytical"
description: "This section covers analytical concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. Revision works best in one direction here: read Analytical, attempt the practice problems cold, and only then check the worked solutions.
...
- [5_analytical](/chemistry/5-analytical/5_analytical/)
...
If Analytical feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
