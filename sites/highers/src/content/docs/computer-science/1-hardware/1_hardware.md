...
- [Software](/computer-science/2-software/2_software/) covers the operating systems and applications that run on the hardware foundations described here.
- [Algorithms](/computer-science/4-algorithms/4_algorithms/) explains the computational methods that hardware executes through its instruction set architecture.
- [Networks](/computer-science/5-networks/5_networks/) extends hardware concepts to the communication infrastructure connecting distributed systems.
