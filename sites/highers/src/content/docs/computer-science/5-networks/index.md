...
title: "Networks | Highers - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 5 networks study notes for highers with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
