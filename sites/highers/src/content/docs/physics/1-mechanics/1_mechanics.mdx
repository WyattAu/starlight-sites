...
<Aside type="note" title="The work-energy theorem is one of the most powerful tools in mechanics. It works even when">
...
<Aside type="caution" title="Always check whether motion actually occurs before applying the equations of motion. If">
