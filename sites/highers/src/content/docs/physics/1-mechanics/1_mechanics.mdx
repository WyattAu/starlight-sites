...
<aside aria-label="The work-energy theorem is one of the most powerful tools in mechanics. It works even when" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Always check whether motion actually occurs before applying the equations of motion. If" class="starlight-aside starlight-aside--caution">
