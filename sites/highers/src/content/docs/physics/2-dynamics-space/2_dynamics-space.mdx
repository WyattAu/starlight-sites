...
[Mechanics](/physics/1-mechanics/1_mechanics/)).
...
<Aside type="note">
Counter-, when a satellite fires its engines forward to speed up, it moves to a Higher orbit
...
- [Mechanics](/physics/1-mechanics/1_mechanics/) -- Dynamics extends kinematics by introducing forces that cause the motion described in mechanics.
- [Electricity](/physics/3-electricity/3_electricity/) -- Gravitational and electric fields share mathematical similarities, connecting dynamics to electrostatics.
- [Particles and Waves](/physics/4-particles-waves/4_particles-waves/) -- Momentum conservation in particle physics applies the same dynamic principles at the quantum scale.
