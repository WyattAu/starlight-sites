...
<aside aria-label="Hohmann transfers are the most fuel-efficient two-impulse transfer between coplanar circular" class="starlight-aside starlight-aside--note">
...
<aside aria-label="The Gaia space telescope can measure parallaxes down to about $10 \mathrm{ \mu\mathrm{as$" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Counter-, when a satellite fires its engines forward to speed up, it moves to a Higher orbit" class="starlight-aside starlight-aside--note">
...
<aside aria-label="The apparent magnitude scale is logarithmic and inverted: a difference of 5 magnitudes" class="starlight-aside starlight-aside--note">
