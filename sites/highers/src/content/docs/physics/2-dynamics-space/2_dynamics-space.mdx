...
title: "Dynamics and Space | Highers - Wyatt's Notes"
...
1. A $2000 \mathrm{ kg$ satellite in circular orbit at $500 \mathrm{ km$ altitude needs to move to
    a higher orbit at $1000 \mathrm{ km$ altitude. Calculate the energy required using the
    gravitational potential energy formula.

2. A star has apparent brightness $B$ and is at distance $d$. If the same star were moved to
    distance $3d$By what factor would its apparent brightness change?

3. Calculate the escape velocity from the surface of the Sun. (Mass of Sun
    $= 1.989 \times 10^{30} \mathrm{ kg$Radius of Sun $= 6.96 \times 10^8 \mathrm{ m$.)

4. A ball of mass $0.3 \mathrm{ kg$ on a string of length $0.9 \mathrm{ m$ is swung in a vertical
...
5. Explain why a white dwarf is hot but has low luminosity, while a red giant is cool but has high
    luminosity. Reference the Stefan-Boltzmann law in your answer.

6. A galaxy at a distance of $100 \mathrm{ Mpc$ has a recession velocity of $7000 \mathrm{ km/s$.
    Calculate the value of the Hubble constant from this single data point.

7. Calculate the gravitational field strength at the surface of Mars and compare it to Earth\'s
    surface gravity. (Mars mass $= 6.39 \times 10^{23} \mathrm{ kg$Mars radius
    $= 3.39 \times 10^6 \mathrm{ m$.)

8. Two stars in a binary system orbit their common centre of mass. Star A has mass
...
9. Explain the evidence for the Big Bang theory, including the cosmic microwave background
    radiation and Hubble\'s law.

10. A geostationary satellite must have an orbital period of 24 hours. Calculate the required
...
:::note
<strong>Hohmann transfers are the most fuel-efficient two-impulse transfer between coplanar circular</strong>
...
:::caution
<strong>The Gaia space telescope can measure parallaxes down to about $10 \mathrm{ \mu\mathrm{as$</strong>
...
:::note
<strong>Counter-, when a satellite fires its engines forward to speed up, it moves to a Higher orbit</strong>
...
1. A probe is launched from Earth\'s surface with escape velocity. Calculate the speed of the probe
    when it is at a distance of $3R_E$ from Earth\'s centre.

2. Two galaxies are observed to be moving apart at $1200 \mathrm{ km/s$. Using Hubble\'s constant
    $H_0 = 70 \mathrm{ km/s/Mpc$Calculate the distance to these galaxies in Mpc and in light-years.

3. A $2000 \mathrm{ kg$ spacecraft in circular orbit at $300 \mathrm{ km$ altitude fires
...
4. The Sun has an apparent brightness of $1.37 \times 10^3 \mathrm{ W/m^2$ at Earth. Calculate the
    luminosity of the Sun and its absolute magnitude (reference: $M_{\mathrm{ref} = 4.83$).

5. Explain how astronomers distinguish between redshift due to the Doppler effect (peculiar
...
:::note
<strong>The apparent magnitude scale is logarithmic and inverted: a difference of 5 magnitudes</strong>
...
1. Calculate the escape velocity from the surface of Mars. (Mars mass
    $= 6.39 \times 10^{23} \mathrm{ kg$Mars radius $= 3.39 \times 10^6 \mathrm{ m$.) Compare it to
    the escape velocity from Earth.

2. A satellite in an elliptical orbit has a perigee altitude of $300 \mathrm{ km$ and an apogee
    altitude of $3000 \mathrm{ km$. Calculate the semi-major axis, the orbital period, and the
    speeds at perigee and apogee.

3. A star has a surface temperature of $12000 \mathrm{ K$ and a radius of $2.5 R_\odot$. Calculate
    its luminosity relative to the Sun ($T_\odot = 5778 \mathrm{ K$) and its absolute magnitude.

4. Explain the significance of the cosmic microwave background radiation. At what temperature is it
    currently measured, and what does this tell us about the age of the universe?

5. Calculate the gravitational potential energy of a $100 \mathrm{ kg$ satellite in a circular
    orbit at an altitude of $500 \mathrm{ km$. What is its total energy (kinetic + potential)?

## Cross-References

- [Mechanics](../1-mechanics/1_mechanics) -- Dynamics extends kinematics by introducing forces that cause the motion described in mechanics.
- [Electricity](../3-electricity/3_electricity) -- Gravitational and electric fields share mathematical similarities, connecting dynamics to electrostatics.
- [Particles and Waves](../4-particles-waves/4_particles-waves) -- Momentum conservation in particle physics applies the same dynamic principles at the quantum scale.


```mermaid
flowchart TD
    A[2_Dynamics Spacex] --> B[Key Concepts]
    A --> C[Core Principles]
...
Dynamics and space physics extend Newton's mechanics to the cosmic scale, where gravity becomes the dominant force. The key insight is that the same force that makes an apple fall also keeps the Moon in orbit — Newton's law of universal gravitation unifies terrestrial and celestial mechanics. Gravity follows an inverse-square law: double the distance and the force drops to one-quarter. This simple relationship explains Kepler's laws of planetary motion, the orbits of satellites, and the escape velocity from planets.

Circular motion in space is fundamentally different from circular motion on Earth. In orbital mechanics, the centripetal force is provided entirely by gravity, and the orbital speed is determined by the balance between gravitational attraction and the inertia of the orbiting body. The counterintuitive result is that objects in higher orbits move _slower_ — the International Space Station at 400 km altitude orbits at about 7.7 km/s, while the Moon at 384,000 km orbits at only about 1.0 km/s. This relationship is captured by Kepler's third law: the square of the orbital period is proportional to the cube of the orbital radius.

Stellar physics and cosmology apply these same dynamic principles to understand the life cycles of stars and the large-scale structure of the universe. Wien's law and the Stefan-Boltzmann law connect a star's temperature to its colour and luminosity. The mass-luminosity relation reveals that massive stars burn through their fuel far faster than small ones — a star ten times the Sun's mass lives only about 30 million years compared to 10 billion years for the Sun. At the largest scales, Hubble's law tells us the universe is expanding, with distant galaxies receding faster than nearby ones, providing evidence for the Big Bang.
