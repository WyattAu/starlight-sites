...
- [Mechanics](/physics/1-mechanics/1_mechanics/) -- Electric circuits involve energy transfer, connecting electrical power to mechanical work and energy conservation.
- [Waves and Radiation](/physics/5-waves-radiation/5_waves-radiation/) -- Electromagnetic waves are produced by accelerating charges, linking electricity to wave phenomena.
- [Dynamics and Space](/physics/2-dynamics-space/2_dynamics-space/) -- Electric and magnetic fields affect the motion of charged particles, connecting electricity to dynamics.
