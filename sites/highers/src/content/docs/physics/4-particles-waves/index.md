...
title: "Particles Waves | Highers - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 4 particles waves study notes for highers with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
