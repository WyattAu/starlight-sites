...
title: "Organic | HSC - Wyatt's Notes"
...
**Answer:** $\text{CH}_3\text{COOH} + \text{CH}_3\text{CH}_2\text{OH} \rightarrow \text{CH}_3\text{COOCH}_2\text{CH}_3 + \text{H}_2\text{O}$ (ethyl ethanoate)
