...
title: "Periodicity"
description: "This section covers periodicity concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. If Periodicity feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
...
- [1_periodicity](/chemistry/3-periodicity/1_periodicity/)
...
Revision works best in one direction here: read Periodicity, attempt the practice problems cold, and only then check the worked solutions.
