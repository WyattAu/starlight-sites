...
title: "Periodicity | IB - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 3 periodicity study notes for ib with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
