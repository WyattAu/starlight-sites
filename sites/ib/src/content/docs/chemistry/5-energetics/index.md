...
title: "Energetics"
description: "This section covers energetics concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. If Energetics feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
...
- [1_thermochemistry](/chemistry/5-energetics/1_thermochemistry/)
...
Revision works best in one direction here: read Energetics, attempt the practice problems cold, and only then check the worked solutions.
