...
sources:
  - text: Standard textbook reference
description: "Comprehensive 3 networks study notes for ib with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
