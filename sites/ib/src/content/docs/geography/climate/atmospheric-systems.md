...
title: "Atmospheric Systems | IB - Wyatt's Notes"
description: "Comprehensive study notes for Atmospheric Systems with worked examples, practice problems, and key concepts for exam preparation."
---
...
```mermaid
flowchart TD
    A[Atmospheric Systems] --> B[Key Concepts]
    A --> C[Core Principles]
