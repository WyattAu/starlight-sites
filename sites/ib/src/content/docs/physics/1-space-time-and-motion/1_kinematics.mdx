...
\{/* prettier-ignore */\}
<DesmosGraph client:only="solid-js" title="Projectile Trajectory" expressions={["y=x*tan(a)-\\frac{4.9*x^2}{v^2*cos(a)^2}"]} width={800} height={500}  />
...
- [Rotational Motion](/physics/1-space-time-and-motion/4_rotational-motion/)

## References

1. Halliday, D., Resnick, R. & Walker, J. (2013). *Fundamentals of Physics* (10th ed.). John Wiley & Sons.
2. Giancoli, D. C. (2014). *Physics: Principles with Applications, International Student Edition* (7th ed.). Pearson.
3. Cripps, C. (2014). *Cambridge Physics for the IB Diploma*. Cambridge University Press.
4. Kerr, J. (2020). *Physics for the IB Diploma* (2nd ed.). Oxford University Press.
5. Hewitt, P. G. (2015). *Conceptual Physics* (12th ed.). Pearson.
