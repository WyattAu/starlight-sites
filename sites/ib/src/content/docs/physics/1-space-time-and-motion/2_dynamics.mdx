...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "ib", "url": "https://ib.wyattau.com"}, {"name": "Physics", "url": "https://ib.wyattau.com/physics"}, {"name": "1 Space Time And Motion", "url": "https://ib.wyattau.com/physics/1-space-time-and-motion"}, {"name": "2_dynamics", "url": "https://ib.wyattau.com/physics/1-space-time-and-motion/2_dynamics"}]
}
</script>
...
Dynamics is the answer to kinematics' question of why things move the way they do. Newton's three laws are like the rules of a cosmic game: objects stay still or keep moving unless pushed, the harder you push the faster it accelerates, and every push gets an equal push back. The third law is often misunderstood: when you stand on the floor, your weight pushing down and the floor pushing up are not an action-reaction pair because they act on the same object. Friction is nature's way of converting kinetic energy into heat, which is why sliding on ice is easy but sliding on sandpaper is not.
