...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Thermodynamics**? The contains the hardest questions
...
```mermaid
flowchart TD
    A[1_Thermodynamicsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Atomic and Nuclear Physics](/physics/2-particulate-nature-of-matter/2_atomic-physics/)
- [Current Electricity](/physics/2-particulate-nature-of-matter/6_current-electricity/)
