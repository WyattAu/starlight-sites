...
```mermaid
flowchart TD
    A[2_Atomic Physicsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Atomic and Nuclear Physics**? The contains the hardest questions
...
- [Thermodynamics](/physics/2-particulate-nature-of-matter/1_thermodynamics/) covers thermal energy and gas laws that relate to atomic-scale particle behaviour.
- [Quantum and Nuclear Physics](/physics/5-nuclear-and-quantum-physics/1_quantum-and-nuclear-physics/) extends atomic physics to nuclear decay, fission, and fusion processes.
- [Current Electricity](https://gaokao.wyattau.com/physics/electricity/) explains how atomic-level electron behaviour gives rise to electrical conduction.
