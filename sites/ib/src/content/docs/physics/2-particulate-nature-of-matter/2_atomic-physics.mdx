...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "ib", "url": "https://ib.wyattau.com"}, {"name": "Physics", "url": "https://ib.wyattau.com/physics"}, {"name": "2 Particulate Nature Of Matter", "url": "https://ib.wyattau.com/physics/2-particulate-nature-of-matter"}, {"name": "2_atomic Physics", "url": "https://ib.wyattau.com/physics/2-particulate-nature-of-matter/2_atomic-physics"}]
}
</script>
...
<aside class="starlight-aside starlight-aside--tip">
<strong>Diagnostic Test Ready to test your understanding of **Atomic and Nuclear Physics**? The contains the hardest questions</strong>
...
Atomic physics bridges the microscopic and macroscopic worlds. The Bohr model quantises electron orbits like seats on a staircase rather than a ramp, explaining why atoms emit only specific colours of light. Radioactivity is spontaneous nuclear decay, governed by probability rather than certainty, with half-life describing how quickly a sample decays. Nuclear fission splits heavy atoms and fusion joins light ones, both releasing energy because the binding energy per nucleon has a maximum near iron. The photoelectric effect proved light comes in packets, launching quantum mechanics.
...
- [Thermodynamics](/docs/ib/physics/2-particulate-nature-of-matter/1_thermodynamics) covers thermal energy and gas laws that relate to atomic-scale particle behaviour.
- [Quantum and Nuclear Physics](/docs/ib/physics/5-nuclear-and-quantum-physics/1_quantum-and-nuclear-physics) extends atomic physics to nuclear decay, fission, and fusion processes.
- [Current Electricity](/docs/ib/physics/2-particulate-nature-of-matter/3_current-electricity) explains how atomic-level electron behaviour gives rise to electrical conduction.
