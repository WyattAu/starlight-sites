...
- [Thermodynamics](/ib/physics/2-particulate-nature-of-matter/1_thermodynamics) covers thermal energy and gas laws that relate to atomic-scale particle behaviour.
- [Quantum and Nuclear Physics](/ib/physics/5-nuclear-and-quantum-physics/1_quantum-and-nuclear-physics) extends atomic physics to nuclear decay, fission, and fusion processes.
- [Current Electricity](/ib/physics/2-particulate-nature-of-matter/3_current-electricity) explains how atomic-level electron behaviour gives rise to electrical conduction.
