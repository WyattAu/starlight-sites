...
<Aside type="note">
Data Booklet Reference Both forms appear in the IB data booklet:
$$
...
<Aside type="tip">
Electron vs Proton Deflection For the same field and entry speed, a proton is deflected
...
<Aside type="note">
Typical Values For copper, $n \approx 8.5 \times 10^{28}\mathrm{ m}^{-3}$. For a
...
<Aside type="note" title="Data Booklet Resistivity Values Copper:">
...
<Aside type="caution">
Efficiency at Maximum Power At $R_L = r$The efficiency is only 50% (half the power is
...
<Aside type="tip">
Minimising Measurement Error For ammeters: use instruments with the smallest possible
...
<Aside type="note">
IB Physics Data Booklet, Topic 5 The following are the key equations for current
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Current Electricity**? The contains the hardest
