...
:::caution[Efficiency at Maximum Power] At $R_L = r$The efficiency is only 50% (half the power is
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Current Electricity**? The contains the hardest" class="starlight-aside starlight-aside--tip">
