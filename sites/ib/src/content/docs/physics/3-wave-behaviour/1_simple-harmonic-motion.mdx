...
<aside aria-label="**Standard level and higher level (3 hours):** Students should understand:" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Equation (16) alone is ambiguous: $\arctan$ returns values in $(-\pi/2,\, \pi/2)$But the actual" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Simple Harmonic Motion**? The contains the hardest questions within the" class="starlight-aside starlight-aside--tip">
