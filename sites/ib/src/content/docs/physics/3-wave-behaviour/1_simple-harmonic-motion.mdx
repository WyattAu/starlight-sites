...
<Aside type="note" title="**Standard level and higher level (3 hours):** Students should understand:">
...
<Aside type="caution" title="Equation (16) alone is ambiguous: $\arctan$ returns values in $(-\pi/2,\, \pi/2)$But the actual">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Simple Harmonic Motion**? The contains the hardest questions within the">
