...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "ib", "url": "https://ib.wyattau.com"}, {"name": "Physics", "url": "https://ib.wyattau.com/physics"}, {"name": "3 Wave Behaviour", "url": "https://ib.wyattau.com/physics/3-wave-behaviour"}, {"name": "4_wave Phenomena", "url": "https://ib.wyattau.com/physics/3-wave-behaviour/4_wave-phenomena"}]
}
</script>
...
<DesmosGraph client:only="solid-js" title="Wave Superposition" expressions={["\\sin(x)", "\\sin(2x)",
...
Wave phenomena reveal the wave nature of light and sound. Diffraction gratings produce sharp interference patterns by combining many sources, like a crowd clapping in synchrony. Thin film interference creates the iridescent colours on soap bubbles because light reflecting from the top and bottom surfaces of the film interfere differently at each thickness. The principle of superposition underpins all interference, while Huygens' principle explains diffraction by treating every point on a wavefront as a new source of wavelets.
