...
title: "Wave Phenomena | IB - Wyatt's Notes"
...
```mermaid
flowchart TD
    A[4_Wave Phenomenax] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Wave Behaviour](./)
- [Wave Properties](./2_wave-properties)
- [Simple Harmonic Motion](./1_simple-harmonic-motion)
