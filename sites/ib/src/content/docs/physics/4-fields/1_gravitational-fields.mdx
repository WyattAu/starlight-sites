...
[moment of inertia ($I$)](/physics/1-space-time-and-motion/5_forces-and-momentum/#moment-of-inertia) of The
...
Hence the
[angular momentum ($L$)](/physics/1-space-time-and-motion/5_forces-and-momentum/#angular-momentum) of the
...
[acceleration](/physics/1-space-time-and-motion/5_forces-and-momentum/#acceleration), where the
...
[displacement](/physics/1-space-time-and-motion/5_forces-and-momentum/#displacement) magnitude of $r$. For
...
[acceleration](/physics/1-space-time-and-motion/5_forces-and-momentum/#acceleration) (force per unit mass)
...
[centripetal force](/physics/1-space-time-and-motion/5_forces-and-momentum/#centripetal-force) $F_c$ of
...
[centripetal force](/physics/1-space-time-and-motion/5_forces-and-momentum/#centripetal-force), then
...
<Aside type="caution">
The IB requires only qualitative understanding of the shell theorem. A full
...
<Aside type="tip">
Diagnostic Test Ready to test your understanding of **Gravitational Fields**? The contains the hardest
