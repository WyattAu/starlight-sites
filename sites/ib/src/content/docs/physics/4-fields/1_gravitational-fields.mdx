...
<aside aria-label="The IB uses the Newton\'s Universal Law of Gravitation published in 1687, where the equation" class="starlight-aside starlight-aside--note">
...
<aside aria-label="IB extends Newton\'s Law of Universal Gravitation to include spherical masses with uniform" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="In IB, only the cases of orbiting a body with significantly more mass is present. The IB" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="IB does only consider the magnitude of orbital velocity, therefore, the equation above is" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Since $\frac{4\pi^2}{GM}$ is constant for a given central body, this reduces to" class="starlight-aside starlight-aside--note">
...
<aside aria-label="The IB requires only qualitative understanding of the shell theorem. A full" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Gravitational Fields**? The contains the hardest" class="starlight-aside starlight-aside--tip">
