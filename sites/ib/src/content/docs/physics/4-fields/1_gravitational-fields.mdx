...
:::caution IB extends Newton\'s Law of Universal Gravitation to include spherical masses with uniform
...
:::caution In IB, only the cases of orbiting a body with significantly more mass is present. The IB
...
:::caution The IB requires only qualitative understanding of the shell theorem. A full
