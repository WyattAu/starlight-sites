...
```mermaid
flowchart TD
    A[2_Electric And Magnetic Fieldsx] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Fields](./)
- [Gravitational Fields](./1_gravitational-fields)
- [Motion in Electromagnetic Fields](./3_motion-in-electromagnetic-fields)
