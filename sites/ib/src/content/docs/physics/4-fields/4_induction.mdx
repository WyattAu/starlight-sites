...
<Aside type="note" title="One situation that generates EMF is a magnet passing through a solenoid, where an EMF is">
...
<Aside type="tip" title="Exam Tip When answering Lenz\'s law questions, always state both: (a) the direction of the">
...
<Aside type="tip" title="Exam Tip RMS values are what multimeters display. Always use RMS values when calculating">
...
<Aside type="tip" title="Exam Tip In Paper 2, induction questions often combine Faraday\'s law with energy">
...
<Aside type="caution" title="This model assumes the entire disc is immersed in the field. In practice only a localized">
...
<Aside type="tip" title="Diagnostic Test Ready to test your understanding of **Induction**? The contains the hardest questions within">
