...
<aside aria-label="One situation that generates EMF is a magnet passing through a solenoid, where an EMF is" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Exam Tip When answering Lenz\'s law questions, always state both: (a) the direction of the" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Tip RMS values are what multimeters display. Always use RMS values when calculating" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="Exam Tip In Paper 2, induction questions often combine Faraday\'s law with energy" class="starlight-aside starlight-aside--tip">
...
<aside aria-label="This model assumes the entire disc is immersed in the field. In practice only a localized" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Diagnostic Test Ready to test your understanding of **Induction**? The contains the hardest questions within" class="starlight-aside starlight-aside--tip">
