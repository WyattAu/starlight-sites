...
sources:
  - text: Standard textbook reference
description: "Comprehensive 5 nuclear and quantum physics study notes for ib with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
