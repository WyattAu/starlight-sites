...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    {"name": "Home", "url": "https://ib.wyattau.com"},
    {"name": "Practice Test", "url": "https://ib.wyattau.com/practice-test-mega"}
  ]
}
</script>
...
| Chemistry | Q6–Q10 | 5 |
| Physics | Q11–Q15 | 5 |
| Mathematics | Q16–Q20 | 5 |
| Economics | Q21–Q25 | 5 |
| Geography | Q26–Q30 | 5 |
| History | Q31–Q35 | 5 |
| English | Q36–Q40 | 5 |
| Computer Science | Q41–Q45 | 5 |
| Psychology | Q46–Q50 | 5 |
| **Total** | **50** | **50** |
...
| # | Option |
| --- | --- |
| A | The inhibitor binds to an allosteric site |
| B | The effect of inhibition can be overcome by increasing substrate concentration |
| C | The inhibitor permanently denatures the enzyme |
| D | $V_{max}$ is reduced in the presence of the inhibitor |
...
| # | Option |
| --- | --- |
| A | Ecological succession following a disturbance that leaves soil intact |
| B | Ecological succession starting from bare rock with no pre-existing soil |
| C | The gradual replacement of one community by another in a climax ecosystem |
| D | Seasonal changes in species composition |
...
| B | Blood flows from the atria into the ventricles |
| C | The semilunar valves open and blood is ejected into the arteries |
...
| # | Option |
| --- | --- |
| A | $\text{CH}_4$ (tetrahedral) |
| B | $\text{NH}_3$ (trigonal pyramidal) |
| C | $\text{H}_2\text{O}$ (bent) |
| D | $\text{SF}_6$ (octahedral) |
...
| # | Option |
| --- | --- |
| A | The enthalpy change of a reaction is always negative |
| B | The total enthalpy change is the same regardless of the route taken |
| C | Enthalpy is always conserved |
| D | Exothermic reactions have lower activation energies |
...
| A | Sodium hydroxide |
| B | Bromine water |
| C | Tollens' reagent (ammoniacal silver nitrate) |
| D | Ethanol |
...
| B | No heat enters or leaves the system |
...
Mean = $\frac{2+4+4+4+5+5+7+9}{8} = \frac{40}{8} = 5$.
...
| # | Option |
| --- | --- |
| A | Is overconsumed by the free market |
| B | Is underconsumed by the free market |
| C | Produces negative externalities |
| D | Is only provided by the government |
...
| # | Option |
| --- | --- |
| A | An increase in interest rates reduces investment |
| B | An initial increase in spending leads to a larger final increase in national income |
| C | An increase in the money supply causes inflation |
| D | Tax increases reduce aggregate demand |
...
| B | Decrease domestic production |
| C | Generate government revenue |
| D | Reduce the price of imported goods |
...
| B | Changes in birth and death rates as a country develops |
| C | The distribution of population across continents |
| D | The rate of population growth in developing countries |
...
| # | Option |
| --- | --- |
| A | The decline of city centres |
| B | The uncontrolled expansion of urban areas into surrounding countryside |
| C | The development of high-rise buildings |
| D | The concentration of industry in cities |
...
| # | Option |
| --- | --- |
| A | An area where all precipitation flows to a single river mouth |
| B | A body of freshwater on the Earth's surface |
| C | The underground layer where water is stored |
| D | The area where a river meets the sea |
...
| # | Option |
| --- | --- |
| A | Prevent the spread of communism beyond existing borders |
| B | Encourage Soviet economic reform |
| C | Reduce nuclear arsenals on both sides |
| D | Promote decolonisation in Africa |
...
| B | Centralised command economy |
| C | Free press and open elections |
...
| # | Option |
| --- | --- |
| A | Unlimited rearmament |
| B | Territorial expansion |
| C | War guilt and reparations |
| D | Membership of the League of Nations as a permanent member |
...
| # | Option |
| --- | --- |
| A | A return to religious authority |
| B | Emphasis on reason, science, and individual rights |
| C | The rejection of philosophical inquiry |
| D | Absolute monarchies across Europe |
...
| # | Option |
| --- | --- |
| A | The strengthening of European colonial powers after WWII |
| B | The weakening of European powers and the rise of independence movements |
| C | Increased European investment in African infrastructure |
| D | The support of the United Nations for continued colonial rule |
...
| B | The placement of contrasting elements side by side |
| C | A reference to another literary work |
| D | The use of vivid sensory language |
...
| # | Option |
| --- | --- |
| A | A poem with no regular metre or rhyme scheme |
| B | A 14-line poem with a specific rhyme scheme |
| C | A poem that tells a narrative story |
...
| B | To add emotional weight to the argument |
| C | To provide logical evidence (logos) for the argument |
...
| # | Option |
| --- | --- |
| A | The alphabetical ordering of words in a dictionary |
| B | The level of formality in language appropriate to a particular situation |
| C | The historical development of a language |
| D | The system of sounds in a language |
...
| B | The ability of objects of different classes to be treated as objects of a common superclass |
| C | The ability of a class to inherit from multiple classes |
| D | The ability to hide internal state details |
...
| # | Option |
| --- | --- |
| A | People always conform to group norms |
| B | People may give obviously incorrect answers to match a group majority |
| C | Conformity only occurs in collectivist cultures |
| D | Authority is the primary driver of conformity |
...
| # | Option |
| --- | --- |
| A | All psychological disorders are caused by childhood trauma |
| B | Disorders result from a biological vulnerability combined with environmental stress |
| C | Stress alone is sufficient to cause any disorder |
| D | Genetic factors are irrelevant to mental health |
