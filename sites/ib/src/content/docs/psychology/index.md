...
The IB Psychology course is assessed through three components:
...
The IA is a psychological investigation that you design and conduct yourself. You choose a research question, review relevant literature, design a study, collect and analyse data, and write a report of 2000 words. This component tests your understanding of research methods and your ability to apply them independently.

### Command Terms

IB Psychology uses specific command terms that indicate the depth of response required:

- **Outline:** Give a brief account or summary
- **Discuss:** Give a balanced argument including for and against
...
## Intuition: What Psychology Is Really About

**The science of why we do what we do:** Psychology seeks to understand the causes of behaviour at multiple levels. Why do people conform to group norms? How does stress affect immune function? What happens in the brain when we form memories? These questions connect biology, cognition, and social context.
...
The biological level of analysis examines how physiological mechanisms, brain structures, neurochemistry, and genetics influence behaviour. This approach assumes that behaviour has a biological basis and can be understood through the study of the nervous system, the endocrine system, and genetic inheritance.
...
The sociocultural level of analysis examines how social and cultural factors influence individual behaviour. This approach recognises that humans are fundamentally social beings whose behaviour is shaped by group membership, cultural norms, social interactions, and institutional structures.

### Core Concepts

**Conformity:** Adjusting behaviour or beliefs to match those of a group. Asch (1951) demonstrated that approximately 75% of participants conformed to an obviously incorrect group answer at least once in a line judgement task. Conformity serves to maintain social harmony and gain acceptance, but can lead to poor decision-making in group contexts.

**Obedience:** Following direct orders from an authority figure. Milgram (1963) showed that 65% of participants administered the maximum 450V shock when instructed by an experimenter in a lab coat. Obedience is influenced by authority proximity, the presence of dissenting peers, and the perceived legitimacy of the authority figure.
...
Understanding research methods is assessed in both Paper 1 and Paper 2, and is essential for the IA. Key areas include:
...
|---------------|----------|------------------|
| Multiple choice | Eliminate wrong answers, identify key terms | 1 mark per question |
| Short answer | Use command term, provide specific evidence | 2-4 marks per question |
| Essay | Plan before writing, use research to support points, evaluate strengths and limitations | Up to 22 marks per essay |
| IA | Follow the assessment criteria exactly, use primary data, provide thorough analysis | 20% of total grade |

### Essay Writing Structure

A strong IB Psychology essay follows this structure:

1. **Introduction** (1-2 sentences): Define key terms and outline what you will discuss
2. **Topic sentence 1**: State your first argument with reference to research
3. **Evidence**: Describe the study (aim, method, findings)
4. **Analysis**: Explain how the evidence supports your argument
5. **Evaluation**: Discuss strengths and limitations of the research
6. **Topic sentence 2**: State your second argument
7. **Evidence**: Describe a second study
8. **Analysis and evaluation**: As above
9. **Counterargument**: Present an opposing view or limitation
10. **Conclusion**: Summarise your argument and provide a final judgement
...
- **Describing studies instead of using them as evidence:** Examiners want you to apply research to support your arguments, not simply summarise what a study found. Always link the study back to the question.

- **Ignoring the evaluation component:** Every essay should include evaluation of both supporting and opposing evidence. Failing to evaluate is one of the most common reasons for losing marks.

- **Confusing correlation with causation:** A correlational study does not demonstrate that one variable causes another. Always be precise about the type of conclusion that can be drawn from a given research design.

- **Omitting ethical considerations in the IA:** The IA marking criteria reward thorough ethical reasoning. Always discuss how you addressed consent, confidentiality, and protection from harm.

- **Using too few studies:** Essays that reference only one or two studies tend to lack depth. Aim to discuss at least two to three relevant studies per point.
...
- *Psychology* by Myers and DeWall (comprehensive IB-aligned textbook)
- *Thinking, Fast and Slow* by Daniel Kahneman (accessible introduction to cognitive psychology)
- *Influence: The Psychology of Persuasion* by Robert Cialdini (social psychology in everyday life)
- *The Man Who Mistook His Wife for a Hat* by Oliver Sacks (case studies in neuropsychology)
- *Stumbling on Happiness* by Daniel Gilbert (cognitive biases in everyday life)
