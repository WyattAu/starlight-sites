...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "java", "url": "https://java.wyattau.com"}, {"name": "02 Fundamentals", "url": "https://java.wyattau.com/02-fundamentals"}, {"name": "03 Strings", "url": "https://java.wyattau.com/02-fundamentals/03-strings"}]
}
</script>
...
- [Types and Variables](https://kotlin.wyattau.com/basics/types-and-variables/) -- String immutability and the pool
- [Collections Framework](/04-collections/01-collections-framework/) -- using Strings as keys
- [Streams API](/05-streams/01-streams-api/) -- string processing with streams
:::
