...
title: "Collections Framework | Java - Wyatt's Notes"
description: "Comprehensive study notes for Collections Framework with worked examples, practice problems, and key concepts for exam preparation."
categories: ["java"]
---
...
- [Maps and Sets](02-maps-and-sets) -- HashMap, TreeMap, and Set implementations
- [Streams API](../05-streams/01-streams-api) -- stream operations on collections
- [Concurrency](../06-concurrency/01-concurrency) -- ConcurrentHashMap and thread-safe collections
