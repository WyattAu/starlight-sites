...
title: "Java - Wyatt's Notes"
description: "Java is a programming language with a rich type system and ecosystem. These notes cover the language from fundamentals to advanced topics, with worked"
hero:
...
Java is a programming language with a rich type system and ecosystem. Work through the Java sections in order, starting with Best Practices and Build Tools and building toward Best Practices, Build Tools, Collections, Concurrency, Exceptions, Fundamentals, Generics Reflection, Io Nio, Jvm Internals, Modern Java, Object Oriented, Streams and Testing, then check yourself with the practice problems for each topic.
