...
Kotlin is a programming language with a rich type system and ecosystem. Work through the Kotlin sections in order, starting with Advanced and Basics and building toward Advanced, Basics and Intermediate, then check yourself with the practice problems for each topic.
