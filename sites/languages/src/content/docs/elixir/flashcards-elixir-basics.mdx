...
- **[Elixir Practice](https://elixir.wyattau.com/practice-elixir-basics/):** Auto-graded problems testing the same core Elixir concepts covered in these flashcards.
- **[Basics and Pattern Matching](https://elixir.wyattau.com/01-basics/1_basics-and-pattern-matching/):** Deep dive into pattern matching and data types referenced in the flashcards.
- **[Metaprogramming](https://elixir.wyattau.com/04-advanced/1_metaprogramming/):** Advanced quote/unquote and macro system concepts.
- **[Haskell Basics](https://haskell.wyattau.com/flashcards-haskell-basics/):** Functional programming patterns compared across languages.
