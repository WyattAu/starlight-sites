...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "languages", "url": "https://languages.wyattau.com"}, {"name": "Elixir", "url": "https://languages.wyattau.com/elixir"}, {"name": "Flashcards Elixir Basics", "url": "https://languages.wyattau.com/elixir/flashcards-elixir-basics"}]
}
</script>
...
- **[Elixir Practice](../practice-elixir-basics.mdx):** Auto-graded problems testing the same core Elixir concepts covered in these flashcards.
- **[Basics and Pattern Matching](../01-basics/1_basics-and-pattern-matching.md):** Deep dive into pattern matching and data types referenced in the flashcards.
- **[Metaprogramming](../04-advanced/1_metaprogramming.md):** Advanced quote/unquote and macro system concepts.
- **[Haskell Basics](../../haskell/flashcards-haskell-basics.mdx):** Functional programming patterns compared across languages.
