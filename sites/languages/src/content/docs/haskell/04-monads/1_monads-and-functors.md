...
- **[Types and Functions](/haskell/01-basics/1_types-and-functions/):** Type classes and function composition underlying functor and monad operations.
- **[Pattern Matching](/haskell/02-pattern-matching/1_pattern-matching/):** Pattern matching on Maybe, Either, and list constructors in monadic code.
- **[Advanced Types](/haskell/05-advanced/1_advanced-types/):** Type families and GADTs used to implement custom monad transformers.
