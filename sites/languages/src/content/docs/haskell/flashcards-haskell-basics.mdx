...
- **[Types and Functions](https://haskell.wyattau.com/01-basics/1_types-and-functions/):** Deep dive into currying, higher-order functions, and type classes.
- **[Pattern Matching](https://haskell.wyattau.com/02-pattern-matching/1_pattern-matching/):** Structural pattern matching on algebraic data types.
- **[Monads and Functors](https://haskell.wyattau.com/04-monads/1_monads-and-functors/):** Monad transformers and effect management covered in the flashcards.
