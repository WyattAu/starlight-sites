...
- **[Types and Functions](../../../../../haskell/src/content/docs/01-basics/1_types-and-functions):** Deep dive into currying, higher-order functions, and type classes.
- **[Pattern Matching](../../../../../haskell/src/content/docs/02-pattern-matching/1_pattern-matching):** Structural pattern matching on algebraic data types.
- **[Monads and Functors](../../../../../haskell/src/content/docs/04-monads/1_monads-and-functors):** Monad transformers and effect management covered in the flashcards.
- **[Rust Traits](../rust/flashcards-rust-basics):** Rust's trait system provides similar type-level abstractions to Haskell's type classes.
