...
title: "Programming Languages - Wyatt's Notes"
description: "Comparative programming language notes covering syntax, paradigms, type systems, and concurrency models across Dart, Go, Rust, Python, and more."
sources:
  - text: "Abelson, H. & Sussman, G. J. (1996). Structure and Interpretation of Computer Programs (2nd ed.). MIT Press."
  - text: "Kernighan, B. W. & Ritchie, D. M. (1988). The C Programming Language (2nd ed.). Prentice Hall."
  - text: "Scott, M. L. (2015). Programming Language Pragmatics (4th ed.). Morgan Kaufmann."
  - text: "Pierce, B. C. (2002). Types and Programming Languages. MIT Press."
  - text: "Sebesta, R. W. (2012). Concepts of Programming Languages (10th ed.). Pearson."
hero:
...
- **[Computer Science](../../../../typescript/src/content/docs/index):** Algorithms, data structures, and theory of computation foundations.
- **[Mathematics](../../../../typescript/src/content/docs/index):** Linear algebra, calculus, and discrete mathematics for formal reasoning.
- **[Physics](../../../../typescript/src/content/docs/index):** Classical mechanics, electromagnetism, and quantum physics.
