...
description: "Study notes for Virtual Threads and Structured Concurrency with worked examples, practice problems, and key concepts for exam preparation."
categories: ["java"]
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "languages", "url": "https://languages.wyattau.com"}, {"name": "Java", "url": "https://languages.wyattau.com/java"}, {"name": "08 Modern Java", "url": "https://languages.wyattau.com/java/08-modern-java"}, {"name": "02 Virtual Threads Structured Concurrency", "url": "https://languages.wyattau.com/java/08-modern-java/02-virtual-threads-structured-concurrency"}]
}
</script>
...
- [Concurrency](/java/06-concurrency/01-concurrency/) -- traditional concurrency primitives,
  `ReentrantLock``CompletableFuture`
- [Collections Framework](/java/04-collections/01-collections-framework/) -- thread-safe collections
...
- [Class Loading and Memory Model](/java/09-jvm-internals/01-class-loading-memory/) -- how the JVM
