...
- [Concurrency](/java/06-concurrency/01-concurrency/) -- how threads interact with JVM memory
- [Style and Patterns](/java/07-best-practices/01-style-and-patterns/) -- memory management best
  practices
- [JIT Compilation](/java/09-jvm-internals/02-jit-compilation/) -- how the JIT compiler optimizes hot
  code
