...
- **[Generics](/java/11-generics-reflection/01-generics/):** Type erasure and generic type tokens used in reflective type inspection.
- **[Concurrency Deep Dive](/java/06-concurrency/02-concurrency-deep-dive/):** MethodHandle and VarHandle for low-level concurrent field access.
- **[Testing](/java/14-testing/testing/):** Reflection-based test doubles and annotation-driven test configuration.
