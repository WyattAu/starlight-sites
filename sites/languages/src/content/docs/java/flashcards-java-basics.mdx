...
- **[Kotlin Basics](https://kotlin.wyattau.com/flashcards-kotlin-basics/):** Kotlin runs on the JVM and is more concise than Java.
- **[Go Standard Library](https://go.wyattau.com/flashcards-standard-library/):** Go's approach to concurrency and standard library compared to Java.
