...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "languages", "url": "https://languages.wyattau.com"}, {"name": "Java", "url": "https://languages.wyattau.com/java"}, {"name": "Flashcards Java Basics", "url": "https://languages.wyattau.com/java/flashcards-java-basics"}]
}
</script>
...
- **[Java Fundamentals Practice](../java/practice-java-basics.mdx):** Auto-graded problems testing the same core Java concepts covered in these flashcards.
- **[Types and Variables](../java/02-fundamentals/01-types-and-variables.md):** Primitive and reference type fundamentals.
- **[Control Flow](../java/02-fundamentals/02-control-flow.md):** If-else, switch, and loop constructs.
- **[Kotlin Basics](../../kotlin/flashcards-kotlin-basics.mdx):** Kotlin runs on the JVM and is more concise than Java.
- **[Go Standard Library](../../go/flashcards-standard-library.mdx):** Go's approach to concurrency and standard library compared to Java.
