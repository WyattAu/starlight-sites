...
- **[Java Basics](https://java.wyattau.com/flashcards-java-basics/):** Kotlin runs on the JVM; understanding Java helps with Kotlin interop.
- **[Dart Basics](https://dart.wyattau.com/flashcards-dart-basics/):** Null safety and async patterns compared across languages.
