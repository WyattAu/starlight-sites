...
- [Coroutines](https://kotlin.wyattau.com/intermediate/coroutines/), StateFlow and MutableStateFlow use property delegation for reactive state management in coroutine-based architectures.
