...
- [Types and Variables](../../../../../../kotlin/src/content/docs/basics/types-and-variables) — Boolean truthiness, None checks, and the **bool** protocol determine how conditions evaluate in control flow.
