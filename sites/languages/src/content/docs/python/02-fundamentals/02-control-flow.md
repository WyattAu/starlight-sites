...
- [Types and Variables](https://kotlin.wyattau.com/basics/types-and-variables/), Boolean truthiness, None checks, and the **bool** protocol determine how conditions evaluate in control flow.
- [Collections](https://kotlin.wyattau.com/intermediate/collections/), Iterating over lists, dicts, and sets in for loops uses the iterator protocol that underpins all collection types.
- [Python Internals](/python/02-fundamentals/05-python-internals/), The bytecode instructions generated by if/else and for loops are visible in the dis module output.
- [Dicts, Sets, and Collections Deep Dive](/python/03-data-structures/02-dicts-sets-counter/), Pattern matching and dictionary dispatch relate to the dict-based dispatch patterns in collections.
:::
