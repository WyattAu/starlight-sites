...
- **[Python Practice](practice-python-basics):** Auto-graded problems testing the same core Python concepts.
- **[Python Interactive Practice](../../../../../ib/src/content/docs/mathematics/practice-interactive):** Advanced practice with async, functional, and advanced patterns.
