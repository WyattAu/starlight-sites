...
- **[Python Practice](/python/practice-python-basics/):** Auto-graded problems testing the same core Python concepts.
- **[Python Interactive Practice](https://ib.wyattau.com/mathematics/practice-interactive/):** Advanced practice with async, functional, and advanced patterns.
...
- **[Ruby Basics](/ruby/flashcards-ruby-basics/):** Dynamic typing and object-oriented patterns compared across languages.
