...
- [Variables and Types](/ruby/01-basics/1_variables-and-types/) defines the data types that methods accept as parameters and return as values.
- [Control Flow](/ruby/02-control-flow/1_control-flow/) provides the conditional logic used within method bodies and block iterations.
- [Object-Oriented Programming](/ruby/04-oop/1_oop/) shows how methods define object behaviour in Ruby's class-based system.
