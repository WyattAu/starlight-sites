...
- [Object-Oriented Programming](../04-oop/1_oop) defines the objects and state that concurrent threads access and modify.
- [Metaprogramming](../../../../../../elixir/src/content/docs/04-advanced/1_metaprogramming) can introduce race conditions when dynamically modifying class definitions across threads.
- [Methods and Blocks](../03-methods-blocks/1_methods-and-blocks) shows how method calls and blocks interact with Ruby's thread scheduler.
