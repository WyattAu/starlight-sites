...
title: "Structs Enums | Languages - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 03 structs enums study notes for languages with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
