...
title: "Macros | Languages - Wyatt's Notes"
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "languages", "url": "https://languages.wyattau.com"}, {"name": "Rust", "url": "https://languages.wyattau.com/rust"}, {"name": "08 Macros", "url": "https://languages.wyattau.com/rust/08-macros"}]
}
</script>
...
- [Rust Ownership and Borrowing](/rust/02-ownership-borrowing/ownership/) -- Ownership rules are enforced at compile time, while macros operate on the syntax tree before type checking.
- [Rust Traits](https://programming.wyattau.com/templates_and_metaprogramming/3_compile_time_computation/4_type_traits/) -- Derive macros automatically generate trait implementations, reducing boilerplate.
- [Rust Generics](https://kotlin.wyattau.com/intermediate/generics/) -- Generic functions and trait bounds work alongside macros for type-safe code generation.
- [Rust Error Handling](https://dart.wyattau.com/08-error-handling/) -- Procedural macros can generate error handling boilerplate for custom error types.
:::
