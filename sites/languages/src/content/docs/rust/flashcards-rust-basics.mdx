...
- **[Rust Practice](/rust/practice-rust-basics/):** Auto-graded problems testing ownership, borrowing, and concurrency concepts.
- **[Go Concurrency](https://go.wyattau.com/concurrency/channels/):** Channel-based concurrency patterns compared to Rust's ownership model.
- **[Haskell Types](https://haskell.wyattau.com/01-basics/1_types-and-functions/):** Type system fundamentals that Rust's traits and generics build upon.
