...
- **[Rust Practice](practice-rust-basics):** Auto-graded problems testing ownership, borrowing, and concurrency concepts.
- **[Go Concurrency](../../../../../go/src/content/docs/concurrency/channels):** Channel-based concurrency patterns compared to Rust's ownership model.
- **[Haskell Types](../../../../../haskell/src/content/docs/01-basics/1_types-and-functions):** Type system fundamentals that Rust's traits and generics build upon.
- **[Swift Value Types](../swift/flashcards-swift-basics):** Value semantics and memory safety without garbage collection.
