...
title: "Genetics | Leaving Cert - Wyatt's Notes"
sources:
  - text: Standard textbook reference
description: "Comprehensive 3 genetics study notes for leaving-cert with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
