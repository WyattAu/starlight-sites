...
sources:
  - text: Standard textbook reference
description: "Comprehensive 1 atomic structure study notes for leaving-cert with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: Standard textbook reference
...
- [1_atomic Structure](./1_atomic-structure)
