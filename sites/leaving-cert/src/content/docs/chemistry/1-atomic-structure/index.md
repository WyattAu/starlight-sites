...
description: "This section covers atomic structure concepts, definitions, and applications with worked examples and practice problems."
...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. If Atomic Structure feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
...
- [1_atomic Structure](/chemistry/1-atomic-structure/1_atomic-structure/)
...
Work through Atomic Structure alongside the practice problems for Chemistry, then let the diagnostic tests tell you whether it stuck.
