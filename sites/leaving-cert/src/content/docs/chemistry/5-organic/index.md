...
This section covers fundamental chemical principles, from atomic structure and bonding to reaction kinetics and equilibrium. Revision works best in one direction here: read Organic, attempt the practice problems cold, and only then check the worked solutions.
...
- [5_organic](/chemistry/5-organic/5_organic/)
...
If Organic feels solid, move on; if not, the worked examples below are the fastest way to repair it before the exam.
