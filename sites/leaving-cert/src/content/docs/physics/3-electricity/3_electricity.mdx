...
<aside aria-label="Only resistors dissipate power in AC circuits. Inductors and capacitors store and release" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Useful rules of thumb for RC circuits:" class="starlight-aside starlight-aside--note">
