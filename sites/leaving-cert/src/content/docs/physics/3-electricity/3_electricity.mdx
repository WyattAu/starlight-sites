...
- **[Mechanics](../1-mechanics/1_mechanics):** Covers work, energy, and power concepts that connect to electrical energy and circuits.
- **[Light and Waves](../2-waves/2_waves):** Explores the electromagnetic spectrum and wave properties, linking to electromagnetic induction.
- **[Heat and Thermodynamics](../4-heat/4_heat):** Covers energy transfer and thermodynamics, connecting to the energy dissipation in electrical circuits.
- **[Practice Physics](../practice-physics):** Interactive practice problems covering electricity, circuits, and other physics topics.
