...
<Aside type="note" title="Only resistors dissipate power in AC circuits. Inductors and capacitors store and release">
...
<Aside type="note" title="Useful rules of thumb for RC circuits:">
