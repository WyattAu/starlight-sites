...
- [File Systems and Mounting](/02-file-systems/filesystems-and-mounting/) -- File permissions are a property of the file system; understanding mounting helps with permission management across partitions.
