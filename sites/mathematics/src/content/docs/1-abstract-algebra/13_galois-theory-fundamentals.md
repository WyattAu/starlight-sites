...
- **[Additional Results](/1-abstract-algebra/14_additional-results/)**: Extends the group theory toolkit with Cauchy's theorem and the structure theorem for abelian groups, which underpin the classification of Galois groups.
