...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "mathematics", "url": "https://mathematics.wyattau.com"}, {"name": "1 Abstract Algebra", "url": "https://mathematics.wyattau.com/1-abstract-algebra"}, {"name": "2_subgroups", "url": "https://mathematics.wyattau.com/1-abstract-algebra/2_subgroups"}]
}
</script>
...
A subgroup is a subset of a group that is itself a group under the same operation. The subgroup criterion, $ab^{-1} \in H$ for all $a, b \in H$, packages closure, identity, and inverses into one condition. The cyclic subgroup generated by an element $g$ consists of all powers of $g$: it is the smallest subgroup containing $g$, like the orbit of a single rotation. Lagrange's theorem says the size of any subgroup divides the size of the whole group, which severely limits the possible subgroup structures. Normal subgroups are the ones that are compatible with coset multiplication, enabling quotient groups, the algebraic analogue of factoring out by a symmetry.
...
- **[Groups](/1-abstract-algebra/1_groups/)**: Every subgroup is itself a group under the inherited operation.
- **[Lagrange's Theorem](/1-abstract-algebra/3_lagrange-s-theorem/)**: Lagrange's theorem shows the order of a subgroup divides the order of the group.
- **[Normal Subgroups and Quotient Groups](/1-abstract-algebra/4_normal-subgroups-and-quotient-groups/)**: Normal subgroups are those for which the quotient group construction is well-defined.
