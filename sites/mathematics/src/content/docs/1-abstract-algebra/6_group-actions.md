...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "mathematics", "url": "https://mathematics.wyattau.com"}, {"name": "1 Abstract Algebra", "url": "https://mathematics.wyattau.com/1-abstract-algebra"}, {"name": "6_group Actions", "url": "https://mathematics.wyattau.com/1-abstract-algebra/6_group-actions"}]
}
</script>
...
- [The Sylow Theorems](/1-abstract-algebra/7_the-sylow-theorems/) -- Sylow's theorems use group actions on coset spaces and conjugacy classes to count subgroups.
- [Lagrange's Theorem](/1-abstract-algebra/3_lagrange-s-theorem/) -- The orbit-stabilizer theorem is a generalisation of Lagrange's theorem applied to group actions.
- [Classification of Groups of Small Order](/1-abstract-algebra/16_classification-of-groups-of-small-order/) -- Group actions on conjugacy classes and Sylow subgroups drive the classification of small-order groups.
- [Worked Examples](/1-abstract-algebra/15_worked-examples/) -- Several worked examples apply orbit-stabilizer and Burnside's lemma to concrete counting problems.
