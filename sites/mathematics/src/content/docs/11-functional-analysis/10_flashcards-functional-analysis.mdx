...
description: "import { flashcards1, flashcards2, flashcards3, flashcards4 } from '@/data/flashcards/mathematics/11-functional-analysis/10_flashcards-functional-analysis-data."
...
- **[Linear Algebra](../../../../../typescript/src/content/docs/index):** Vector spaces and inner products; functional analysis extends these to infinite dimensions.
- **[Measure Theory](../../../../../typescript/src/content/docs/index):** L^p spaces built on measure-theoretic foundations; integration defines the norms.
- **[Real Analysis](../../../../../typescript/src/content/docs/index):** Convergence, continuity, and completeness underpin Banach and Hilbert space theory.
