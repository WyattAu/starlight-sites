...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "mathematics", "url": "https://mathematics.wyattau.com"}, {"name": "12 Differential Geometry", "url": "https://mathematics.wyattau.com/12-differential-geometry"}, {"name": "2_tangent Spaces And Tangent Bundles", "url": "https://mathematics.wyattau.com/12-differential-geometry/2_tangent-spaces-and-tangent-bundles"}]
}
</script>
...
- **[Curvature](/12-differential-geometry/7_curvature/)**: Uses the tangent bundle and connections to define the Riemann curvature tensor, measuring how parallel transport rotates vectors.
- **[The Gauss-Bonnet Theorem](/12-differential-geometry/8_the-gauss-bonnet-theorem/)**: Relates the integral of Gaussian curvature over a surface to its Euler characteristic, a topological invariant of the tangent bundle.
- **[Applications](/12-differential-geometry/9_applications/)**: Uses tangent spaces and vector fields to model geodesics as a rule relativity and configuration spaces in robotics.
