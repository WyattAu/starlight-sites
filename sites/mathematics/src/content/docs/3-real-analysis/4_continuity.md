...
title: "Continuity | Mathematics - Wyatt's Notes"
tags:
  - Mathematics
  - University
...
- **[Differentiability](5_differentiability)**: Differentiability implies continuity, but the converse is false; the relationship between these concepts is explored via the mean value theorem.
- **[Riemann Integration](6_riemann-integration)**: Continuous functions on closed intervals are Riemann integrable, and the Heine-Cantor theorem guarantees uniform continuity on compact domains.
- **[Sigma-Algebras and Measurable Spaces](../10-measure-theory/1_sigma-algebras-and-measurable-spaces)**: Continuity is defined in terms of open sets, which generate the Borel sigma-algebra used in measure theory.
