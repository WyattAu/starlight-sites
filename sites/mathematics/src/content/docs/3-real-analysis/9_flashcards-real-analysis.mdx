...
- **Compactness**: a set is compact if every open cover has a finite subcover. In ℝⁿ, compact = closed and bounded (Heine-Borel). In general metric spaces, compactness is strictly stronger than closed and bounded.
