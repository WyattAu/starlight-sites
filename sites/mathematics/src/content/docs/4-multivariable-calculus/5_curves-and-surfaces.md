...
title: "Curves and Surfaces | Mathematics"
tags:
  - Mathematics
  - University
...
- **[Vector Calculus](3_vector-calculus)**: Surface integrals and flux integrals are computed using the normal vector and the tools of vector calculus.
- **[Multiple Integrals](2_multiple-integrals)**: Surface area and surface integrals are evaluated as double integrals using the parametrisation and the cross product.
- **[Curvature and Torsion](5_curves-and-surfaces)**: The Frenet-Serret formulas describe how the tangent, normal, and binormal vectors move along a curve.
