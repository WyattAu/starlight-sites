...
- **Multivariable Calculus:** Partial derivatives and vector calculus fundamentals.
- **Linear Algebra:** Jacobians and Hessians as matrices; gradients are vector quantities.
- **Ordinary Differential Equations:** Systems of ODEs use multivariable calculus; vector fields are multivariable functions.
- **Differential Geometry:** Manifolds extend multivariable calculus to curved spaces.
