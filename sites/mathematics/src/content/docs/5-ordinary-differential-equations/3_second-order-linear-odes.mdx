...
<aside aria-label="Common Pitfall When using undetermined coefficients, always check whether your guess" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common Pitfall For Euler-Cauchy equations, the substitution $y = x^r$ only works for" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="Common Pitfall Variation of parameters always works but can lead to difficult integrals." class="starlight-aside starlight-aside--caution">
