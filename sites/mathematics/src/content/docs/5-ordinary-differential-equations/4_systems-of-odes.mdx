...
title: "Systems of ODEs | Mathematics - Wyatt's Notes"
tags:
  - Mathematics
  - University
...
- **[Stability and Phase Plane Analysis](9_stability-and-phase-plane-analysis)**: The phase portrait classification of 2D systems uses the eigenvalue analysis developed for matrix systems.
- **[Second-Order Linear ODEs](3_second-order-linear-odes)**: Systems of first-order ODEs can be derived from a single second-order ODE by introducing new variables.
- **[Laplace Transforms](5_laplace-transforms)**: The Laplace transform converts systems of ODEs into algebraic equations in the frequency domain.
