...
- **[Singularities and Residue Theory](/6-complex-analysis/8_singularities-and-residue-theory/)**: The residue theorem provides the computational tool for evaluating contour integrals.
- **[Complex Integration](/6-complex-analysis/4_complex-integration/)**: Contour integration techniques form the foundation for evaluating real integrals.
- **[Conformal Mappings](/6-complex-analysis/10_conformal-mappings/)**: Conformal mappings can transform difficult integrals into simpler ones that are easier to evaluate.
