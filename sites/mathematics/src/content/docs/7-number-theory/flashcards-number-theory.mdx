...
description: "import { flashcards1, flashcards2, flashcards3, flashcards4 } from '@/data/flashcards/mathematics/7-number-theory/flashcards-number-theory-data.js';"
...
- **[Abstract Algebra](../../../../../typescript/src/content/docs/index):** Group theory in modular arithmetic; (Z/nZ)* is a group under multiplication.
- **[Complex Analysis](../../../../../typescript/src/content/docs/index):** Analytic number theory uses complex analysis (e.g., Riemann zeta function).
- **[Linear Algebra](../../../../../typescript/src/content/docs/index):** Matrix methods in number theory (e.g., lattice reduction).
