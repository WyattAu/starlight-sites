...
- **[Fourier Analysis](/university/mathematics/real-analysis)**: Fourier series decomposition is a central topic in real analysis, connecting periodic functions to infinite sums of sines and cosines.
- **[Linear Algebra](/university/mathematics/linear-algebra)**: The sine and square wave visualisations illustrate orthogonal function bases, a key concept in linear algebra.
- **[Complex Analysis](/university/mathematics/complex-analysis)**: Complex exponentials provide an alternative formulation of Fourier series via Euler's formula.
