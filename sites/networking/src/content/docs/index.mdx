...
title: "Networking - Wyatt's Notes"
description: "Computer networking from fundamentals to administration: OSI and TCP/IP models, routing and switching, DNS, DHCP, HTTP/HTTPS, firewall configuration, VPNs,"
hero:
