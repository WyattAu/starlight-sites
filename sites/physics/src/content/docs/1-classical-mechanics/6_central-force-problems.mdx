...
- **[Lagrangian Mechanics](3_lagrangian-mechanics)**: The Lagrangian formulation provides the effective potential analysis for central force problems.
- **[Hamiltonian Mechanics](4_hamiltonian-mechanics)**: The Hamiltonian formalism gives the total energy and phase space representation of central force orbits.
