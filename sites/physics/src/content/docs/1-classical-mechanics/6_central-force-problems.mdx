...
- **[Noether's Theorem](5_noether-s-theorem-and-conservation-laws.md)**: Rotational symmetry of central potentials leads to angular momentum conservation via Noether's theorem.
