...
- **[Lagrangian Mechanics](/1-classical-mechanics/3_lagrangian-mechanics/)**: Many problems here apply the Euler-Lagrange equations and generalised coordinates from the Lagrangian formalism.
- **[Central Force Problems](/1-classical-mechanics/6_central-force-problems/)**: The orbital mechanics and scattering problems draw on central force theory and the effective potential.
- **[Hamiltonian Mechanics](/1-classical-mechanics/4_hamiltonian-mechanics/)**: Phase space analysis and canonical transformations are needed for the more advanced problems in this set.
