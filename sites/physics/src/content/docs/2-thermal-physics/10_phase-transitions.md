...
- **[The Ising Model](/2-thermal-physics/6_the-ising-model/)**: The Ising model is the simplest model exhibiting a second-order phase transition with well-characterised critical exponents.
- **[Statistical Mechanics](/2-thermal-physics/2_statistical-mechanics/)**: Phase transitions are understood through the partition function and free energy minima in statistical mechanics.
- **[Bose-Einstein Condensation](/2-thermal-physics/5_bose-einstein-condensation/)**: Bose-Einstein condensation is a quantum phase transition driven purely by Bose statistics.
