...
- **[Statistical Mechanics](/2-thermal-physics/2_statistical-mechanics/)**: The canonical ensemble is the fixed-temperature counterpart to the microcanonical ensemble, with equivalent predictions in the thermodynamic limit.
- **[The Laws of Thermodynamics](/2-thermal-physics/1_the-laws-of-thermodynamics/)**: The microcanonical entropy $S = k_B \ln \Omega$ provides the microscopic foundation for the second law of thermodynamics.
- **[The Grand Canonical Ensemble](/2-thermal-physics/3_the-grand-canonical-ensemble/)**: The grand canonical ensemble further extends the framework to systems that exchange both energy and particles with a reservoir.
