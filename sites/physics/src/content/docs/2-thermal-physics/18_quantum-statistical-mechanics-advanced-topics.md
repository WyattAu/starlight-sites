...
- **[Statistical Mechanics](2_statistical-mechanics.md)**: The density matrix formalism extends the canonical ensemble framework to quantum systems with mixed states.
