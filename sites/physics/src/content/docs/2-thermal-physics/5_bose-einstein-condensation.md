...
- **[Statistical Mechanics](/2-thermal-physics/2_statistical-mechanics/)**: Bose-Einstein statistics are derived from the grand canonical ensemble for particles with integer spin.
- **[The Grand Canonical Ensemble](/2-thermal-physics/3_the-grand-canonical-ensemble/)**: The grand canonical ensemble is the natural framework for deriving Bose-Einstein and Fermi-Dirac distributions.
- **[Fermi Gas at Finite Temperature](/2-thermal-physics/4_fermi-gas-at-finite-temperature/)**: The contrast between Bose and Fermi statistics leads to fundamentally different low-temperature behaviours.
