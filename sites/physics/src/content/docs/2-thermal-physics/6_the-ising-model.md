...
- **[Statistical Mechanics](/2-thermal-physics/2_statistical-mechanics/)**: The Ising model partition function is computed using the same statistical mechanics framework as the canonical ensemble.
- **[Phase Transitions](/2-thermal-physics/10_phase-transitions/)**: The Ising model exhibits a second-order phase transition with universal critical exponents described by Landau theory.
- **[The Laws of Thermodynamics](/2-thermal-physics/1_the-laws-of-thermodynamics/)**: The Ising model free energy minimisation at equilibrium follows from the second law of thermodynamics.
