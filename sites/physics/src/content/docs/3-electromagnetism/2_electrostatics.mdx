...
- **[Maxwell's Equations](/3-electromagnetism/1_maxwell-s-equations/)**: Electrostatics provides the static electric field solutions that form two of Maxwell's four equations.
- **[Potentials and Gauge Transformations](/3-electromagnetism/6_potentials-and-gauge-transformations/)**: The electric potential introduced here is the scalar potential used in the general gauge theory framework.
- **[Electrodynamics](/3-electromagnetism/4_electrodynamics/)**: Electrostatics is the zero-velocity limit of the full electrodynamics theory developed in the next chapter.
