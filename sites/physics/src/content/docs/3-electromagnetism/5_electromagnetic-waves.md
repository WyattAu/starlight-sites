...
- [Potentials and Gauge Transformations](/3-electromagnetism/6_potentials-and-gauge-transformations/) -- The scalar and vector potentials simplify the derivation of radiation fields from accelerated charges.
- [Special Relativity and Electromagnetism](/3-electromagnetism/7_special-relativity-and-electromagnetism/) -- The relativistic invariance of Maxwell's equations shows that EM waves propagate at $c$ in all frames.
- [Radiation from Accelerating Charges](/3-electromagnetism/10_radiation-from-accelerating-charges/) -- The Larmor formula and dipole radiation patterns extend the plane-wave analysis to realistic sources.
