...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "physics", "url": "https://physics.wyattau.com"}, {"name": "3 Electromagnetism", "url": "https://physics.wyattau.com/3-electromagnetism"}, {"name": "Index", "url": "https://physics.wyattau.com/3-electromagnetism/index"}]
}
</script>
...
5. [Electromagnetic Waves](5_electromagnetic-waves.md)
6. [Potentials and Gauge Transformations](6_potentials-and-gauge-transformations.md)
7. [Special Relativity and Electromagnetism](7_special-relativity-and-electromagnetism.md)
8. [Problem Set](8_problem-set.md)
9. [Waveguides and Cavities](9_waveguides-and-cavities.md)
10. [Radiation from Accelerating Charges](10_radiation-from-accelerating-charges.md)
11. [Advanced Electrodynamics](11_advanced-electrodynamics.md)
12. [Special Relativity and Electromagnetism](12_special-relativity-and-electromagnetism-12.md)
13. [Plasma Physics: Brief Overview](13_plasma-physics-brief-overview.md)
