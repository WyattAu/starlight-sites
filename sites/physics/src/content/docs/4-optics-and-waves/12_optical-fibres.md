...
- **[Geometric Optics](/4-optics-and-waves/6_geometric-optics/)**: Total internal reflection and the critical angle derived in geometric optics are the guiding mechanism for light in optical fibres.
- **[Dispersion](/4-optics-and-waves/11_dispersion/)**: Material and waveguide dispersion limit the data rate in fibre communication by broadening optical pulses.
- **[Electromagnetic Waves](/4-optics-and-waves/2_electromagnetic-waves/)**: The wave equation and boundary conditions for electromagnetic fields in cylindrical waveguides determine the fibre modes.
