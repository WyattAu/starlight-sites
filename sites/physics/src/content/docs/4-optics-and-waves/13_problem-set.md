...
- **[The Wave Equation](/4-optics-and-waves/1_the-wave-equation/)**: The string and wave problems here apply the classical wave equation solutions derived in this chapter.
- **[Interference](/4-optics-and-waves/3_interference/)**: The thin-film and double-slit problems use the path difference and phase shift principles from interference theory.
- **[Diffraction](/4-optics-and-waves/4_diffraction/)**: The grating and single-slit problems require the Fraunhofer diffraction formulas developed in this chapter.
