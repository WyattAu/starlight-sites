...
- **[Diffraction](/4-optics-and-waves/4_diffraction/)**: Provides the physical foundation for Fraunhofer diffraction through the Huygens-Fresnel principle and Kirchhoff integral.
- **[Fourier Optics](/4-optics-and-waves/7_fourier-optics/)**: Develops the 4f imaging system, optical transfer function, and spatial filtering applications that build on the Fourier transform framework.
- **[Coherence](/4-optics-and-waves/15_coherence-theory/)**: The coherence properties of the source determine whether the Fourier transform relationship between aperture and far-field pattern is valid.
