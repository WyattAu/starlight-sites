...
```mermaid
flowchart TD
    A[18_Common Pitfalls] --> B[Key Concepts]
    A --> C[Core Principles]
...
- [Fourier Optics](/4-optics-and-waves/19_fourier-optics-15/) -- The Fraunhofer/Fresnel distinction and spatial filtering concepts are developed systematically in the Fourier optics chapter.
- [Coherence Theory](/4-optics-and-waves/20_coherence-theory-16/) -- Temporal and spatial coherence, fringe visibility, and the van Cittert-Zernike theorem are treated in detail here.
- [Lasers](/4-optics-and-waves/9_lasers/) -- Coherence length, mode structure, and the relationship between linewidth and coherence are covered in the laser chapter.
