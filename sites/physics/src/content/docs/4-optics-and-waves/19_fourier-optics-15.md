...
- [Coherence Theory](/4-optics-and-waves/20_coherence-theory-16/) -- Spatial coherence determines the visibility of diffraction patterns; the van Cittert-Zernike theorem connects source size to coherence width.
- [Lasers](/4-optics-and-waves/9_lasers/) -- Gaussian beam propagation and spatial filtering of laser beams are direct applications of Fourier optics principles.
