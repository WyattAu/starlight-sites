...
- **[The Wave Equation](/4-optics-and-waves/1_the-wave-equation/)**: Interference arises from the superposition principle applied to solutions of the wave equation.
...
- **[Coherence Theory](/4-optics-and-waves/8_coherence/)**: Coherence theory explains the conditions under which stable interference patterns can be observed.
