...
- **[Electromagnetic Waves](/4-optics-and-waves/2_electromagnetic-waves/)**: Derives the wave equations and boundary conditions from which Snell's law and the Fresnel equations emerge in the high-frequency limit.
- **[Fresnel Equations](/4-optics-and-waves/10_fresnel-equations/)**: Provides the amplitude reflection and transmission coefficients that govern the intensity of reflected and refracted rays.
- **[Optical Fibres](/4-optics-and-waves/12_optical-fibres/)**: Applies total internal reflection to guide light in fibre cores, a direct application of the ray optics developed here.
...
```mermaid
flowchart TD
    A[6_Geometric Optics] --> B[Key Concepts]
    A --> C[Core Principles]
