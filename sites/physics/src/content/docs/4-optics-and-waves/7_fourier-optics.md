...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "physics", "url": "https://physics.wyattau.com"}, {"name": "4 Optics And Waves", "url": "https://physics.wyattau.com/4-optics-and-waves"}, {"name": "7_fourier Optics", "url": "https://physics.wyattau.com/4-optics-and-waves/7_fourier-optics"}]
}
</script>
...
- **[Diffraction](/4-optics-and-waves/4_diffraction/)**: Establishes the Huygens-Fresnel principle and Fraunhofer diffraction integral that the Fourier transform relationship formalises.
- **[Coherence](/4-optics-and-waves/8_coherence/)**: The spatial and temporal coherence of the source determines whether the Fourier transform relationship between aperture and far-field pattern holds.
- **[Fourier Optics](/4-optics-and-waves/14_fourier-optics-10/)**: Provides the mathematical framework for diffraction as Fourier decomposition, including the convolution theorem and Airy pattern.
