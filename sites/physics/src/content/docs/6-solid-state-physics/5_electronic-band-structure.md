...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "physics", "url": "https://physics.wyattau.com"}, {"name": "6 Solid State Physics", "url": "https://physics.wyattau.com/6-solid-state-physics"}, {"name": "5_electronic Band Structure", "url": "https://physics.wyattau.com/6-solid-state-physics/5_electronic-band-structure"}]
}
</script>
...
- **[Transport Properties](/6-solid-state-physics/8_transport-properties/)**: Uses the band structure and Fermi surface to explain electrical and thermal conductivity via the Drude and Boltzmann models.
- **[Superconductivity](/6-solid-state-physics/7_superconductivity/)**: Cooper pairing and the superconducting gap arise from the electronic structure at the Fermi surface.
- **[Topological Insulators and Semimetals](/6-solid-state-physics/13_topological-insulators-and-semimetals/)**: Extends band theory to include topological invariants that classify insulating and semimetallic phases.
