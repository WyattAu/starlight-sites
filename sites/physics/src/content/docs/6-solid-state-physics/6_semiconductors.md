...
```mermaid
flowchart TD
    A[6_Semiconductors] --> B[Key Concepts]
    A --> C[Core Principles]
...
- **[Crystal Structures](/6-solid-state-physics/1_crystal-structures/)**: The crystal structure and lattice constant determine the band structure and effective masses of charge carriers.
- **[Lattice Vibrations and Phonons](/6-solid-state-physics/4_lattice-vibrations-and-phonons/)**: Phonon scattering limits carrier mobility and determines the temperature dependence of conductivity.
- **[Advanced Semiconductor Physics](/6-solid-state-physics/15_advanced-semiconductor-physics/)**: MOSFET operation, heterostructures, and the quantum Hall effect build on the basic semiconductor physics developed here.
- **[Magnetism in Solids](/6-solid-state-physics/10_magnetism-in-solids/)**: Magnetic semiconductors and spin-dependent transport connect semiconductor physics to magnetic ordering.
