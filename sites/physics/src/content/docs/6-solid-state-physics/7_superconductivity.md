...
- **[Electronic Band Structure](/6-solid-state-physics/5_electronic-band-structure/)**: The density of states at the Fermi level determines the superconducting gap and critical temperature via the BCS formula.
- **[Transport Properties](/6-solid-state-physics/8_transport-properties/)**: The zero resistance of superconductors contrasts with the finite resistivity arising from scattering in normal metals.
- **[Advanced Topics in Superconductivity](/6-solid-state-physics/12_advanced-topics-in-superconductivity/)**: Develops the Ginzburg-Landau phenomenological theory and Abrikosov vortex physics beyond the basic BCS framework.
