...
- **[Electronic Band Structure](/6-solid-state-physics/5_electronic-band-structure/)**: Defects introduce localized states within the band gap and modify the electronic structure, affecting conductivity and optical properties.
- **[Transport Properties](/6-solid-state-physics/8_transport-properties/)**: Defects contribute to electron scattering and residual resistivity, entering Matthiessen's rule as the temperature-independent component.
- **[Superconductivity](/6-solid-state-physics/7_superconductivity/)**: Defects can pin Abrikosov vortices in Type II superconductors, enhancing the critical current density.
...
```mermaid
flowchart TD
    A[9_Defects In Crystals] --> B[Key Concepts]
    A --> C[Core Principles]
