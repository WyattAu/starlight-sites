...
```mermaid
flowchart TD
    A[9_Beyond The Standard Model] --> B[Key Concepts]
    A --> C[Core Principles]
...
- **[The Standard Model](/7-particle-physics-and-cosmology/1_the-standard-model/)**: The hierarchy problem and gauge coupling unification are motivations for extending the Standard Model.
- **[The Higgs Mechanism](/7-particle-physics-and-cosmology/4_the-higgs-mechanism/)**: Supersymmetry solves the hierarchy problem by cancelling quadratic divergences in the Higgs mass.
- **[Running Coupling Constants](/7-particle-physics-and-cosmology/6_running-coupling-constants/)**: Gauge coupling unification requires new physics beyond the Standard Model, such as supersymmetry.
- **[Big Bang Cosmology](/7-particle-physics-and-cosmology/7_big-bang-cosmology/)**: Dark matter candidates and inflation models are extensions to the cosmological framework motivated by BSM physics.
