...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "physics", "url": "https://physics.wyattau.com"}, {"name": "7 Particle Physics And Cosmology", "url": "https://physics.wyattau.com/7-particle-physics-and-cosmology"}, {"name": "Index", "url": "https://physics.wyattau.com/7-particle-physics-and-cosmology/index"}]
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Course",
  "name": "Particle Physics and Cosmology",
...
1. [The Standard Model](1_the-standard-model.md)
2. [Conservation Laws and Symmetries](2_conservation-laws-and-symmetries.md)
3. [Feynman Diagrams](3_feynman-diagrams.md)
4. [The Higgs Mechanism](4_the-higgs-mechanism.md)
5. [Group Theory in Particle Physics](5_group-theory-in-particle-physics.md)
6. [Running Coupling Constants](6_running-coupling-constants.md)
7. [Big Bang Cosmology](7_big-bang-cosmology.md)
8. [Neutrino Physics](8_neutrino-physics.md)
9. [Beyond the Standard Model](9_beyond-the-standard-model.md)
10. [Problem Set](10_problem-set.md)
11. [Advanced Topics in Particle Physics](11_advanced-topics-in-particle-physics.md)
12. [Advanced Topics in Cosmology](12_advanced-topics-in-cosmology.md)
13. [Precision Tests of the Standard Model](13_precision-tests-of-the-standard-model.md)
