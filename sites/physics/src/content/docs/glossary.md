---
title: "Physics Glossary — Key Terms and Definitions"
description: "Study notes for Physics Glossary — Key Terms and Definitions with worked examples, practice problems, and key concepts for exam preparation."
date: 2026-07-24
tags: [glossary]
---
...
**Newton's Second Law**: The net force on an object equals its mass times its acceleration: **F** = m**a**. This is the fundamental equation of classical mechanics.
...
**Bohr Model**: An atomic model where electrons orbit the nucleus in quantized energy levels. Explains hydrogen spectrum but fails for multi-electron atoms.
...
**General Relativity**: Einstein's theory describing gravity as the curvature of spacetime caused by mass and energy. Field equations: G_μν + Λg_μν = (8πG/c⁴)T_μν.
