---
title: Heap
description: 'When a C++ program executes or It requests "Dynamic Storage Duration." Unlike the stack, which is managed by a simple pointer increment/decrement...'
