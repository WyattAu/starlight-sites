...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "programming", "url": "https://programming.wyattau.com"}, {"name": "Compilation_model", "url": "https://programming.wyattau.com/compilation_model"}, {"name": "1_translation", "url": "https://programming.wyattau.com/compilation_model/1_translation"}, {"name": "5_name_mangling", "url": "https://programming.wyattau.com/compilation_model/1_translation/5_name_mangling"}]
}
</script>
title: Name Mangling
...
<strong>Return Types The Itanium ABI generally does **not** encode the return type of a function, as</strong>
...
<strong>Mixing function pointers with different linkage is undefined behavior [N4950 S10.5 p7]. A</strong>
...
<aside class="starlight-aside starlight-aside--caution">
<strong>In C++17, `noexcept` became part of the type system. This means function pointer types</strong>
...
Name mangling is the compiler's way of encoding extra information into function names so the linker can distinguish between functions that share the same base name but differ in namespaces or parameter types. Think of it as giving each function a full postal address rather than just a first name. When you declare two functions called `process` in different namespaces, mangling gives each a unique mangled name so the linker never confuses them, the way two people named John Smith need distinct addresses to receive different mail.
