...
<aside aria-label="Return Types The Itanium ABI generally does **not** encode the return type of a function, as" class="starlight-aside starlight-aside--note">
...
<aside aria-label="Mixing function pointers with different linkage is undefined behavior [N4950 S10.5 p7]. A" class="starlight-aside starlight-aside--caution">
...
<aside aria-label="In C++17, `noexcept` became part of the type system. This means function pointer types" class="starlight-aside starlight-aside--caution">
