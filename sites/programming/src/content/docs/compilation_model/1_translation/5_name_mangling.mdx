...
<Aside type="note" title="Return Types The Itanium ABI generally does **not** encode the return type of a function, as">
...
<Aside type="caution" title="Mixing function pointers with different linkage is undefined behavior [N4950 S10.5 p7]. A">
...
<Aside type="caution" title="In C++17, `noexcept` became part of the type system. This means function pointer types">
