...
sources:
  - text: McConnell - Code Complete
description: "Comprehensive 1_threading_and_synchronization study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: McConnell - Code Complete
