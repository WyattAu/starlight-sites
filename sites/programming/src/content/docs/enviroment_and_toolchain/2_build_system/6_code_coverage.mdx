...
- [Unit Tests](/enviroment_and_toolchain/2_build_system/5_unit_tests/), Writing tests that drive coverage analysis
- [Build Caching](/enviroment_and_toolchain/2_build_system/4_build_caching/), Avoiding cache poisoning with instrumented builds
- [CMake Targets and Properties](/enviroment_and_toolchain/2_build_system/1_cmake_targets_properties_generator/), Custom targets for
  coverage automation
