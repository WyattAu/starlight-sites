...
description: "Comprehensive 2_error_handling study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
...
- [1_exception_abi](./1_exception_abi)
- [2_exception_safety](./2_exception_safety)
- [3_noexcept](./3_noexcept)
- [4_optional_variant](./4_optional_variant)
- [5_expected](./5_expected)
- [Flashcards Error Handling](./flashcards-error-handling)
- [Practice Error Handling](./practice-error-handling)
