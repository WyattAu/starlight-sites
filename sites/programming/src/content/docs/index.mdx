...
title: "Programming Notes - Wyatt's Notes"
description: "Deep systems programming notes covering C++ ownership, templates, concurrency, the standard library, and build systems with worked examples."
sources:
