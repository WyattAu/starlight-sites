---
title: "1_class_design | Programming - Wyatt's Notes"
description: "Comprehensive 1_class_design study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
...
- [1_object_layout_vptr](./1_object_layout_vptr)
- [2_access_control](./2_access_control)
- [3_special_member_functions](./3_special_member_functions)
- [4_operator_overloading](./4_operator_overloading)
- [5_spaceship_operator](./5_spaceship_operator)
- [6_std_formatter](./6_std_formatter)
