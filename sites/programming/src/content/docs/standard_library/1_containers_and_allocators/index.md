...
sources:
  - text: McConnell - Code Complete
description: "Comprehensive 1_containers_and_allocators study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: McConnell - Code Complete
