...
sources:
  - text: McConnell - Code Complete
description: "Comprehensive 3_compile_time_computation study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: McConnell - Code Complete
