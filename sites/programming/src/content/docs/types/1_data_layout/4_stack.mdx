...
title: "Stack | Programming - Wyatt's Notes"
description: "The stack is like a stack of plates in a cafeteria — you can only add or remove from the top, and you do it in constant time. When a function is called, a new"
