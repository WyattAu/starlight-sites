---
title: Heap
description: "Unlike the stack, which is managed by a simple pointer increment/decrement''
...
- [Pointers](../pointers_references_views/1_pointers.mdx)
- [Unique Ownership (std::unique_ptr) and EBO](../../resource_management/ownership_and_raii/2_unique_ptr.md)
- [Polymorphic Memory Resources (PMR)](../../standard_library/containers_and_allocators/4_pmr.md)
