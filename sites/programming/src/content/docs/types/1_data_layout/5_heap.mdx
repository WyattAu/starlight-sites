...
title: "Heap | Programming - Wyatt's Notes"
description: "The heap is the Wild West of memory — vast and untamed, where any object can live at any address. Unlike the stack, which moves like a well-organised conveyor"
