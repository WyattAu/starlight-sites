...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "programming", "url": "https://programming.wyattau.com"}, {"name": "Types", "url": "https://programming.wyattau.com/types"}, {"name": "1_data_layout", "url": "https://programming.wyattau.com/types/1_data_layout"}, {"name": "5_heap", "url": "https://programming.wyattau.com/types/1_data_layout/5_heap"}]
}
</script>
title: Heap
...
The heap is the Wild West of memory — vast and untamed, where any object can live at any address. Unlike the stack, which moves like a well-organised conveyor belt, the heap is a scattered collection of free blocks that must be found, claimed, and later returned. Virtual memory is the illusion that gives each process its own private continent, even though physical RAM is shared. Page tables are the translation maps that turn virtual addresses into physical ones. When you allocate on the heap, the allocator searches its free lists like a real estate agent looking for available lots — and when you deallocate, you are returning the lot to the market.
