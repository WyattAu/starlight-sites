...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "programming", "url": "https://programming.wyattau.com"}, {"name": "Types", "url": "https://programming.wyattau.com/types"}, {"name": "2_pointers_references_views", "url": "https://programming.wyattau.com/types/2_pointers_references_views"}, {"name": "5_contiguous_memory_views", "url": "https://programming.wyattau.com/types/2_pointers_references_views/5_contiguous_memory_views"}]
}
</script>
...
A span is a window into memory — it does not own the data, it just looks at it. Think of a span as a book open on a table: you can read any page, but you did not write the book and you cannot burn it. This is useful when you want to pass a piece of an array to a function without copying: instead of handing over a photocopy, you hand over the bookmark. The key danger is that a span becomes a dangling reference if the underlying data is destroyed — like reading from a book that someone has already put back on the shelf and removed. Spans replace the old C pattern of passing a pointer and a size separately, bundling them into one safe package.
