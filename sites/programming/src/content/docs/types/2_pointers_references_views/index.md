...
sources:
  - text: McConnell - Code Complete
description: "Comprehensive 2_pointers_references_views study notes for programming with worked examples, practice problems, and key concepts for exam preparation."
sources:
  - text: McConnell - Code Complete
