...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [{"name": "Home", "url": "https://wyattau.com"}, {"name": "python", "url": "https://python.wyattau.com"}, {"name": "Flashcards Python Basics", "url": "https://python.wyattau.com/flashcards-python-basics"}]
}
</script>
