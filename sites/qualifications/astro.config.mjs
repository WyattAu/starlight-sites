...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      description: "GCSE, AP, Scottish Highers, Irish Leaving Certificate, and other qualification revision notes with exam-style practice.",
      ...
      head: [
        ...
        { tag: 'meta', attrs: { property: 'og:image', content: 'https://qualifications.wyattau.com/img/social-card.svg' } },
        { tag: 'script', attrs: { src: '/cross-site-search.js', defer: true } },
        { tag: 'script', attrs: { src: '/page-search.js', defer: true } },
        { tag: 'script', attrs: { type: 'application/ld+json' }, content: JSON.stringify({ "@context": "https://schema.org", "@type": "WebSite", "name": "Qualifications Notes", "description": "GCSE, AP, and other qualifications", "url": "https://qualifications.wyattau.com", "publisher": { "@type": "Organization", "name": "Wyatt's Notes", "url": "https://wyattsnotes.wyattau.com" } }) },
      ],
