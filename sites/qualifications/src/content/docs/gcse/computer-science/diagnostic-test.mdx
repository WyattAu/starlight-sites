...
<DiagnosticTest title="GCSE Computer Science Diagnostic Test" description="20 questions covering fundamentals, hardware, networks, algorithms, and programming." questions={questions} />
## Scoring
