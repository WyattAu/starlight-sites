...
- [Variables and Types](https://languages.wyattau.com/ruby/01-basics/1_variables-and-types/) - Ruby's dynamic type system and variable scoping rules
- [Methods and Blocks](https://languages.wyattau.com/ruby/03-methods-blocks/1_methods-and-blocks/) - How blocks, procs, and closures form Ruby's functional capabilities
- [OOP](https://languages.wyattau.com/ruby/04-oop/1_oop/) - Ruby's object model where everything is an object
