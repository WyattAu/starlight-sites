...
title: "Rust - Wyatt's Notes"
description: "Rust is a programming language with a rich type system and ecosystem. These notes cover the language from fundamentals to advanced topics, with worked"
hero:
...
Rust is a programming language with a rich type system and ecosystem. Work through the Rust sections in order, starting with Cargo Ecosystem and Concurrency and building toward Cargo Ecosystem, Concurrency, Error Handling, Fundamentals, Ownership Borrowing, Structs Enums and Traits Generics, then check yourself with the practice problems for each topic.
