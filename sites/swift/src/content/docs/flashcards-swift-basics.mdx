...
title: "Swift Basics Flashcards - Wyatt's Notes"
description: "Swift is designed for safety and performance — optionals force you to handle nil at compile time, value types (structs, enums) prevent shared state bugs, and"
sidebar_position: 51
---
