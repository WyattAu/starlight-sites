...
- **[Linked Lists, Stacks, and Queues](/algorithms/03-linked-lists-stacks-queues/linked-lists-stacks-queues/):** Alternative linear data structures that complement hash tables for different use cases.
- **[Sorting Algorithms](/algorithms/05-sorting/sorting/):** Covers comparison-based and non-comparison sorting, which can be combined with hash-based techniques.
- **[Dynamic Programming](/algorithms/06-dynamic-programming/dynamic-programming/):** Explores overlapping subproblems and optimal substructure, concepts related to hash-based memoisation.
