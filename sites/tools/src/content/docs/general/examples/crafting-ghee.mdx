...
title: "Crafting Ghee | Tools - Wyatt's Notes"
description: "Clarifying butter to its essence: Making ghee is like refining gold — you heat butter to drive off water and milk solids, leaving behind pure butterfat with a"
...
1. Controlled Caramelization (Temperature: $118-121\degree C$)
...
```mermaid
flowchart TD
    A[Crafting Gheex] --> B[Key Concepts]
    A --> C[Core Principles]
