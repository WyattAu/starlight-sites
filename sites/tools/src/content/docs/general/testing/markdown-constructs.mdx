...
description: "The building blocks of documentation: Markdown constructs are like LEGO bricks for documentation, each construct (headings, tables, code blocks, asides)"
...
- **[Markdown Constructs](../markdown-constructs):** Reference guide for Markdown syntax and formatting rules.
