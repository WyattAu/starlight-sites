...
# Default pull strategy: rebase instead of merge (see [Remotes](/git/04-remotes-and-workflows/01-remote-operations/))
...
| Section                                                                     | Content                                                   |
| --------------------------------------------------------------------------- | --------------------------------------------------------- |
| [Fundamentals](/git/02-fundamentals/01-the-three-trees/)                     | Three-tree architecture, Git objects, references          |
| [Branching and Merging](/git/03-branching-and-merging/01-branching/)         | Branches, merge strategies, rebasing, conflict resolution |
| [Remotes and Workflows](/git/04-remotes-and-workflows/01-remote-operations/) | Remote operations, branching strategies, pull requests    |
| [Advanced Topics](/git/05-advanced-topics/01-reflog/)                        | Reflog, stash, bisect, submodules, worktrees              |
| [Internals](/git/06-internals/01-git-directory-structure/)                   | `.git` directory layout, pack files, hashing algorithm    |
| [Others](/git/Others/gitea-on-truenas/)                                      | Self-hosting, commit history removal                      |
