...
objects: blobs, trees, commits, and tags. See [Git Objects](/git/02-fundamentals/02-git-objects/)
...
See [Packing and Garbage Collection](/git/06-internals/02-packing-and-garbage-collection/) for details.
...
See [References](/git/02-fundamentals/03-references/) for the full treatment. In summary:
