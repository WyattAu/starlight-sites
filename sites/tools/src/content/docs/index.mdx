...
description: "Choosing the wrong algorithm based on input size: Big-O notation tells you how an algorithm scales, but constant factors matter for small inputs. A O(n^2)"
hero:
