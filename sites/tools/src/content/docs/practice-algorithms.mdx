...
- **[Linked Lists, Stacks, and Queues](algorithms/03-linked-lists-stacks-queues/linked-lists-stacks-queues):** Linear data structures that serve as building blocks for algorithm implementations.
