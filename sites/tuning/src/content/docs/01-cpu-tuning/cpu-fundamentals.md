...
title: "CPU Architecture and Tuning - Wyatt's Notes"
...
- [Cooling](../05-cooling-systems/cooling) - How thermal solutions enable sustained boost clocks and prevent throttling
- [Memory Tuning](../02-memory-tuning/memory-tuning) - How memory speed and timings interact with CPU performance
