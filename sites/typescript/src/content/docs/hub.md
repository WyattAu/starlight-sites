...
- Literal Types, string literals, number literals, and template literal types
- Union and Intersection, combining types with | and &
- Type Narrowing, typeof, instanceof, in, and discriminated unions
- Type Assertions, as, satisfies, and non-null assertion !
...
- Interfaces, defining object shapes, optional properties, and readonly properties
- Type Aliases, type keyword, unions, and intersections
- Declaration Merging, extending interfaces and module augmentation
- Index Signatures, dynamic property access and Record types
...
- Generic Functions, type parameters and type inference
- Generic Constraints, extends keyword and keyof
- Generic Classes and Interfaces, parameterized types and generic collections
...
- Object Utility Types, Partial, Required, Readonly, Pick, Omit, and Record
- Union Utility Types, Exclude, Extract, NonNullable, and ReturnType
- Template Literal Types, string manipulation at the type level
- Conditional Types, ternary operator for types and infer keyword
...
- Mapped Types, iterating over object properties and transforming types
- Template Literal Manipulation, Uppercase, Lowercase, and string transformations
...
- Component Props, typing props, default props, and children
- Hooks, useState, useEffect, useRef, and custom hooks
- Event Handlers, typing click, change, and form events
- Context and Providers, typing React context and providers
