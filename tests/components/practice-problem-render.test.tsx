  ...
  it('should render multiple problems', () => {
    render(() => (
      <PracticeProblem questions={[
        { question: 'What is 2 + 2?', options: ['3', '4'], correctAnswer: 1, explanation: '4', difficulty: 'easy' },
        { question: 'What is 3 + 3?', options: ['5', '6'], correctAnswer: 1, explanation: '6', difficulty: 'medium' },
      ]} />
    ))
    expect(screen.getByText('What is 2 + 2?')).toBeTruthy()
